...
#define NODE_MAIN_LOGGER_NAME "simple_planning_simulator_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsimple_planning_simulator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<simulation::simple_planning_simulator::SimplePlanningSimulator>";
