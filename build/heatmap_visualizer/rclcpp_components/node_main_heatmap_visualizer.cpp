...
#define NODE_MAIN_LOGGER_NAME "heatmap_visualizer"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libheatmap_visualizer_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<heatmap_visualizer::HeatmapVisualizerNode>";
