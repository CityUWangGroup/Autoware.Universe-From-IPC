...
#define NODE_MAIN_LOGGER_NAME "crosswalk_traffic_light_estimator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcrosswalk_traffic_light_estimator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<traffic_light::CrosswalkTrafficLightEstimatorNode>";
