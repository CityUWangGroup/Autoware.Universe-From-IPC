...
#ifndef TIER4_PERCEPTION_MSGS__MSG__DETAIL__SHAPE__STRUCT_HPP_
#define TIER4_PERCEPTION_MSGS__MSG__DETAIL__SHAPE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__tier4_perception_msgs__msg__Shape __attribute__((deprecated))
#else
# define DEPRECATED__tier4_perception_msgs__msg__Shape __declspec(deprecated)
#endif
...
struct Shape_
{
  ...
  using ConstRawPtr =
    const tier4_perception_msgs::msg::Shape_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tier4_perception_msgs::msg::Shape_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tier4_perception_msgs__msg__Shape
    std::shared_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tier4_perception_msgs__msg__Shape
    std::shared_ptr<tier4_perception_msgs::msg::Shape_<ContainerAllocator> const>
...
using Shape =
  tier4_perception_msgs::msg::Shape_<std::allocator<void>>;
...
#endif  // TIER4_PERCEPTION_MSGS__MSG__DETAIL__SHAPE__STRUCT_HPP_
