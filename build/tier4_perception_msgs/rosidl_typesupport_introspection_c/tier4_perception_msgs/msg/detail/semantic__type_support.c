  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_perception_msgs__msg__Semantic__init(message_memory);
}

void Semantic__rosidl_typesupport_introspection_c__Semantic_fini_function(void * message_memory)
{
  tier4_perception_msgs__msg__Semantic__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Semantic__rosidl_typesupport_introspection_c__Semantic_message_member_array[2] = {
  {
    ...
    offsetof(tier4_perception_msgs__msg__Semantic, type),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_perception_msgs__msg__Semantic, confidence),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Semantic__rosidl_typesupport_introspection_c__Semantic_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_perception_msgs__msg__Semantic),
