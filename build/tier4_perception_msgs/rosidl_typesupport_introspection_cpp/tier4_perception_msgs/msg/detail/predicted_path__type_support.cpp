...
{
  new (message_memory) tier4_perception_msgs::msg::PredictedPath(_init);
}

void PredictedPath_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_perception_msgs::msg::PredictedPath *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PredictedPath_message_member_array[2] = {
  {
    ...
    offsetof(tier4_perception_msgs::msg::PredictedPath, path),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_perception_msgs::msg::PredictedPath, confidence),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PredictedPath_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_perception_msgs::msg::PredictedPath),
...
{
  return &::tier4_perception_msgs::msg::rosidl_typesupport_introspection_cpp::PredictedPath_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_perception_msgs, msg, PredictedPath)() {
  return &::tier4_perception_msgs::msg::rosidl_typesupport_introspection_cpp::PredictedPath_message_type_support_handle;
}
