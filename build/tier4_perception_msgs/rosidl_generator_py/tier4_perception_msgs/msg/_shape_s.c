...
bool tier4_perception_msgs__msg__shape__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_perception_msgs.msg._shape.Shape", full_classname_dest, 38) == 0);
  }
  tier4_perception_msgs__msg__Shape * ros_message = _ros_message;
  {  // type
...
PyObject * tier4_perception_msgs__msg__shape__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_perception_msgs.msg._shape");
