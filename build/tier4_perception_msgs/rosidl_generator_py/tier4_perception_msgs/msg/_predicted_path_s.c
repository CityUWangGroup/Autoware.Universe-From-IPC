...
bool tier4_perception_msgs__msg__predicted_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_perception_msgs.msg._predicted_path.PredictedPath", full_classname_dest, 55) == 0);
  }
  tier4_perception_msgs__msg__PredictedPath * ros_message = _ros_message;
  {  // path
    ...
    geometry_msgs__msg__PoseWithCovarianceStamped * dest = ros_message->path.data;
...
PyObject * tier4_perception_msgs__msg__predicted_path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_perception_msgs.msg._predicted_path");
