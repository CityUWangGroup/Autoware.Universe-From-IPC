...
{
  tier4_perception_msgs__msg__DetectedObjectsWithFeature * msg = (tier4_perception_msgs__msg__DetectedObjectsWithFeature *)malloc(sizeof(tier4_perception_msgs__msg__DetectedObjectsWithFeature));
  if (!msg) {
    return NULL;
  }
...
tier4_perception_msgs__msg__DetectedObjectsWithFeature__Sequence__init(tier4_perception_msgs__msg__DetectedObjectsWithFeature__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_perception_msgs__msg__DetectedObjectsWithFeature *)calloc(size, sizeof(tier4_perception_msgs__msg__DetectedObjectsWithFeature));
    if (!data) {
      return false;
    }
...
{
  tier4_perception_msgs__msg__DetectedObjectsWithFeature__Sequence * array = (tier4_perception_msgs__msg__DetectedObjectsWithFeature__Sequence *)malloc(sizeof(tier4_perception_msgs__msg__DetectedObjectsWithFeature__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_perception_msgs__msg__DetectedObjectsWithFeature__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_perception_msgs__msg__DetectedObjectsWithFeature * data =
      (tier4_perception_msgs__msg__DetectedObjectsWithFeature *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_perception_msgs__msg__DetectedObjectsWithFeature__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_perception_msgs__msg__DetectedObjectsWithFeature__fini(&data[i]);
        }
        free(data);
        return false;
      }
