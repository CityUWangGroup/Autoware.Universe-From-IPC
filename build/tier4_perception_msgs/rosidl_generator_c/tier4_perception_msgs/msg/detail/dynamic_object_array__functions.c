...
{
  tier4_perception_msgs__msg__DynamicObjectArray * msg = (tier4_perception_msgs__msg__DynamicObjectArray *)malloc(sizeof(tier4_perception_msgs__msg__DynamicObjectArray));
  if (!msg) {
    return NULL;
  }
...
tier4_perception_msgs__msg__DynamicObjectArray__Sequence__init(tier4_perception_msgs__msg__DynamicObjectArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_perception_msgs__msg__DynamicObjectArray *)calloc(size, sizeof(tier4_perception_msgs__msg__DynamicObjectArray));
    if (!data) {
      return false;
    }
...
{
  tier4_perception_msgs__msg__DynamicObjectArray__Sequence * array = (tier4_perception_msgs__msg__DynamicObjectArray__Sequence *)malloc(sizeof(tier4_perception_msgs__msg__DynamicObjectArray__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_perception_msgs__msg__DynamicObjectArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_perception_msgs__msg__DynamicObjectArray * data =
      (tier4_perception_msgs__msg__DynamicObjectArray *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_perception_msgs__msg__DynamicObjectArray__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_perception_msgs__msg__DynamicObjectArray__fini(&data[i]);
        }
        free(data);
        return false;
      }
