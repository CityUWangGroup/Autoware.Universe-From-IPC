...
static size_t _DetectedObjectsWithFeature__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_tier4_perception_msgs__msg__DetectedObjectsWithFeature(
    full_bounded, 0);
}
