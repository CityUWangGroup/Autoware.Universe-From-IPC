...
#include "autoware_planning_msgs/msg/detail/lanelet_route__rosidl_typesupport_fastrtps_c.h"
...
using _LaneletRoute__ros_msg_type = autoware_planning_msgs__msg__LaneletRoute;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LaneletRoute__ros_msg_type * ros_message = static_cast<const _LaneletRoute__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LaneletRoute__ros_msg_type * ros_message = static_cast<_LaneletRoute__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _LaneletRoute__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_planning_msgs__msg__LaneletRoute(
...
{
  return max_serialized_size_autoware_planning_msgs__msg__LaneletRoute(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LaneletRoute = {
...
static rosidl_message_type_support_t _LaneletRoute__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LaneletRoute,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_planning_msgs, msg, LaneletRoute)() {
  return &_LaneletRoute__type_support;
}
