...
static const _PoseWithUuid_type_support_symbol_names_t _PoseWithUuid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_planning_msgs, msg, PoseWithUuid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, PoseWithUuid)),
  }
};
...
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_cpp::PoseWithUuid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_planning_msgs, msg, PoseWithUuid)() {
  return get_message_type_support_handle<autoware_planning_msgs::msg::PoseWithUuid>();
}
