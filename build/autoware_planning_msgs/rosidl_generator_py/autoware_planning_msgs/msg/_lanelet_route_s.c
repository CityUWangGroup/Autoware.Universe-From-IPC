...
bool autoware_planning_msgs__msg__lanelet_route__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_planning_msgs.msg._lanelet_route.LaneletRoute", full_classname_dest, 54) == 0);
  }
  autoware_planning_msgs__msg__LaneletRoute * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LaneletRoute */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_planning_msgs.msg._lanelet_route");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LaneletRoute");
