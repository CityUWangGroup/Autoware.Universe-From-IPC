...
bool autoware_planning_msgs__srv__set_route__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_planning_msgs.srv._set_route.SetRoute_Request", full_classname_dest, 54) == 0);
  }
  autoware_planning_msgs__srv__SetRoute_Request * ros_message = _ros_message;
  {  // header
  ...
  {  // segments
    ...
    if (!autoware_planning_msgs__msg__LaneletSegment__Sequence__init(&(ros_message->segments), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create autoware_planning_msgs__msg__LaneletSegment__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    autoware_planning_msgs__msg__LaneletSegment * dest = ros_message->segments.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!autoware_planning_msgs__msg__lanelet_segment__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * autoware_planning_msgs__srv__set_route__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_planning_msgs.srv._set_route");
  ...
  {  // segments
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = autoware_planning_msgs__msg__lanelet_segment__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool autoware_planning_msgs__srv__set_route__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_planning_msgs.srv._set_route.SetRoute_Response", full_classname_dest, 55) == 0);
  }
  autoware_planning_msgs__srv__SetRoute_Response * ros_message = _ros_message;
  {  // status
