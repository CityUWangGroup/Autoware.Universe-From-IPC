...
#define NODE_MAIN_LOGGER_NAME "steer_offset_estimator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsteer_offset_estimator_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<steer_offset_estimator::SteerOffsetEstimatorNode>";
