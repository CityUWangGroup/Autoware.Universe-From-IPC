...
#define NODE_MAIN_LOGGER_NAME "detected_object_feature_remover"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdetected_object_feature_remover_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<detected_object_feature_remover::DetectedObjectFeatureRemover>";
