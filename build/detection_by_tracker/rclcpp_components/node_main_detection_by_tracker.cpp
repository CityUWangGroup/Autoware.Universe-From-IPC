...
#define NODE_MAIN_LOGGER_NAME "detection_by_tracker"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdetection_by_tracker_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<DetectionByTracker>";
