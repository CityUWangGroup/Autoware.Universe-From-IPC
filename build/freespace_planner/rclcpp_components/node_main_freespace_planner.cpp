...
#define NODE_MAIN_LOGGER_NAME "freespace_planner"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfreespace_planner_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<freespace_planner::FreespacePlannerNode>";
