...
#define NODE_MAIN_LOGGER_NAME "motion_velocity_smoother"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmotion_velocity_smoother_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<motion_velocity_smoother::MotionVelocitySmootherNode>";
