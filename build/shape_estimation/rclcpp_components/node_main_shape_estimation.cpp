...
#define NODE_MAIN_LOGGER_NAME "shape_estimation"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libshape_estimation_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ShapeEstimationNode>";
