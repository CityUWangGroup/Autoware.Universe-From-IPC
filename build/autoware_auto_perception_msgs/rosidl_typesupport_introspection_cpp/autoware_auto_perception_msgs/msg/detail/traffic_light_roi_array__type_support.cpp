...
{
  new (message_memory) autoware_auto_perception_msgs::msg::TrafficLightRoiArray(_init);
}

void TrafficLightRoiArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_perception_msgs::msg::TrafficLightRoiArray *>(message_memory);
  typed_message->~TrafficLightRoiArray();
}

size_t size_function__TrafficLightRoiArray__rois(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_auto_perception_msgs::msg::TrafficLightRoi> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_auto_perception_msgs::msg::TrafficLightRoi> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_auto_perception_msgs::msg::TrafficLightRoi> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficLightRoiArray_message_member_array[2] = {
  {
    ...
    offsetof(autoware_auto_perception_msgs::msg::TrafficLightRoiArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_auto_perception_msgs::msg::TrafficLightRoi>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_perception_msgs::msg::TrafficLightRoiArray, rois),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrafficLightRoiArray_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_perception_msgs::msg::TrafficLightRoiArray),
...
get_message_type_support_handle<autoware_auto_perception_msgs::msg::TrafficLightRoiArray>()
{
  return &::autoware_auto_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLightRoiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_perception_msgs, msg, TrafficLightRoiArray)() {
  return &::autoware_auto_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLightRoiArray_message_type_support_handle;
}
