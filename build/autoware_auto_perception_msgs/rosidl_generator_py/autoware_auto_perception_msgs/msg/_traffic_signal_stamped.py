...
class Metaclass_TrafficSignalStamped(type):
    """Metaclass of message 'TrafficSignalStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__traffic_signal_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__traffic_signal_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__traffic_signal_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__traffic_signal_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__traffic_signal_stamped
...
class TrafficSignalStamped(metaclass=Metaclass_TrafficSignalStamped):
    """Message class 'TrafficSignalStamped'."""
