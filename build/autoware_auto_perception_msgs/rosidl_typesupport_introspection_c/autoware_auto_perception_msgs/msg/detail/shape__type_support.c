...
static rosidl_typesupport_introspection_c__MessageMember Shape__rosidl_typesupport_introspection_c__Shape_message_member_array[3] = {
  {
    ...
    offsetof(autoware_auto_perception_msgs__msg__Shape, type),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_perception_msgs__msg__Shape, footprint),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_perception_msgs__msg__Shape, dimensions),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
