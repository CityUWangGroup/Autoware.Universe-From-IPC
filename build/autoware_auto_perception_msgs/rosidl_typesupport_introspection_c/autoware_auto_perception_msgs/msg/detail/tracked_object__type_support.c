...
static rosidl_typesupport_introspection_c__MessageMember TrackedObject__rosidl_typesupport_introspection_c__TrackedObject_message_member_array[5] = {
  {
    "object_id",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_perception_msgs, msg, TrackedObject)() {
  ...
  TrackedObject__rosidl_typesupport_introspection_c__TrackedObject_message_member_array[2].members_ =
