...
{
  autoware_auto_perception_msgs__msg__TrafficSignalArray * msg = (autoware_auto_perception_msgs__msg__TrafficSignalArray *)malloc(sizeof(autoware_auto_perception_msgs__msg__TrafficSignalArray));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_perception_msgs__msg__TrafficSignalArray__Sequence__init(autoware_auto_perception_msgs__msg__TrafficSignalArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_perception_msgs__msg__TrafficSignalArray *)calloc(size, sizeof(autoware_auto_perception_msgs__msg__TrafficSignalArray));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_perception_msgs__msg__TrafficSignalArray__Sequence * array = (autoware_auto_perception_msgs__msg__TrafficSignalArray__Sequence *)malloc(sizeof(autoware_auto_perception_msgs__msg__TrafficSignalArray__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_auto_perception_msgs__msg__TrafficSignalArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_perception_msgs__msg__TrafficSignalArray * data =
      (autoware_auto_perception_msgs__msg__TrafficSignalArray *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_perception_msgs__msg__TrafficSignalArray__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_perception_msgs__msg__TrafficSignalArray__fini(&data[i]);
        }
        free(data);
        return false;
      }
