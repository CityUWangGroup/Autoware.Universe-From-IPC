...
#include "autoware_auto_perception_msgs/msg/detail/traffic_signal_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::TrafficSignalStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::TrafficSignalStamped & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autoware_auto_perception_msgs
max_serialized_size_TrafficSignalStamped(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::TrafficSignalStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::TrafficSignalStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrafficSignalStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::TrafficSignalStamped *>(
...
{
  return max_serialized_size_TrafficSignalStamped(full_bounded, 0);
}

static message_type_support_callbacks_t _TrafficSignalStamped__callbacks = {
...
static rosidl_message_type_support_t _TrafficSignalStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrafficSignalStamped__callbacks,
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficSignalStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, TrafficSignalStamped)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficSignalStamped__handle;
}
