...
#include "autoware_auto_perception_msgs/msg/detail/looking_traffic_signal__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_auto_perception_msgs::msg::TrafficSignalWithJudge &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::LookingTrafficSignal & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.perception,
    cdr);
  // Member: external
  autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.external,
    cdr);
  // Member: result
  autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.result,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::LookingTrafficSignal & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autoware_auto_perception_msgs
max_serialized_size_LookingTrafficSignal(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: perception
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficSignalWithJudge(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::LookingTrafficSignal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::LookingTrafficSignal *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LookingTrafficSignal__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::LookingTrafficSignal *>(
...
{
  return max_serialized_size_LookingTrafficSignal(full_bounded, 0);
}

static message_type_support_callbacks_t _LookingTrafficSignal__callbacks = {
...
static rosidl_message_type_support_t _LookingTrafficSignal__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LookingTrafficSignal__callbacks,
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_LookingTrafficSignal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, LookingTrafficSignal)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_LookingTrafficSignal__handle;
}
