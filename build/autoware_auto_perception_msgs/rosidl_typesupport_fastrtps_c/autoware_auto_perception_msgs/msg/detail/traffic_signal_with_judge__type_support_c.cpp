...
static size_t _TrafficSignalWithJudge__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_perception_msgs__msg__TrafficSignalWithJudge(
    full_bounded, 0);
}
