...
#define NODE_MAIN_LOGGER_NAME "obstacle_collision_checker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobstacle_collision_checker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<obstacle_collision_checker::ObstacleCollisionCheckerNode>";
