...
#define NODE_MAIN_LOGGER_NAME "fault_injection_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfault_injection_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fault_injection::FaultInjectionNode>";
