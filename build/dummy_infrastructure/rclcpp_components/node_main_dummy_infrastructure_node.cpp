...
#define NODE_MAIN_LOGGER_NAME "dummy_infrastructure_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdummy_infrastructure_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<dummy_infrastructure::DummyInfrastructureNode>";
