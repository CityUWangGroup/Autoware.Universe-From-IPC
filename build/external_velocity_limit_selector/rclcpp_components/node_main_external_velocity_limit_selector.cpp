...
#define NODE_MAIN_LOGGER_NAME "external_velocity_limit_selector"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libexternal_velocity_limit_selector_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ExternalVelocityLimitSelectorNode>";
