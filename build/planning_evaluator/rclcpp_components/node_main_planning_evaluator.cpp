...
#define NODE_MAIN_LOGGER_NAME "planning_evaluator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libplanning_evaluator_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_diagnostics::PlanningEvaluatorNode>";
