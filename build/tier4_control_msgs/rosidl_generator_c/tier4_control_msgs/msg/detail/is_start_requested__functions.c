...
{
  tier4_control_msgs__msg__IsStartRequested * msg = (tier4_control_msgs__msg__IsStartRequested *)malloc(sizeof(tier4_control_msgs__msg__IsStartRequested));
  if (!msg) {
    return NULL;
  }
...
tier4_control_msgs__msg__IsStartRequested__Sequence__init(tier4_control_msgs__msg__IsStartRequested__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_control_msgs__msg__IsStartRequested *)calloc(size, sizeof(tier4_control_msgs__msg__IsStartRequested));
    if (!data) {
      return false;
    }
...
{
  tier4_control_msgs__msg__IsStartRequested__Sequence * array = (tier4_control_msgs__msg__IsStartRequested__Sequence *)malloc(sizeof(tier4_control_msgs__msg__IsStartRequested__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_control_msgs__msg__IsStartRequested__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_control_msgs__msg__IsStartRequested * data =
      (tier4_control_msgs__msg__IsStartRequested *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_control_msgs__msg__IsStartRequested__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_control_msgs__msg__IsStartRequested__fini(&data[i]);
        }
        free(data);
        return false;
      }
