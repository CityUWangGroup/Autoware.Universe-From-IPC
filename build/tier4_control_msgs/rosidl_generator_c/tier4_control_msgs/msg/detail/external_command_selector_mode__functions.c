...
{
  tier4_control_msgs__msg__ExternalCommandSelectorMode * msg = (tier4_control_msgs__msg__ExternalCommandSelectorMode *)malloc(sizeof(tier4_control_msgs__msg__ExternalCommandSelectorMode));
  if (!msg) {
    return NULL;
  }
...
tier4_control_msgs__msg__ExternalCommandSelectorMode__Sequence__init(tier4_control_msgs__msg__ExternalCommandSelectorMode__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_control_msgs__msg__ExternalCommandSelectorMode *)calloc(size, sizeof(tier4_control_msgs__msg__ExternalCommandSelectorMode));
    if (!data) {
      return false;
    }
...
{
  tier4_control_msgs__msg__ExternalCommandSelectorMode__Sequence * array = (tier4_control_msgs__msg__ExternalCommandSelectorMode__Sequence *)malloc(sizeof(tier4_control_msgs__msg__ExternalCommandSelectorMode__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_control_msgs__msg__ExternalCommandSelectorMode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_control_msgs__msg__ExternalCommandSelectorMode * data =
      (tier4_control_msgs__msg__ExternalCommandSelectorMode *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_control_msgs__msg__ExternalCommandSelectorMode__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_control_msgs__msg__ExternalCommandSelectorMode__fini(&data[i]);
        }
        free(data);
        return false;
      }
