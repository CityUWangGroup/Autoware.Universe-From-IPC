...
{
  tier4_control_msgs__srv__ExternalCommandSelect_Request * msg = (tier4_control_msgs__srv__ExternalCommandSelect_Request *)malloc(sizeof(tier4_control_msgs__srv__ExternalCommandSelect_Request));
  if (!msg) {
    return NULL;
  }
...
tier4_control_msgs__srv__ExternalCommandSelect_Request__Sequence__init(tier4_control_msgs__srv__ExternalCommandSelect_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_control_msgs__srv__ExternalCommandSelect_Request *)calloc(size, sizeof(tier4_control_msgs__srv__ExternalCommandSelect_Request));
    if (!data) {
      return false;
    }
...
{
  tier4_control_msgs__srv__ExternalCommandSelect_Request__Sequence * array = (tier4_control_msgs__srv__ExternalCommandSelect_Request__Sequence *)malloc(sizeof(tier4_control_msgs__srv__ExternalCommandSelect_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_control_msgs__srv__ExternalCommandSelect_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_control_msgs__srv__ExternalCommandSelect_Request * data =
      (tier4_control_msgs__srv__ExternalCommandSelect_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_control_msgs__srv__ExternalCommandSelect_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_control_msgs__srv__ExternalCommandSelect_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  tier4_control_msgs__srv__ExternalCommandSelect_Response * msg = (tier4_control_msgs__srv__ExternalCommandSelect_Response *)malloc(sizeof(tier4_control_msgs__srv__ExternalCommandSelect_Response));
  if (!msg) {
    return NULL;
  }
...
tier4_control_msgs__srv__ExternalCommandSelect_Response__Sequence__init(tier4_control_msgs__srv__ExternalCommandSelect_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_control_msgs__srv__ExternalCommandSelect_Response *)calloc(size, sizeof(tier4_control_msgs__srv__ExternalCommandSelect_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  tier4_control_msgs__srv__ExternalCommandSelect_Response__Sequence * array = (tier4_control_msgs__srv__ExternalCommandSelect_Response__Sequence *)malloc(sizeof(tier4_control_msgs__srv__ExternalCommandSelect_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_control_msgs__srv__ExternalCommandSelect_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_control_msgs__srv__ExternalCommandSelect_Response * data =
      (tier4_control_msgs__srv__ExternalCommandSelect_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_control_msgs__srv__ExternalCommandSelect_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_control_msgs__srv__ExternalCommandSelect_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
