...
static const _IsStartRequested_type_support_symbol_names_t _IsStartRequested_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_control_msgs, msg, IsStartRequested)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_control_msgs, msg, IsStartRequested)),
  }
};
...
{
  return &::tier4_control_msgs::msg::rosidl_typesupport_cpp::IsStartRequested_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tier4_control_msgs, msg, IsStartRequested)() {
  return get_message_type_support_handle<tier4_control_msgs::msg::IsStartRequested>();
}
