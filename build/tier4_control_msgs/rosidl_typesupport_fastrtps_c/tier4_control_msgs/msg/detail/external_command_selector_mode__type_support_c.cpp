...
#include "tier4_control_msgs/msg/detail/external_command_selector_mode__rosidl_typesupport_fastrtps_c.h"
...
using _ExternalCommandSelectorMode__ros_msg_type = tier4_control_msgs__msg__ExternalCommandSelectorMode;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ExternalCommandSelectorMode__ros_msg_type * ros_message = static_cast<const _ExternalCommandSelectorMode__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ExternalCommandSelectorMode__ros_msg_type * ros_message = static_cast<_ExternalCommandSelectorMode__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    cdr >> ros_message->data;
  }
...
static uint32_t _ExternalCommandSelectorMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_control_msgs__msg__ExternalCommandSelectorMode(
...
{
  return max_serialized_size_tier4_control_msgs__msg__ExternalCommandSelectorMode(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ExternalCommandSelectorMode = {
...
static rosidl_message_type_support_t _ExternalCommandSelectorMode__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExternalCommandSelectorMode,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_control_msgs, msg, ExternalCommandSelectorMode)() {
  return &_ExternalCommandSelectorMode__type_support;
}
