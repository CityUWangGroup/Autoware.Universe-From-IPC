...
static size_t _SetPause_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_tier4_control_msgs__srv__SetPause_Request(
    full_bounded, 0);
}
...
static size_t _SetPause_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_tier4_control_msgs__srv__SetPause_Response(
    full_bounded, 0);
}
