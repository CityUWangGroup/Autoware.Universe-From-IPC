...
static const _InfrastructureCommandArray_type_support_symbol_names_t _InfrastructureCommandArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_v2x_msgs, msg, InfrastructureCommandArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_v2x_msgs, msg, InfrastructureCommandArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_v2x_msgs, msg, InfrastructureCommandArray)() {
  return &::tier4_v2x_msgs::msg::rosidl_typesupport_c::InfrastructureCommandArray_message_type_support_handle;
}
