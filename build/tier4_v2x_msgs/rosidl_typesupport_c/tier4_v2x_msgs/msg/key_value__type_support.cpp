...
static const _KeyValue_type_support_symbol_names_t _KeyValue_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_v2x_msgs, msg, KeyValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_v2x_msgs, msg, KeyValue)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_v2x_msgs, msg, KeyValue)() {
  return &::tier4_v2x_msgs::msg::rosidl_typesupport_c::KeyValue_message_type_support_handle;
}
