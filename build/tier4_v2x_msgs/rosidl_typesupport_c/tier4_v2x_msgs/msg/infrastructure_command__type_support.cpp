...
static const _InfrastructureCommand_type_support_symbol_names_t _InfrastructureCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_v2x_msgs, msg, InfrastructureCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_v2x_msgs, msg, InfrastructureCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_v2x_msgs, msg, InfrastructureCommand)() {
  return &::tier4_v2x_msgs::msg::rosidl_typesupport_c::InfrastructureCommand_message_type_support_handle;
}
