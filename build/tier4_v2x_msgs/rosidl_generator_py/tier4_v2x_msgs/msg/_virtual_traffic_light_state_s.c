...
bool tier4_v2x_msgs__msg__virtual_traffic_light_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_v2x_msgs.msg._virtual_traffic_light_state.VirtualTrafficLightState", full_classname_dest, 72) == 0);
  }
  tier4_v2x_msgs__msg__VirtualTrafficLightState * ros_message = _ros_message;
  {  // stamp
  ...
  {  // is_finalized
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_finalized");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_finalized = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of VirtualTrafficLightState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_v2x_msgs.msg._virtual_traffic_light_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VirtualTrafficLightState");
  ...
  {  // is_finalized
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_finalized ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_finalized", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
