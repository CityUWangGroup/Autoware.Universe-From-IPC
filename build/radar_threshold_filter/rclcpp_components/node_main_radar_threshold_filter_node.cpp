...
#define NODE_MAIN_LOGGER_NAME "radar_threshold_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libradar_threshold_filter_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<radar_threshold_filter::RadarThresholdFilterNode>";
