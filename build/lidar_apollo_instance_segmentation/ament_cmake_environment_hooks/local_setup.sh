...
: ${AMENT_CURRENT_PREFIX:="/home/cityu/autoware/install/lidar_apollo_instance_segmentation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lidar_apollo_instance_segmentation/environment/library_path.sh"
