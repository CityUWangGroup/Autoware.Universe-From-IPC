...
#define NODE_MAIN_LOGGER_NAME "rtc_auto_mode_manager_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librtc_auto_mode_manager.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rtc_auto_mode_manager::RTCAutoModeManagerNode>";
