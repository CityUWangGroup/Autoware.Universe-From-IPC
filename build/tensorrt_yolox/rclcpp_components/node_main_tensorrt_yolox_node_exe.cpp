...
#define NODE_MAIN_LOGGER_NAME "tensorrt_yolox_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtensorrt_yolox_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tensorrt_yolox::TrtYoloXNode>";
