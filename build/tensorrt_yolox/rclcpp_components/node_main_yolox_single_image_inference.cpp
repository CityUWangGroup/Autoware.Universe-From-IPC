...
#define NODE_MAIN_LOGGER_NAME "yolox_single_image_inference"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libyolox_single_image_inference_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tensorrt_yolox::YoloXSingleImageInferenceNode>";
