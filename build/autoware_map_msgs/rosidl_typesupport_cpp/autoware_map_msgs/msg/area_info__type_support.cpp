...
static const _AreaInfo_type_support_symbol_names_t _AreaInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_map_msgs, msg, AreaInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_map_msgs, msg, AreaInfo)),
  }
};
...
{
  return &::autoware_map_msgs::msg::rosidl_typesupport_cpp::AreaInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_map_msgs, msg, AreaInfo)() {
  return get_message_type_support_handle<autoware_map_msgs::msg::AreaInfo>();
}
