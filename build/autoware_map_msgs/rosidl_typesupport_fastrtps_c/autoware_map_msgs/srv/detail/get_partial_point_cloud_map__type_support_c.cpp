...
static size_t _GetPartialPointCloudMap_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_map_msgs__srv__GetPartialPointCloudMap_Request(
    full_bounded, 0);
}
...
static size_t _GetPartialPointCloudMap_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_map_msgs__srv__GetPartialPointCloudMap_Response(
    full_bounded, 0);
}
