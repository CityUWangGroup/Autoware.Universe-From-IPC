...
bool autoware_map_msgs__srv__get_partial_point_cloud_map__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_map_msgs.srv._get_partial_point_cloud_map.GetPartialPointCloudMap_Request", full_classname_dest, 82) == 0);
  }
  autoware_map_msgs__srv__GetPartialPointCloudMap_Request * ros_message = _ros_message;
  {  // area
...
{
  /* NOTE(esteve): Call constructor of GetPartialPointCloudMap_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_map_msgs.srv._get_partial_point_cloud_map");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPartialPointCloudMap_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool autoware_map_msgs__srv__get_partial_point_cloud_map__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_map_msgs.srv._get_partial_point_cloud_map.GetPartialPointCloudMap_Response", full_classname_dest, 83) == 0);
  }
  autoware_map_msgs__srv__GetPartialPointCloudMap_Response * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of GetPartialPointCloudMap_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_map_msgs.srv._get_partial_point_cloud_map");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPartialPointCloudMap_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
