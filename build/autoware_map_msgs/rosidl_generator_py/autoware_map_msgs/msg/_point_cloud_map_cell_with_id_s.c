...
bool autoware_map_msgs__msg__point_cloud_map_cell_with_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_map_msgs.msg._point_cloud_map_cell_with_id.PointCloudMapCellWithID", full_classname_dest, 75) == 0);
  }
  autoware_map_msgs__msg__PointCloudMapCellWithID * ros_message = _ros_message;
  {  // cell_id
...
{
  /* NOTE(esteve): Call constructor of PointCloudMapCellWithID */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_map_msgs.msg._point_cloud_map_cell_with_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointCloudMapCellWithID");
