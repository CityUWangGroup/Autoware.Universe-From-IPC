...
bool autoware_common_msgs__msg__response_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_common_msgs.msg._response_status.ResponseStatus", full_classname_dest, 56) == 0);
  }
  autoware_common_msgs__msg__ResponseStatus * ros_message = _ros_message;
  {  // success
...
PyObject * autoware_common_msgs__msg__response_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_common_msgs.msg._response_status");
