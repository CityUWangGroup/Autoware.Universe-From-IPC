...
{
  new (message_memory) autoware_common_msgs::msg::ResponseStatus(_init);
}

void ResponseStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_common_msgs::msg::ResponseStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ResponseStatus_message_member_array[3] = {
  {
    ...
    offsetof(autoware_common_msgs::msg::ResponseStatus, success),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_common_msgs::msg::ResponseStatus, code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_common_msgs::msg::ResponseStatus, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ResponseStatus_message_members = {
  "autoware_common_msgs::msg",  // message namespace
  "ResponseStatus",  // message name
  3,  // number of fields
  sizeof(autoware_common_msgs::msg::ResponseStatus),
...
get_message_type_support_handle<autoware_common_msgs::msg::ResponseStatus>()
{
  return &::autoware_common_msgs::msg::rosidl_typesupport_introspection_cpp::ResponseStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_common_msgs, msg, ResponseStatus)() {
  return &::autoware_common_msgs::msg::rosidl_typesupport_introspection_cpp::ResponseStatus_message_type_support_handle;
}
