...
#include "autoware_common_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _ResponseStatus_type_support_symbol_names_t _ResponseStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_common_msgs, msg, ResponseStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_common_msgs, msg, ResponseStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_common_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_common_msgs, msg, ResponseStatus)() {
  return &::autoware_common_msgs::msg::rosidl_typesupport_c::ResponseStatus_message_type_support_handle;
}
