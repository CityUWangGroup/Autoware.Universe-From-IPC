...
static const _Object_type_support_symbol_names_t _Object_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dummy_perception_publisher, msg, Object)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dummy_perception_publisher, msg, Object)),
  }
};
...
{
  return &::dummy_perception_publisher::msg::rosidl_typesupport_cpp::Object_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dummy_perception_publisher, msg, Object)() {
  return get_message_type_support_handle<dummy_perception_publisher::msg::Object>();
}
