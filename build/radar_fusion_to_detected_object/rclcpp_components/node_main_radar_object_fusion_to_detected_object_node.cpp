...
#define NODE_MAIN_LOGGER_NAME "radar_object_fusion_to_detected_object_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libradar_object_fusion_to_detected_object_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<radar_fusion_to_detected_object::RadarObjectFusionToDetectedObjectNode>";
