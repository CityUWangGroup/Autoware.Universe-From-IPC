...
#define NODE_MAIN_LOGGER_NAME "external_cmd_converter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libexternal_cmd_converter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<external_cmd_converter::ExternalCmdConverterNode>";
