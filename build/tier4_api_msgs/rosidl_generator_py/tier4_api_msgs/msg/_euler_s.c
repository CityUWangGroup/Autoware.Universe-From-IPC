...
bool tier4_api_msgs__msg__euler__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_api_msgs.msg._euler.Euler", full_classname_dest, 31) == 0);
  }
  tier4_api_msgs__msg__Euler * ros_message = _ros_message;
  {  // roll
...
{
  /* NOTE(esteve): Call constructor of Euler */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_api_msgs.msg._euler");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Euler");
