...
{
  tier4_api_msgs__msg__StopCommand * msg = (tier4_api_msgs__msg__StopCommand *)malloc(sizeof(tier4_api_msgs__msg__StopCommand));
  if (!msg) {
    return NULL;
  }
...
tier4_api_msgs__msg__StopCommand__Sequence__init(tier4_api_msgs__msg__StopCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_api_msgs__msg__StopCommand *)calloc(size, sizeof(tier4_api_msgs__msg__StopCommand));
    if (!data) {
      return false;
    }
...
{
  tier4_api_msgs__msg__StopCommand__Sequence * array = (tier4_api_msgs__msg__StopCommand__Sequence *)malloc(sizeof(tier4_api_msgs__msg__StopCommand__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_api_msgs__msg__StopCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_api_msgs__msg__StopCommand * data =
      (tier4_api_msgs__msg__StopCommand *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_api_msgs__msg__StopCommand__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_api_msgs__msg__StopCommand__fini(&data[i]);
        }
        free(data);
        return false;
      }
