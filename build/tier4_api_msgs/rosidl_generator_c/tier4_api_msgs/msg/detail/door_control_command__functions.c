...
{
  tier4_api_msgs__msg__DoorControlCommand * msg = (tier4_api_msgs__msg__DoorControlCommand *)malloc(sizeof(tier4_api_msgs__msg__DoorControlCommand));
  if (!msg) {
    return NULL;
  }
...
tier4_api_msgs__msg__DoorControlCommand__Sequence__init(tier4_api_msgs__msg__DoorControlCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_api_msgs__msg__DoorControlCommand *)calloc(size, sizeof(tier4_api_msgs__msg__DoorControlCommand));
    if (!data) {
      return false;
    }
...
{
  tier4_api_msgs__msg__DoorControlCommand__Sequence * array = (tier4_api_msgs__msg__DoorControlCommand__Sequence *)malloc(sizeof(tier4_api_msgs__msg__DoorControlCommand__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_api_msgs__msg__DoorControlCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_api_msgs__msg__DoorControlCommand * data =
      (tier4_api_msgs__msg__DoorControlCommand *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_api_msgs__msg__DoorControlCommand__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_api_msgs__msg__DoorControlCommand__fini(&data[i]);
        }
        free(data);
        return false;
      }
