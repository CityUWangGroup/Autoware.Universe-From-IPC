...
{
  tier4_api_msgs__msg__VelocityLimit * msg = (tier4_api_msgs__msg__VelocityLimit *)malloc(sizeof(tier4_api_msgs__msg__VelocityLimit));
  if (!msg) {
    return NULL;
  }
...
tier4_api_msgs__msg__VelocityLimit__Sequence__init(tier4_api_msgs__msg__VelocityLimit__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_api_msgs__msg__VelocityLimit *)calloc(size, sizeof(tier4_api_msgs__msg__VelocityLimit));
    if (!data) {
      return false;
    }
...
{
  tier4_api_msgs__msg__VelocityLimit__Sequence * array = (tier4_api_msgs__msg__VelocityLimit__Sequence *)malloc(sizeof(tier4_api_msgs__msg__VelocityLimit__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_api_msgs__msg__VelocityLimit__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_api_msgs__msg__VelocityLimit * data =
      (tier4_api_msgs__msg__VelocityLimit *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_api_msgs__msg__VelocityLimit__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_api_msgs__msg__VelocityLimit__fini(&data[i]);
        }
        free(data);
        return false;
      }
