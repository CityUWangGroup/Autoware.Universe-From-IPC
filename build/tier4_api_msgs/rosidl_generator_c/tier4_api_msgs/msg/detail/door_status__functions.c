...
{
  tier4_api_msgs__msg__DoorStatus * msg = (tier4_api_msgs__msg__DoorStatus *)malloc(sizeof(tier4_api_msgs__msg__DoorStatus));
  if (!msg) {
    return NULL;
  }
...
tier4_api_msgs__msg__DoorStatus__Sequence__init(tier4_api_msgs__msg__DoorStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_api_msgs__msg__DoorStatus *)calloc(size, sizeof(tier4_api_msgs__msg__DoorStatus));
    if (!data) {
      return false;
    }
...
{
  tier4_api_msgs__msg__DoorStatus__Sequence * array = (tier4_api_msgs__msg__DoorStatus__Sequence *)malloc(sizeof(tier4_api_msgs__msg__DoorStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_api_msgs__msg__DoorStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_api_msgs__msg__DoorStatus * data =
      (tier4_api_msgs__msg__DoorStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_api_msgs__msg__DoorStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_api_msgs__msg__DoorStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
