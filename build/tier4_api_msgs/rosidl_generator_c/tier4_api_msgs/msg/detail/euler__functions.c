...
{
  tier4_api_msgs__msg__Euler * msg = (tier4_api_msgs__msg__Euler *)malloc(sizeof(tier4_api_msgs__msg__Euler));
  if (!msg) {
    return NULL;
  }
...
tier4_api_msgs__msg__Euler__Sequence__init(tier4_api_msgs__msg__Euler__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_api_msgs__msg__Euler *)calloc(size, sizeof(tier4_api_msgs__msg__Euler));
    if (!data) {
      return false;
    }
...
{
  tier4_api_msgs__msg__Euler__Sequence * array = (tier4_api_msgs__msg__Euler__Sequence *)malloc(sizeof(tier4_api_msgs__msg__Euler__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_api_msgs__msg__Euler__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_api_msgs__msg__Euler * data =
      (tier4_api_msgs__msg__Euler *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_api_msgs__msg__Euler__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_api_msgs__msg__Euler__fini(&data[i]);
        }
        free(data);
        return false;
      }
