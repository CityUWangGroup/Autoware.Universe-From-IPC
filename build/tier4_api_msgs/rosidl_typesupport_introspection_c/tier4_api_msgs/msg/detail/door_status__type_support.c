...
#include <stddef.h>
#include "tier4_api_msgs/msg/detail/door_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_api_msgs__msg__DoorStatus__init(message_memory);
}

void DoorStatus__rosidl_typesupport_introspection_c__DoorStatus_fini_function(void * message_memory)
{
  tier4_api_msgs__msg__DoorStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember DoorStatus__rosidl_typesupport_introspection_c__DoorStatus_message_member_array[1] = {
  {
    "status",  // name
    ...
    offsetof(tier4_api_msgs__msg__DoorStatus, status),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers DoorStatus__rosidl_typesupport_introspection_c__DoorStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_api_msgs__msg__DoorStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_api_msgs, msg, DoorStatus)() {
