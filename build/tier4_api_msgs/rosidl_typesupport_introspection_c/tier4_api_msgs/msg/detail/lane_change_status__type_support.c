...
static rosidl_typesupport_introspection_c__MessageMember LaneChangeStatus__rosidl_typesupport_introspection_c__LaneChangeStatus_message_member_array[4] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_api_msgs, msg, LaneChangeStatus)() {
  ...
  LaneChangeStatus__rosidl_typesupport_introspection_c__LaneChangeStatus_message_member_array[3].members_ =
