...
#define NODE_MAIN_LOGGER_NAME "surround_obstacle_checker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsurround_obstacle_checker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<surround_obstacle_checker::SurroundObstacleCheckerNode>";
