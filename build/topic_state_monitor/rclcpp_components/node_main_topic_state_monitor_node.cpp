...
#define NODE_MAIN_LOGGER_NAME "topic_state_monitor_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtopic_state_monitor.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<topic_state_monitor::TopicStateMonitorNode>";
