...
#define NODE_MAIN_LOGGER_NAME "radar_tracks_msgs_converter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libradar_tracks_msgs_converter_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<radar_tracks_msgs_converter::RadarTracksMsgsConverterNode>";
