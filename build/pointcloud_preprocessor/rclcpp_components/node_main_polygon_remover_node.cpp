...
#define NODE_MAIN_LOGGER_NAME "polygon_remover_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pointcloud_preprocessor::PolygonRemoverComponent>";
