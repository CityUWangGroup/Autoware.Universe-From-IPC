...
#define NODE_MAIN_LOGGER_NAME "vector_map_inside_area_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pointcloud_preprocessor::VectorMapInsideAreaFilterComponent>";
