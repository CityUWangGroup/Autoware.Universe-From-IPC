...
tier4_rtc_msgs__msg__CooperateStatusArray__init(tier4_rtc_msgs__msg__CooperateStatusArray * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    tier4_rtc_msgs__msg__CooperateStatusArray__fini(msg);
    return false;
  }
  // statuses
  if (!tier4_rtc_msgs__msg__CooperateStatus__Sequence__init(&msg->statuses, 0)) {
    tier4_rtc_msgs__msg__CooperateStatusArray__fini(msg);
    return false;
  }
  return true;
...
tier4_rtc_msgs__msg__CooperateStatusArray__fini(tier4_rtc_msgs__msg__CooperateStatusArray * msg)
{
  ...
  // statuses
  tier4_rtc_msgs__msg__CooperateStatus__Sequence__fini(&msg->statuses);
}
...
tier4_rtc_msgs__msg__CooperateStatusArray__are_equal(const tier4_rtc_msgs__msg__CooperateStatusArray * lhs, const tier4_rtc_msgs__msg__CooperateStatusArray * rhs)
{
  ...
  // statuses
  if (!tier4_rtc_msgs__msg__CooperateStatus__Sequence__are_equal(
  ...
  tier4_rtc_msgs__msg__CooperateStatusArray * output)
{
  ...
  // statuses
  if (!tier4_rtc_msgs__msg__CooperateStatus__Sequence__copy(
...
{
  tier4_rtc_msgs__msg__CooperateStatusArray * msg = (tier4_rtc_msgs__msg__CooperateStatusArray *)malloc(sizeof(tier4_rtc_msgs__msg__CooperateStatusArray));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tier4_rtc_msgs__msg__CooperateStatusArray));
  bool success = tier4_rtc_msgs__msg__CooperateStatusArray__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
tier4_rtc_msgs__msg__CooperateStatusArray__Sequence__init(tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * array, size_t size)
{
  ...
  tier4_rtc_msgs__msg__CooperateStatusArray * data = NULL;
  if (size) {
    data = (tier4_rtc_msgs__msg__CooperateStatusArray *)calloc(size, sizeof(tier4_rtc_msgs__msg__CooperateStatusArray));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tier4_rtc_msgs__msg__CooperateStatusArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tier4_rtc_msgs__msg__CooperateStatusArray__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tier4_rtc_msgs__msg__CooperateStatusArray__Sequence__fini(tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tier4_rtc_msgs__msg__CooperateStatusArray__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * array = (tier4_rtc_msgs__msg__CooperateStatusArray__Sequence *)malloc(sizeof(tier4_rtc_msgs__msg__CooperateStatusArray__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tier4_rtc_msgs__msg__CooperateStatusArray__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tier4_rtc_msgs__msg__CooperateStatusArray__Sequence__fini(array);
  }
  free(array);
}
...
tier4_rtc_msgs__msg__CooperateStatusArray__Sequence__are_equal(const tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * lhs, const tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tier4_rtc_msgs__msg__CooperateStatusArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tier4_rtc_msgs__msg__CooperateStatusArray);
    tier4_rtc_msgs__msg__CooperateStatusArray * data =
      (tier4_rtc_msgs__msg__CooperateStatusArray *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_rtc_msgs__msg__CooperateStatusArray__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_rtc_msgs__msg__CooperateStatusArray__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tier4_rtc_msgs__msg__CooperateStatusArray__copy(
