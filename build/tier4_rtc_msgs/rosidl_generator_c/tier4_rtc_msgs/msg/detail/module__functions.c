...
{
  tier4_rtc_msgs__msg__Module * msg = (tier4_rtc_msgs__msg__Module *)malloc(sizeof(tier4_rtc_msgs__msg__Module));
  if (!msg) {
    return NULL;
  }
...
tier4_rtc_msgs__msg__Module__Sequence__init(tier4_rtc_msgs__msg__Module__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_rtc_msgs__msg__Module *)calloc(size, sizeof(tier4_rtc_msgs__msg__Module));
    if (!data) {
      return false;
    }
...
{
  tier4_rtc_msgs__msg__Module__Sequence * array = (tier4_rtc_msgs__msg__Module__Sequence *)malloc(sizeof(tier4_rtc_msgs__msg__Module__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_rtc_msgs__msg__Module__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_rtc_msgs__msg__Module * data =
      (tier4_rtc_msgs__msg__Module *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_rtc_msgs__msg__Module__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_rtc_msgs__msg__Module__fini(&data[i]);
        }
        free(data);
        return false;
      }
