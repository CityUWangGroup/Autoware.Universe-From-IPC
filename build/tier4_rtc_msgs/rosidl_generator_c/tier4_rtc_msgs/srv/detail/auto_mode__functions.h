...
#ifndef TIER4_RTC_MSGS__SRV__DETAIL__AUTO_MODE__FUNCTIONS_H_
#define TIER4_RTC_MSGS__SRV__DETAIL__AUTO_MODE__FUNCTIONS_H_
...
/// Initialize srv/AutoMode message.
/**
...
/// Create srv/AutoMode message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_rtc_msgs__srv__AutoMode_Request__init().
...
/// Destroy srv/AutoMode message.
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoMode_Request__fini()
...
/// Check for srv/AutoMode message equality.
/**
...
/// Initialize array of srv/AutoMode messages.
/**
...
/// Finalize array of srv/AutoMode messages.
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoMode_Request__fini()
...
/// Create array of srv/AutoMode messages.
/**
 * It allocates the memory for the array and calls
 * tier4_rtc_msgs__srv__AutoMode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AutoMode messages.
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoMode_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AutoMode message array equality.
/**
...
/// Copy an array of srv/AutoMode messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_rtc_msgs__srv__AutoMode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_rtc_msgs
...
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoMode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_rtc_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_rtc_msgs__srv__AutoMode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_rtc_msgs
...
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoMode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_RTC_MSGS__SRV__DETAIL__AUTO_MODE__FUNCTIONS_H_
