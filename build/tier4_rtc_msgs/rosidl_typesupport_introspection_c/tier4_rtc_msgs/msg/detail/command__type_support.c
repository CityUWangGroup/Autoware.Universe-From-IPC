  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_rtc_msgs__msg__Command__init(message_memory);
}

void Command__rosidl_typesupport_introspection_c__Command_fini_function(void * message_memory)
{
  tier4_rtc_msgs__msg__Command__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Command__rosidl_typesupport_introspection_c__Command_message_member_array[1] = {
  {
    ...
    offsetof(tier4_rtc_msgs__msg__Command, type),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Command__rosidl_typesupport_introspection_c__Command_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_rtc_msgs__msg__Command),
