...
bool tier4_rtc_msgs__msg__cooperate_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_rtc_msgs.msg._cooperate_command.CooperateCommand", full_classname_dest, 54) == 0);
  }
  tier4_rtc_msgs__msg__CooperateCommand * ros_message = _ros_message;
  {  // uuid
  ...
  {  // command
    ...
    if (!tier4_rtc_msgs__msg__command__convert_from_py(field, &ros_message->command)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CooperateCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_rtc_msgs.msg._cooperate_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CooperateCommand");
  ...
  {  // command
    PyObject * field = NULL;
    field = tier4_rtc_msgs__msg__command__convert_to_py(&ros_message->command);
    if (!field) {
      return NULL;
    }
    {
