...
{
  new (message_memory) tier4_rtc_msgs::msg::Command(_init);
}

void Command_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_rtc_msgs::msg::Command *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_message_member_array[1] = {
  {
    ...
    offsetof(tier4_rtc_msgs::msg::Command, type),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_rtc_msgs::msg::Command),
...
{
  return &::tier4_rtc_msgs::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_rtc_msgs, msg, Command)() {
  return &::tier4_rtc_msgs::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
