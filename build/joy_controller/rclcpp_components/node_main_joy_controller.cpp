...
#define NODE_MAIN_LOGGER_NAME "joy_controller"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libjoy_controller_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<joy_controller::AutowareJoyControllerNode>";
