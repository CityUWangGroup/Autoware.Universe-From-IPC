...
static const _FloatStamped_type_support_symbol_names_t _FloatStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_performance_analysis, msg, FloatStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_performance_analysis, msg, FloatStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, control_performance_analysis, msg, FloatStamped)() {
  return &::control_performance_analysis::msg::rosidl_typesupport_c::FloatStamped_message_type_support_handle;
}
