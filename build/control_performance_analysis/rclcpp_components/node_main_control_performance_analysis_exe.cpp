...
#define NODE_MAIN_LOGGER_NAME "control_performance_analysis_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcontrol_performance_analysis_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<control_performance_analysis::ControlPerformanceAnalysisNode>";
