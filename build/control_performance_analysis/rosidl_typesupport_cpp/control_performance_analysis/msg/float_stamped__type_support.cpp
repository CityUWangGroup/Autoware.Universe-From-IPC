...
static const _FloatStamped_type_support_symbol_names_t _FloatStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_performance_analysis, msg, FloatStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_performance_analysis, msg, FloatStamped)),
  }
};
...
{
  return &::control_performance_analysis::msg::rosidl_typesupport_cpp::FloatStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_performance_analysis, msg, FloatStamped)() {
  return get_message_type_support_handle<control_performance_analysis::msg::FloatStamped>();
}
