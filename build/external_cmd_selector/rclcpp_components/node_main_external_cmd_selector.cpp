...
#define NODE_MAIN_LOGGER_NAME "external_cmd_selector"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libexternal_cmd_selector_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ExternalCmdSelector>";
