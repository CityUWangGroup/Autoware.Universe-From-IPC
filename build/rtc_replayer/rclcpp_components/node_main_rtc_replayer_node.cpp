...
#define NODE_MAIN_LOGGER_NAME "rtc_replayer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librtc_replayer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rtc_replayer::RTCReplayerNode>";
