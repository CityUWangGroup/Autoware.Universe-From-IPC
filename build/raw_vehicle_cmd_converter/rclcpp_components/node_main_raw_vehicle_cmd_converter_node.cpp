...
#define NODE_MAIN_LOGGER_NAME "raw_vehicle_cmd_converter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libraw_vehicle_cmd_converter_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<raw_vehicle_cmd_converter::RawVehicleCommandConverterNode>";
