...
#define NODE_MAIN_LOGGER_NAME "livox_tag_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblivox_tag_filter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<livox_tag_filter::LivoxTagFilterNode>";
