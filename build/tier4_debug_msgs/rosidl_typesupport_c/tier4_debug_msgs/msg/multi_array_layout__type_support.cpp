...
static const _MultiArrayLayout_type_support_symbol_names_t _MultiArrayLayout_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_debug_msgs, msg, MultiArrayLayout)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_debug_msgs, msg, MultiArrayLayout)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_debug_msgs, msg, MultiArrayLayout)() {
  return &::tier4_debug_msgs::msg::rosidl_typesupport_c::MultiArrayLayout_message_type_support_handle;
}
