...
#include <stddef.h>
#include "tier4_debug_msgs/msg/detail/int32_multi_array_stamped__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_debug_msgs__msg__Int32MultiArrayStamped__init(message_memory);
}
...
{
  tier4_debug_msgs__msg__Int32MultiArrayStamped__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Int32MultiArrayStamped__rosidl_typesupport_introspection_c__Int32MultiArrayStamped_message_member_array[3] = {
  {
    ...
    offsetof(tier4_debug_msgs__msg__Int32MultiArrayStamped, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_debug_msgs__msg__Int32MultiArrayStamped, layout),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_debug_msgs__msg__Int32MultiArrayStamped, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Int32MultiArrayStamped__rosidl_typesupport_introspection_c__Int32MultiArrayStamped_message_members = {
  ...
  3,  // number of fields
  sizeof(tier4_debug_msgs__msg__Int32MultiArrayStamped),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_debug_msgs, msg, Int32MultiArrayStamped)() {
