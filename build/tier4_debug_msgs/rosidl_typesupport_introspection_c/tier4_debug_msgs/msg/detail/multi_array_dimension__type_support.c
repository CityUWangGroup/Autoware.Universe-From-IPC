  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_debug_msgs__msg__MultiArrayDimension__init(message_memory);
}

void MultiArrayDimension__rosidl_typesupport_introspection_c__MultiArrayDimension_fini_function(void * message_memory)
{
  tier4_debug_msgs__msg__MultiArrayDimension__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MultiArrayDimension__rosidl_typesupport_introspection_c__MultiArrayDimension_message_member_array[3] = {
  {
    ...
    offsetof(tier4_debug_msgs__msg__MultiArrayDimension, label),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_debug_msgs__msg__MultiArrayDimension, size),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_debug_msgs__msg__MultiArrayDimension, stride),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MultiArrayDimension__rosidl_typesupport_introspection_c__MultiArrayDimension_message_members = {
  ...
  3,  // number of fields
  sizeof(tier4_debug_msgs__msg__MultiArrayDimension),
