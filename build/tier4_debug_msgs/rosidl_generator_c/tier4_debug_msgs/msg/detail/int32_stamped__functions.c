...
tier4_debug_msgs__msg__Int32Stamped__init(tier4_debug_msgs__msg__Int32Stamped * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    tier4_debug_msgs__msg__Int32Stamped__fini(msg);
    return false;
  }
  // data
  return true;
...
{
  tier4_debug_msgs__msg__Int32Stamped * msg = (tier4_debug_msgs__msg__Int32Stamped *)malloc(sizeof(tier4_debug_msgs__msg__Int32Stamped));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tier4_debug_msgs__msg__Int32Stamped));
  bool success = tier4_debug_msgs__msg__Int32Stamped__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
tier4_debug_msgs__msg__Int32Stamped__Sequence__init(tier4_debug_msgs__msg__Int32Stamped__Sequence * array, size_t size)
{
  ...
  tier4_debug_msgs__msg__Int32Stamped * data = NULL;
  if (size) {
    data = (tier4_debug_msgs__msg__Int32Stamped *)calloc(size, sizeof(tier4_debug_msgs__msg__Int32Stamped));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tier4_debug_msgs__msg__Int32Stamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tier4_debug_msgs__msg__Int32Stamped__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tier4_debug_msgs__msg__Int32Stamped__Sequence__fini(tier4_debug_msgs__msg__Int32Stamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tier4_debug_msgs__msg__Int32Stamped__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tier4_debug_msgs__msg__Int32Stamped__Sequence * array = (tier4_debug_msgs__msg__Int32Stamped__Sequence *)malloc(sizeof(tier4_debug_msgs__msg__Int32Stamped__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tier4_debug_msgs__msg__Int32Stamped__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tier4_debug_msgs__msg__Int32Stamped__Sequence__fini(array);
  }
  free(array);
}
...
tier4_debug_msgs__msg__Int32Stamped__Sequence__are_equal(const tier4_debug_msgs__msg__Int32Stamped__Sequence * lhs, const tier4_debug_msgs__msg__Int32Stamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tier4_debug_msgs__msg__Int32Stamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tier4_debug_msgs__msg__Int32Stamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tier4_debug_msgs__msg__Int32Stamped);
    tier4_debug_msgs__msg__Int32Stamped * data =
      (tier4_debug_msgs__msg__Int32Stamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_debug_msgs__msg__Int32Stamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_debug_msgs__msg__Int32Stamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tier4_debug_msgs__msg__Int32Stamped__copy(
