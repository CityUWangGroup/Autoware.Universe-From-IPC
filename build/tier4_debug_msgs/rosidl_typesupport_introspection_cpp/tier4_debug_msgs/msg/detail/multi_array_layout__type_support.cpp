...
{
  new (message_memory) tier4_debug_msgs::msg::MultiArrayLayout(_init);
}

void MultiArrayLayout_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_debug_msgs::msg::MultiArrayLayout *>(message_memory);
  typed_message->~MultiArrayLayout();
}

size_t size_function__MultiArrayLayout__dim(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<tier4_debug_msgs::msg::MultiArrayDimension> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<tier4_debug_msgs::msg::MultiArrayDimension> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<tier4_debug_msgs::msg::MultiArrayDimension> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiArrayLayout_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<tier4_debug_msgs::msg::MultiArrayDimension>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_debug_msgs::msg::MultiArrayLayout, dim),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_debug_msgs::msg::MultiArrayLayout, data_offset),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MultiArrayLayout_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_debug_msgs::msg::MultiArrayLayout),
...
{
  return &::tier4_debug_msgs::msg::rosidl_typesupport_introspection_cpp::MultiArrayLayout_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_debug_msgs, msg, MultiArrayLayout)() {
  return &::tier4_debug_msgs::msg::rosidl_typesupport_introspection_cpp::MultiArrayLayout_message_type_support_handle;
}
