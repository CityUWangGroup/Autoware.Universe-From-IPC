...
class Metaclass_MultiArrayLayout(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tier4_debug_msgs')
        except ImportError:
            import logging
            import traceback
            ...
            from tier4_debug_msgs.msg import MultiArrayDimension
...
class MultiArrayLayout(metaclass=Metaclass_MultiArrayLayout):
    ...
    _fields_and_field_types = {
        'dim': 'sequence<tier4_debug_msgs/MultiArrayDimension>',
        'data_offset': 'uint32',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['tier4_debug_msgs', 'msg'], 'MultiArrayDimension')),  # noqa: E501
