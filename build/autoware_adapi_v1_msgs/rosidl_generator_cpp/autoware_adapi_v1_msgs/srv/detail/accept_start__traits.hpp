...
inline void to_yaml(
  const autoware_adapi_v1_msgs::srv::AcceptStart_Request & msg,
...
inline std::string to_yaml(const autoware_adapi_v1_msgs::srv::AcceptStart_Request & msg)
{
...
inline void to_yaml(
  const autoware_adapi_v1_msgs::srv::AcceptStart_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  // member: status
  {
...
inline std::string to_yaml(const autoware_adapi_v1_msgs::srv::AcceptStart_Response & msg)
{
  std::ostringstream out;
  to_yaml(msg, out);
  return out.str();
