...
inline void to_yaml(
  const autoware_adapi_v1_msgs::msg::LocalizationInitializationState & msg,
...
inline std::string to_yaml(const autoware_adapi_v1_msgs::msg::LocalizationInitializationState & msg)
{
