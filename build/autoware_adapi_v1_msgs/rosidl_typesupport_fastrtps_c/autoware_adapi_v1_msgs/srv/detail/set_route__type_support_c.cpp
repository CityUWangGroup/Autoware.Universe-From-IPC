...
#include "autoware_adapi_v1_msgs/srv/detail/set_route__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_adapi_v1_msgs/msg/detail/route_segment__functions.h"  // segments
...
using _SetRoute_Request__ros_msg_type = autoware_adapi_v1_msgs__srv__SetRoute_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: segments
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, msg, RouteSegment
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: segments
  {
    ...
    if (ros_message->segments.data) {
      autoware_adapi_v1_msgs__msg__RouteSegment__Sequence__fini(&ros_message->segments);
    }
...
size_t get_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetRoute_Request__ros_msg_type * ros_message = static_cast<const _SetRoute_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_autoware_adapi_v1_msgs__msg__RouteSegment(
...
static uint32_t _SetRoute_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_adapi_v1_msgs
size_t max_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_adapi_v1_msgs__msg__RouteSegment(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetRoute_Request)() {
...
using _SetRoute_Response__ros_msg_type = autoware_adapi_v1_msgs__srv__SetRoute_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_adapi_v1_msgs
size_t get_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetRoute_Response__ros_msg_type * ros_message = static_cast<const _SetRoute_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_adapi_v1_msgs
size_t max_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_adapi_v1_msgs__srv__SetRoute_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetRoute_Response)() {
...
// already included above
// #include "autoware_adapi_v1_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "autoware_adapi_v1_msgs/srv/set_route.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetRoute)() {
