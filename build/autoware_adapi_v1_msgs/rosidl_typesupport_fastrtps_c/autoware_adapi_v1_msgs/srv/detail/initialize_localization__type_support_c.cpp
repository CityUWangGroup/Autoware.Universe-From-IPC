...
static size_t _InitializeLocalization_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_adapi_v1_msgs__srv__InitializeLocalization_Request(
    full_bounded, 0);
}
...
static size_t _InitializeLocalization_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_adapi_v1_msgs__srv__InitializeLocalization_Response(
    full_bounded, 0);
}
