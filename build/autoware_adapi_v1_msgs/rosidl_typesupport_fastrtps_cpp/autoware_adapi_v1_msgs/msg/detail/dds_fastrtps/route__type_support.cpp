...
#include "autoware_adapi_v1_msgs/msg/detail/route__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_adapi_v1_msgs::msg::RouteData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autoware_adapi_v1_msgs::msg::Route & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_adapi_v1_msgs::msg::Route & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autoware_adapi_v1_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RouteData(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const autoware_adapi_v1_msgs::msg::Route *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_adapi_v1_msgs::msg::Route *>(
    untyped_ros_message);
...
{
  return &autoware_adapi_v1_msgs::msg::typesupport_fastrtps_cpp::_Route__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_adapi_v1_msgs, msg, Route)() {
  return &autoware_adapi_v1_msgs::msg::typesupport_fastrtps_cpp::_Route__handle;
}
