...
class Metaclass_Route(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_adapi_v1_msgs.msg import RouteData
            if RouteData.__class__._TYPE_SUPPORT is None:
                RouteData.__class__.__import_type_support__()
...
class Route(metaclass=Metaclass_Route):
    ...
    _fields_and_field_types = {
        ...
        'data': 'sequence<autoware_adapi_v1_msgs/RouteData, 1>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autoware_adapi_v1_msgs', 'msg'], 'RouteData'), 1),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, RouteData) for v in value) and
                 True), \
                "The 'data' field must be a set or sequence with length <= 1 and each value of type 'RouteData'"
        self._data = value
