...
class Metaclass_RouteState(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'ARRIVED': cls.__constants['ARRIVED'],
            'CHANGING': cls.__constants['CHANGING'],
        }

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_RouteState.__constants['UNKNOWN']

    @property
    def UNSET(self):
        """Message constant 'UNSET'."""
        return Metaclass_RouteState.__constants['UNSET']

    @property
    def SET(self):
        """Message constant 'SET'."""
        return Metaclass_RouteState.__constants['SET']

    @property
    def ARRIVED(self):
        """Message constant 'ARRIVED'."""
        return Metaclass_RouteState.__constants['ARRIVED']

    @property
    def CHANGING(self):
        """Message constant 'CHANGING'."""
        return Metaclass_RouteState.__constants['CHANGING']
