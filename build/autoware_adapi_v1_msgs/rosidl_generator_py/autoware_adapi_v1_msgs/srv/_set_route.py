...
class Metaclass_SetRoute_Response(type):
    ...
    def ERROR_ROUTE_EXISTS(self):
        ...
        return Metaclass_SetRoute_Response.__constants['ERROR_ROUTE_EXISTS']

    @property
    def ERROR_PLANNER_UNREADY(self):
        """Message constant 'ERROR_PLANNER_UNREADY'."""
        return Metaclass_SetRoute_Response.__constants['ERROR_PLANNER_UNREADY']

    @property
    def ERROR_PLANNER_FAILED(self):
        """Message constant 'ERROR_PLANNER_FAILED'."""
        return Metaclass_SetRoute_Response.__constants['ERROR_PLANNER_FAILED']
...
class Metaclass_SetRoute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_adapi_v1_msgs.srv import _set_route
...
class SetRoute(metaclass=Metaclass_SetRoute):
    from autoware_adapi_v1_msgs.srv._set_route import SetRoute_Request as Request
    from autoware_adapi_v1_msgs.srv._set_route import SetRoute_Response as Response
