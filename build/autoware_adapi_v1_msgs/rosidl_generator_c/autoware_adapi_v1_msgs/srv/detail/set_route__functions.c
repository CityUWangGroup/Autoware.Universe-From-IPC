...
{
  autoware_adapi_v1_msgs__srv__SetRoute_Request * msg = (autoware_adapi_v1_msgs__srv__SetRoute_Request *)malloc(sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Request));
  if (!msg) {
    return NULL;
  }
...
autoware_adapi_v1_msgs__srv__SetRoute_Request__Sequence__init(autoware_adapi_v1_msgs__srv__SetRoute_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_adapi_v1_msgs__srv__SetRoute_Request *)calloc(size, sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Request));
    if (!data) {
      return false;
    }
...
{
  autoware_adapi_v1_msgs__srv__SetRoute_Request__Sequence * array = (autoware_adapi_v1_msgs__srv__SetRoute_Request__Sequence *)malloc(sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_adapi_v1_msgs__srv__SetRoute_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_adapi_v1_msgs__srv__SetRoute_Request * data =
      (autoware_adapi_v1_msgs__srv__SetRoute_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__srv__SetRoute_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__srv__SetRoute_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  autoware_adapi_v1_msgs__srv__SetRoute_Response * msg = (autoware_adapi_v1_msgs__srv__SetRoute_Response *)malloc(sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Response));
  if (!msg) {
    return NULL;
  }
...
autoware_adapi_v1_msgs__srv__SetRoute_Response__Sequence__init(autoware_adapi_v1_msgs__srv__SetRoute_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_adapi_v1_msgs__srv__SetRoute_Response *)calloc(size, sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  autoware_adapi_v1_msgs__srv__SetRoute_Response__Sequence * array = (autoware_adapi_v1_msgs__srv__SetRoute_Response__Sequence *)malloc(sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_adapi_v1_msgs__srv__SetRoute_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_adapi_v1_msgs__srv__SetRoute_Response * data =
      (autoware_adapi_v1_msgs__srv__SetRoute_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__srv__SetRoute_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__srv__SetRoute_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
