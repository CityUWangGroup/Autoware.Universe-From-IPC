...
{
  autoware_adapi_v1_msgs__msg__VelocityFactorArray * msg = (autoware_adapi_v1_msgs__msg__VelocityFactorArray *)malloc(sizeof(autoware_adapi_v1_msgs__msg__VelocityFactorArray));
  if (!msg) {
    return NULL;
  }
...
autoware_adapi_v1_msgs__msg__VelocityFactorArray__Sequence__init(autoware_adapi_v1_msgs__msg__VelocityFactorArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_adapi_v1_msgs__msg__VelocityFactorArray *)calloc(size, sizeof(autoware_adapi_v1_msgs__msg__VelocityFactorArray));
    if (!data) {
      return false;
    }
...
{
  autoware_adapi_v1_msgs__msg__VelocityFactorArray__Sequence * array = (autoware_adapi_v1_msgs__msg__VelocityFactorArray__Sequence *)malloc(sizeof(autoware_adapi_v1_msgs__msg__VelocityFactorArray__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_adapi_v1_msgs__msg__VelocityFactorArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_adapi_v1_msgs__msg__VelocityFactorArray * data =
      (autoware_adapi_v1_msgs__msg__VelocityFactorArray *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__VelocityFactorArray__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__msg__VelocityFactorArray__fini(&data[i]);
        }
        free(data);
        return false;
      }
