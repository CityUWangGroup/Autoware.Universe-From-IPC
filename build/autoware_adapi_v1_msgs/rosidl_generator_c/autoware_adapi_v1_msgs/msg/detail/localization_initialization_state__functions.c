...
{
  autoware_adapi_v1_msgs__msg__LocalizationInitializationState * msg = (autoware_adapi_v1_msgs__msg__LocalizationInitializationState *)malloc(sizeof(autoware_adapi_v1_msgs__msg__LocalizationInitializationState));
  if (!msg) {
    return NULL;
  }
...
autoware_adapi_v1_msgs__msg__LocalizationInitializationState__Sequence__init(autoware_adapi_v1_msgs__msg__LocalizationInitializationState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_adapi_v1_msgs__msg__LocalizationInitializationState *)calloc(size, sizeof(autoware_adapi_v1_msgs__msg__LocalizationInitializationState));
    if (!data) {
      return false;
    }
...
{
  autoware_adapi_v1_msgs__msg__LocalizationInitializationState__Sequence * array = (autoware_adapi_v1_msgs__msg__LocalizationInitializationState__Sequence *)malloc(sizeof(autoware_adapi_v1_msgs__msg__LocalizationInitializationState__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_adapi_v1_msgs__msg__LocalizationInitializationState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_adapi_v1_msgs__msg__LocalizationInitializationState * data =
      (autoware_adapi_v1_msgs__msg__LocalizationInitializationState *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__LocalizationInitializationState__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__msg__LocalizationInitializationState__fini(&data[i]);
        }
        free(data);
        return false;
      }
