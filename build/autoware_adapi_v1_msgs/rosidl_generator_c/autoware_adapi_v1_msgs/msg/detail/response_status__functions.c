...
{
  autoware_adapi_v1_msgs__msg__ResponseStatus * msg = (autoware_adapi_v1_msgs__msg__ResponseStatus *)malloc(sizeof(autoware_adapi_v1_msgs__msg__ResponseStatus));
  if (!msg) {
    return NULL;
  }
...
autoware_adapi_v1_msgs__msg__ResponseStatus__Sequence__init(autoware_adapi_v1_msgs__msg__ResponseStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_adapi_v1_msgs__msg__ResponseStatus *)calloc(size, sizeof(autoware_adapi_v1_msgs__msg__ResponseStatus));
    if (!data) {
      return false;
    }
...
{
  autoware_adapi_v1_msgs__msg__ResponseStatus__Sequence * array = (autoware_adapi_v1_msgs__msg__ResponseStatus__Sequence *)malloc(sizeof(autoware_adapi_v1_msgs__msg__ResponseStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_adapi_v1_msgs__msg__ResponseStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_adapi_v1_msgs__msg__ResponseStatus * data =
      (autoware_adapi_v1_msgs__msg__ResponseStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__ResponseStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__msg__ResponseStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
