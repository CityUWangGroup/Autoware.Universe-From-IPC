...
{
  autoware_adapi_v1_msgs__msg__OperationModeState * msg = (autoware_adapi_v1_msgs__msg__OperationModeState *)malloc(sizeof(autoware_adapi_v1_msgs__msg__OperationModeState));
  if (!msg) {
    return NULL;
  }
...
autoware_adapi_v1_msgs__msg__OperationModeState__Sequence__init(autoware_adapi_v1_msgs__msg__OperationModeState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_adapi_v1_msgs__msg__OperationModeState *)calloc(size, sizeof(autoware_adapi_v1_msgs__msg__OperationModeState));
    if (!data) {
      return false;
    }
...
{
  autoware_adapi_v1_msgs__msg__OperationModeState__Sequence * array = (autoware_adapi_v1_msgs__msg__OperationModeState__Sequence *)malloc(sizeof(autoware_adapi_v1_msgs__msg__OperationModeState__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_adapi_v1_msgs__msg__OperationModeState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_adapi_v1_msgs__msg__OperationModeState * data =
      (autoware_adapi_v1_msgs__msg__OperationModeState *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__OperationModeState__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__msg__OperationModeState__fini(&data[i]);
        }
        free(data);
        return false;
      }
