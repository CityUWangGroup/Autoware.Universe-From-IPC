...
{
  autoware_adapi_v1_msgs__msg__RouteSegment * msg = (autoware_adapi_v1_msgs__msg__RouteSegment *)malloc(sizeof(autoware_adapi_v1_msgs__msg__RouteSegment));
  if (!msg) {
    return NULL;
  }
...
autoware_adapi_v1_msgs__msg__RouteSegment__Sequence__init(autoware_adapi_v1_msgs__msg__RouteSegment__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_adapi_v1_msgs__msg__RouteSegment *)calloc(size, sizeof(autoware_adapi_v1_msgs__msg__RouteSegment));
    if (!data) {
      return false;
    }
...
{
  autoware_adapi_v1_msgs__msg__RouteSegment__Sequence * array = (autoware_adapi_v1_msgs__msg__RouteSegment__Sequence *)malloc(sizeof(autoware_adapi_v1_msgs__msg__RouteSegment__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_adapi_v1_msgs__msg__RouteSegment__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_adapi_v1_msgs__msg__RouteSegment * data =
      (autoware_adapi_v1_msgs__msg__RouteSegment *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__RouteSegment__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__msg__RouteSegment__fini(&data[i]);
        }
        free(data);
        return false;
      }
