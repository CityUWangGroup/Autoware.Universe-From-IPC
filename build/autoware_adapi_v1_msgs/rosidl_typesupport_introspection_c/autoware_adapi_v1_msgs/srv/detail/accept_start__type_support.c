...
void AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_init_function(
...
void AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_fini_function(void * message_memory)
{
  autoware_adapi_v1_msgs__srv__AcceptStart_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_members = {
  ...
  AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_member_array,  // message members
  AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_type_support_handle = {
  0,
  &AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, AcceptStart_Request)() {
  if (!AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_type_support_handle.typesupport_identifier) {
    AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &AcceptStart_Request__rosidl_typesupport_introspection_c__AcceptStart_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_fini_function(void * message_memory)
{
  autoware_adapi_v1_msgs__srv__AcceptStart_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_member_array[1] = {
  {
    "status",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_members = {
  "autoware_adapi_v1_msgs__srv",  // message namespace
  "AcceptStart_Response",  // message name
  1,  // number of fields
  sizeof(autoware_adapi_v1_msgs__srv__AcceptStart_Response),
  AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_member_array,  // message members
  AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_type_support_handle = {
  0,
  &AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, AcceptStart_Response)() {
  AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_member_array[0].members_ =
  ...
  if (!AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_type_support_handle.typesupport_identifier) {
    AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &AcceptStart_Response__rosidl_typesupport_introspection_c__AcceptStart_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
