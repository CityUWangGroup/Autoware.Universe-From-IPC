...
#include <stddef.h>
#include "autoware_adapi_v1_msgs/srv/detail/set_route__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_adapi_v1_msgs__srv__SetRoute_Request__init(message_memory);
}

void SetRoute_Request__rosidl_typesupport_introspection_c__SetRoute_Request_fini_function(void * message_memory)
{
  autoware_adapi_v1_msgs__srv__SetRoute_Request__fini(message_memory);
}

size_t SetRoute_Request__rosidl_typesupport_introspection_c__size_function__RouteSegment__segments(
...
const void * SetRoute_Request__rosidl_typesupport_introspection_c__get_const_function__RouteSegment__segments(
...
void * SetRoute_Request__rosidl_typesupport_introspection_c__get_function__RouteSegment__segments(
...
bool SetRoute_Request__rosidl_typesupport_introspection_c__resize_function__RouteSegment__segments(
...
static rosidl_typesupport_introspection_c__MessageMember SetRoute_Request__rosidl_typesupport_introspection_c__SetRoute_Request_message_member_array[3] = {
  {
    ...
    offsetof(autoware_adapi_v1_msgs__srv__SetRoute_Request, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__srv__SetRoute_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__srv__SetRoute_Request, segments),  // bytes offset in struct
    NULL,  // default value
    SetRoute_Request__rosidl_typesupport_introspection_c__size_function__RouteSegment__segments,  // size() function pointer
    SetRoute_Request__rosidl_typesupport_introspection_c__get_const_function__RouteSegment__segments,  // get_const(index) function pointer
    SetRoute_Request__rosidl_typesupport_introspection_c__get_function__RouteSegment__segments,  // get(index) function pointer
    SetRoute_Request__rosidl_typesupport_introspection_c__resize_function__RouteSegment__segments  // resize(index) function pointer
  }
};
...
static const rosidl_typesupport_introspection_c__MessageMembers SetRoute_Request__rosidl_typesupport_introspection_c__SetRoute_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoute_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  autoware_adapi_v1_msgs__srv__SetRoute_Response__init(message_memory);
}

void SetRoute_Response__rosidl_typesupport_introspection_c__SetRoute_Response_fini_function(void * message_memory)
{
  autoware_adapi_v1_msgs__srv__SetRoute_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetRoute_Response__rosidl_typesupport_introspection_c__SetRoute_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__srv__SetRoute_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetRoute_Response__rosidl_typesupport_introspection_c__SetRoute_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(autoware_adapi_v1_msgs__srv__SetRoute_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_autoware_adapi_v1_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoute_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_service_members = {
  "autoware_adapi_v1_msgs__srv",  // service namespace
  "SetRoute",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_Request_message_type_support_handle,
  NULL  // response message
  // autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_Response_message_type_support_handle
};

static rosidl_service_type_support_t autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_service_type_support_handle = {
  0,
  &autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoute)() {
  if (!autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_service_type_support_handle.typesupport_identifier) {
    autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoute_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoute_Response)()->data;
  }

  return &autoware_adapi_v1_msgs__srv__detail__set_route__rosidl_typesupport_introspection_c__SetRoute_service_type_support_handle;
}
