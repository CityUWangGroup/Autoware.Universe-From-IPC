...
#include <stddef.h>
#include "autoware_adapi_v1_msgs/srv/detail/change_operation_mode__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_adapi_v1_msgs__srv__ChangeOperationMode_Request__init(message_memory);
}
...
{
  autoware_adapi_v1_msgs__srv__ChangeOperationMode_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ChangeOperationMode_Request__rosidl_typesupport_introspection_c__ChangeOperationMode_Request_message_member_array[1] = {
  {
    ...
    offsetof(autoware_adapi_v1_msgs__srv__ChangeOperationMode_Request, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers ChangeOperationMode_Request__rosidl_typesupport_introspection_c__ChangeOperationMode_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(autoware_adapi_v1_msgs__srv__ChangeOperationMode_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, ChangeOperationMode_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  autoware_adapi_v1_msgs__srv__ChangeOperationMode_Response__init(message_memory);
}
...
{
  autoware_adapi_v1_msgs__srv__ChangeOperationMode_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ChangeOperationMode_Response__rosidl_typesupport_introspection_c__ChangeOperationMode_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__srv__ChangeOperationMode_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ChangeOperationMode_Response__rosidl_typesupport_introspection_c__ChangeOperationMode_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(autoware_adapi_v1_msgs__srv__ChangeOperationMode_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_autoware_adapi_v1_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, ChangeOperationMode_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_service_members = {
  "autoware_adapi_v1_msgs__srv",  // service namespace
  "ChangeOperationMode",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_Request_message_type_support_handle,
  NULL  // response message
  // autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_Response_message_type_support_handle
};

static rosidl_service_type_support_t autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_service_type_support_handle = {
  0,
  &autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, ChangeOperationMode)() {
  if (!autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_service_type_support_handle.typesupport_identifier) {
    autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, ChangeOperationMode_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, ChangeOperationMode_Response)()->data;
  }

  return &autoware_adapi_v1_msgs__srv__detail__change_operation_mode__rosidl_typesupport_introspection_c__ChangeOperationMode_service_type_support_handle;
}
