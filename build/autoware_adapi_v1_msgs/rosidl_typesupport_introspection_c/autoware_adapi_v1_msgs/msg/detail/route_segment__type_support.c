...
size_t RouteSegment__rosidl_typesupport_introspection_c__size_function__RoutePrimitive__alternatives(
...
const void * RouteSegment__rosidl_typesupport_introspection_c__get_const_function__RoutePrimitive__alternatives(
...
void * RouteSegment__rosidl_typesupport_introspection_c__get_function__RoutePrimitive__alternatives(
...
bool RouteSegment__rosidl_typesupport_introspection_c__resize_function__RoutePrimitive__alternatives(
...
static rosidl_typesupport_introspection_c__MessageMember RouteSegment__rosidl_typesupport_introspection_c__RouteSegment_message_member_array[2] = {
  {
    "preferred",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    RouteSegment__rosidl_typesupport_introspection_c__size_function__RoutePrimitive__alternatives,  // size() function pointer
    RouteSegment__rosidl_typesupport_introspection_c__get_const_function__RoutePrimitive__alternatives,  // get_const(index) function pointer
    RouteSegment__rosidl_typesupport_introspection_c__get_function__RoutePrimitive__alternatives,  // get(index) function pointer
    RouteSegment__rosidl_typesupport_introspection_c__resize_function__RoutePrimitive__alternatives  // resize(index) function pointer
  }
};
