...
static const _InitializeLocalization_Request_type_support_symbol_names_t _InitializeLocalization_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, InitializeLocalization_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, InitializeLocalization_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, InitializeLocalization_Request)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::InitializeLocalization_Request_message_type_support_handle;
}
...
static const _InitializeLocalization_Response_type_support_symbol_names_t _InitializeLocalization_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, InitializeLocalization_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, InitializeLocalization_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_adapi_v1_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, InitializeLocalization_Response)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::InitializeLocalization_Response_message_type_support_handle;
}
...
static const _InitializeLocalization_type_support_symbol_names_t _InitializeLocalization_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, InitializeLocalization)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, InitializeLocalization)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, InitializeLocalization)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::InitializeLocalization_service_type_support_handle;
}
