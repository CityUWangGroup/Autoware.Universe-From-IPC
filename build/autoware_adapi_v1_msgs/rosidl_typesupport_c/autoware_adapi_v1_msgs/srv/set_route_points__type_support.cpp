...
static const _SetRoutePoints_Request_type_support_symbol_names_t _SetRoutePoints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetRoutePoints_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoutePoints_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SetRoutePoints_Request)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SetRoutePoints_Request_message_type_support_handle;
}
...
static const _SetRoutePoints_Response_type_support_symbol_names_t _SetRoutePoints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetRoutePoints_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoutePoints_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_adapi_v1_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SetRoutePoints_Response)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SetRoutePoints_Response_message_type_support_handle;
}
...
static const _SetRoutePoints_type_support_symbol_names_t _SetRoutePoints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetRoutePoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoutePoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SetRoutePoints)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SetRoutePoints_service_type_support_handle;
}
