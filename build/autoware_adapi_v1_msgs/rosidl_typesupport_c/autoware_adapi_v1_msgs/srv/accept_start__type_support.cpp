...
static const _AcceptStart_Request_type_support_symbol_names_t _AcceptStart_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, AcceptStart_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, AcceptStart_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, AcceptStart_Request)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::AcceptStart_Request_message_type_support_handle;
}
...
static const _AcceptStart_Response_type_support_symbol_names_t _AcceptStart_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, AcceptStart_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, AcceptStart_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_adapi_v1_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, AcceptStart_Response)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::AcceptStart_Response_message_type_support_handle;
}
...
static const _AcceptStart_type_support_symbol_names_t _AcceptStart_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, AcceptStart)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, AcceptStart)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, AcceptStart)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::AcceptStart_service_type_support_handle;
}
