...
#define NODE_MAIN_LOGGER_NAME "lateral_error_publisher_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblateral_error_publisher.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<LateralErrorPublisher>";
