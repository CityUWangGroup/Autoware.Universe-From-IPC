...
#define NODE_MAIN_LOGGER_NAME "costmap_generator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcostmap_generator_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<CostmapGenerator>";
