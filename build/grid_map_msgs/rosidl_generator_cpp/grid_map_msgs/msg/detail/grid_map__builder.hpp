...
{
public:
  explicit Init_GridMap_info(::grid_map_msgs::msg::GridMap & msg)
  : msg_(msg)
  {}
...
class Init_GridMap_header
{
public:
  Init_GridMap_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GridMap_info header(::grid_map_msgs::msg::GridMap::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_GridMap_info(msg_);
  }
...
{
  return grid_map_msgs::msg::builder::Init_GridMap_header();
}
