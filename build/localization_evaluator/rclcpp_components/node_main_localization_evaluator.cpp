...
#define NODE_MAIN_LOGGER_NAME "localization_evaluator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblocalization_evaluator_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<localization_diagnostics::LocalizationEvaluatorNode>";
