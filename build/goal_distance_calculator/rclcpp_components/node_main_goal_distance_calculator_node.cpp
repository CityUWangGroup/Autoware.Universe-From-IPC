...
#define NODE_MAIN_LOGGER_NAME "goal_distance_calculator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgoal_distance_calculator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<goal_distance_calculator::GoalDistanceCalculatorNode>";
