  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: new_trajectory
  {
    ...
    out << "new_trajectory: ";
    value_to_yaml(msg.new_trajectory, out);
    out << "\n";
  }
  ...
  // member: trajectory_source
  {
    ...
    value_to_yaml(msg.trajectory_source, out);
    out << "\n";
  }
  ...
  // member: pose_source
  {
    ...
    out << "pose_source: ";
    value_to_yaml(msg.pose_source, out);
    out << "\n";
  }
  ...
  // member: lateral_error_m
  {
    ...
    out << "lateral_error_m: ";
    value_to_yaml(msg.lateral_error_m, out);
    out << "\n";
  }
  ...
  // member: longitudinal_error_m
  {
    ...
    value_to_yaml(msg.longitudinal_error_m, out);
    out << "\n";
  }
  ...
  // member: velocity_error_mps
  {
    ...
    value_to_yaml(msg.velocity_error_mps, out);
    out << "\n";
  }
  ...
  // member: acceleration_error_mps2
  {
    ...
    value_to_yaml(msg.acceleration_error_mps2, out);
    out << "\n";
  }
  ...
  // member: yaw_error_rad
  {
    ...
    out << "yaw_error_rad: ";
    value_to_yaml(msg.yaw_error_rad, out);
    out << "\n";
  }
  ...
  // member: yaw_rate_error_rps
  {
    ...
    value_to_yaml(msg.yaw_rate_error_rps, out);
    out << "\n";
  }
