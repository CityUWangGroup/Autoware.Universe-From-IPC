...
bool
autoware_auto_system_msgs__msg__HazardStatusStamped__are_equal(const autoware_auto_system_msgs__msg__HazardStatusStamped * lhs, const autoware_auto_system_msgs__msg__HazardStatusStamped * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_auto_system_msgs__msg__HazardStatusStamped__copy(
  const autoware_auto_system_msgs__msg__HazardStatusStamped * input,
  autoware_auto_system_msgs__msg__HazardStatusStamped * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence__are_equal(const autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence * lhs, const autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_system_msgs__msg__HazardStatusStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence__copy(
  const autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence * input,
  autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_system_msgs__msg__HazardStatusStamped);
    autoware_auto_system_msgs__msg__HazardStatusStamped * data =
      (autoware_auto_system_msgs__msg__HazardStatusStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_system_msgs__msg__HazardStatusStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_system_msgs__msg__HazardStatusStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_system_msgs__msg__HazardStatusStamped__copy(
