...
#define NODE_MAIN_LOGGER_NAME "multi_object_tracker"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmulti_object_tracker_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<MultiObjectTracker>";
