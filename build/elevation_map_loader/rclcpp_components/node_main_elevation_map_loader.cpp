...
#define NODE_MAIN_LOGGER_NAME "elevation_map_loader"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libelevation_map_loader_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ElevationMapLoaderNode>";
