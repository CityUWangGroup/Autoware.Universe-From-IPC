...
#define NODE_MAIN_LOGGER_NAME "mrm_comfortable_stop_operator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmrm_comfortable_stop_operator_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mrm_comfortable_stop_operator::MrmComfortableStopOperator>";
