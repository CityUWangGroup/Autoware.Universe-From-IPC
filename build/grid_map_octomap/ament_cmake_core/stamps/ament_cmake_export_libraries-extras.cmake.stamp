...
set(_exported_libraries "grid_map_octomap;/opt/ros/galactic/lib/liboctomap.so;/opt/ros/galactic/lib/liboctomath.so")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'grid_map_octomap' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND grid_map_octomap_LIBRARIES ${_cfg} "${_lib}")
