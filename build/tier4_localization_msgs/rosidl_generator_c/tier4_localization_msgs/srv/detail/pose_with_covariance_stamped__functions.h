...
#ifndef TIER4_LOCALIZATION_MSGS__SRV__DETAIL__POSE_WITH_COVARIANCE_STAMPED__FUNCTIONS_H_
#define TIER4_LOCALIZATION_MSGS__SRV__DETAIL__POSE_WITH_COVARIANCE_STAMPED__FUNCTIONS_H_
...
#include "tier4_localization_msgs/msg/rosidl_generator_c__visibility_control.h"

#include "tier4_localization_msgs/srv/detail/pose_with_covariance_stamped__struct.h"

/// Initialize srv/PoseWithCovarianceStamped message.
/**
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_localization_msgs
bool
...
/// Finalize srv/PoseWithCovarianceStamped message.
/**
...
/// Create srv/PoseWithCovarianceStamped message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Request__init().
...
/// Destroy srv/PoseWithCovarianceStamped message.
/**
 * It calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Request__fini()
...
/// Check for srv/PoseWithCovarianceStamped message equality.
/**
...
/// Copy a srv/PoseWithCovarianceStamped message.
/**
...
/// Initialize array of srv/PoseWithCovarianceStamped messages.
/**
...
/// Finalize array of srv/PoseWithCovarianceStamped messages.
/**
 * It calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Request__fini()
...
/// Create array of srv/PoseWithCovarianceStamped messages.
/**
 * It allocates the memory for the array and calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PoseWithCovarianceStamped messages.
/**
 * It calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PoseWithCovarianceStamped message array equality.
/**
...
/// Copy an array of srv/PoseWithCovarianceStamped messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_localization_msgs
...
/**
 * It calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_localization_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_localization_msgs
...
/**
 * It calls
 * tier4_localization_msgs__srv__PoseWithCovarianceStamped_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_LOCALIZATION_MSGS__SRV__DETAIL__POSE_WITH_COVARIANCE_STAMPED__FUNCTIONS_H_
