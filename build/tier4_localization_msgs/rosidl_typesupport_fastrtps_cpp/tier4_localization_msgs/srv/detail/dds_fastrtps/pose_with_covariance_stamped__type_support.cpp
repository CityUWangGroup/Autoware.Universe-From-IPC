...
{
  return max_serialized_size_PoseWithCovarianceStamped_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_PoseWithCovarianceStamped_Response(full_bounded, 0);
}
