...
#define NODE_MAIN_LOGGER_NAME "mrm_emergency_stop_operator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmrm_emergency_stop_operator_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mrm_emergency_stop_operator::MrmEmergencyStopOperator>";
