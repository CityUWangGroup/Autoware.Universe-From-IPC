...
#define NODE_MAIN_LOGGER_NAME "simple_trajectory_follower_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsimple_trajectory_follower.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<simple_trajectory_follower::SimpleTrajectoryFollower>";
