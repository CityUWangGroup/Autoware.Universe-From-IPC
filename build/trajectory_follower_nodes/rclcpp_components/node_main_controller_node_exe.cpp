...
#define NODE_MAIN_LOGGER_NAME "controller_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcontroller_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::motion::control::trajectory_follower_nodes::Controller>";
