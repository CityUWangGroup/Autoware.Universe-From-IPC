...
#define NODE_MAIN_LOGGER_NAME "lidar_centerpoint_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblidar_centerpoint_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<centerpoint::LidarCenterPointNode>";
