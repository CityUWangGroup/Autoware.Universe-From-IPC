...
#define NODE_MAIN_LOGGER_NAME "single_inference_lidar_centerpoint_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsingle_inference_lidar_centerpoint_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<centerpoint::SingleInferenceLidarCenterPointNode>";
