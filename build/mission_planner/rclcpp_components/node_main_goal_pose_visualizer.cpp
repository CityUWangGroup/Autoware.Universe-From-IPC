...
#define NODE_MAIN_LOGGER_NAME "goal_pose_visualizer"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgoal_pose_visualizer_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mission_planner::GoalPoseVisualizer>";
