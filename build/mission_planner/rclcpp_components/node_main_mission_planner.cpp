...
#define NODE_MAIN_LOGGER_NAME "mission_planner"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmission_planner_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mission_planner::MissionPlanner>";
