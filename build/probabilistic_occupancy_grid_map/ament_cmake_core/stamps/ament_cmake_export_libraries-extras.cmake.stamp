...
set(_exported_libraries "pointcloud_based_occupancy_grid_map;laserscan_based_occupancy_grid_map")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'probabilistic_occupancy_grid_map' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND probabilistic_occupancy_grid_map_LIBRARIES ${_cfg} "${_lib}")
