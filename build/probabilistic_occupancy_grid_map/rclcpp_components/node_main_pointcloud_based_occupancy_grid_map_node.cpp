...
#define NODE_MAIN_LOGGER_NAME "pointcloud_based_occupancy_grid_map_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpointcloud_based_occupancy_grid_map.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<occupancy_grid_map::PointcloudBasedOccupancyGridMapNode>";
