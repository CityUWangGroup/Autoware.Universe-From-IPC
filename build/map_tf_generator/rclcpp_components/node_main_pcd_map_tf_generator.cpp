...
#define NODE_MAIN_LOGGER_NAME "pcd_map_tf_generator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpcd_map_tf_generator_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<PcdMapTFGeneratorNode>";
