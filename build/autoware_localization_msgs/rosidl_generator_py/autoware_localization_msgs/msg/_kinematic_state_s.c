...
bool autoware_localization_msgs__msg__kinematic_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_localization_msgs.msg._kinematic_state.KinematicState", full_classname_dest, 62) == 0);
  }
  autoware_localization_msgs__msg__KinematicState * ros_message = _ros_message;
  {  // header
  ...
  {  // accel_with_covariance
    PyObject * field = PyObject_GetAttrString(_pymsg, "accel_with_covariance");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__accel_with_covariance__convert_from_py(field, &ros_message->accel_with_covariance)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of KinematicState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_localization_msgs.msg._kinematic_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KinematicState");
  ...
  {  // accel_with_covariance
    PyObject * field = NULL;
    field = geometry_msgs__msg__accel_with_covariance__convert_to_py(&ros_message->accel_with_covariance);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "accel_with_covariance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
