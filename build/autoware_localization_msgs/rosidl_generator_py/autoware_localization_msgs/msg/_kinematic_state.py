...
class Metaclass_KinematicState(type):
    """Metaclass of message 'KinematicState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('autoware_localization_msgs')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__kinematic_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__kinematic_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__kinematic_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__kinematic_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__kinematic_state
...
class KinematicState(metaclass=Metaclass_KinematicState):
    """Message class 'KinematicState'."""
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import AccelWithCovariance
        self.accel_with_covariance = kwargs.get('accel_with_covariance', AccelWithCovariance())
    ...
    def __eq__(self, other):
        ...
        if self.twist_with_covariance != other.twist_with_covariance:
            return False
        if self.accel_with_covariance != other.accel_with_covariance:
            return False
        return True
    ...
    @property
    def accel_with_covariance(self):
        """Message field 'accel_with_covariance'."""
        return self._accel_with_covariance

    @accel_with_covariance.setter
    def accel_with_covariance(self, value):
        if __debug__:
            from geometry_msgs.msg import AccelWithCovariance
            assert \
                isinstance(value, AccelWithCovariance), \
                "The 'accel_with_covariance' field must be a sub message of type 'AccelWithCovariance'"
        self._accel_with_covariance = value
