...
: ${AMENT_CURRENT_PREFIX:="/home/cityu/autoware/install/lidar_centerpoint_tvm"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lidar_centerpoint_tvm/environment/library_path.sh"
