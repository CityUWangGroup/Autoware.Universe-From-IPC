...
#define NODE_MAIN_LOGGER_NAME "lidar_centerpoint_tvm_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblidar_centerpoint_tvm_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::perception::lidar_centerpoint_tvm::LidarCenterPointTVMNode>";
