...
tier4_planning_msgs__msg__StopSpeedExceeded__init(tier4_planning_msgs__msg__StopSpeedExceeded * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    tier4_planning_msgs__msg__StopSpeedExceeded__fini(msg);
    return false;
  }
  // stop_speed_exceeded
  return true;
...
tier4_planning_msgs__msg__StopSpeedExceeded__are_equal(const tier4_planning_msgs__msg__StopSpeedExceeded * lhs, const tier4_planning_msgs__msg__StopSpeedExceeded * rhs)
{
  ...
  // stop_speed_exceeded
  if (lhs->stop_speed_exceeded != rhs->stop_speed_exceeded) {
    return false;
  }
  return true;
}
  ...
  tier4_planning_msgs__msg__StopSpeedExceeded * output)
{
  ...
  // stop_speed_exceeded
  output->stop_speed_exceeded = input->stop_speed_exceeded;
  return true;
}
...
{
  tier4_planning_msgs__msg__StopSpeedExceeded * msg = (tier4_planning_msgs__msg__StopSpeedExceeded *)malloc(sizeof(tier4_planning_msgs__msg__StopSpeedExceeded));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tier4_planning_msgs__msg__StopSpeedExceeded));
  bool success = tier4_planning_msgs__msg__StopSpeedExceeded__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
tier4_planning_msgs__msg__StopSpeedExceeded__Sequence__init(tier4_planning_msgs__msg__StopSpeedExceeded__Sequence * array, size_t size)
{
  ...
  tier4_planning_msgs__msg__StopSpeedExceeded * data = NULL;
  if (size) {
    data = (tier4_planning_msgs__msg__StopSpeedExceeded *)calloc(size, sizeof(tier4_planning_msgs__msg__StopSpeedExceeded));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tier4_planning_msgs__msg__StopSpeedExceeded__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tier4_planning_msgs__msg__StopSpeedExceeded__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tier4_planning_msgs__msg__StopSpeedExceeded__Sequence__fini(tier4_planning_msgs__msg__StopSpeedExceeded__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tier4_planning_msgs__msg__StopSpeedExceeded__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tier4_planning_msgs__msg__StopSpeedExceeded__Sequence * array = (tier4_planning_msgs__msg__StopSpeedExceeded__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__StopSpeedExceeded__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tier4_planning_msgs__msg__StopSpeedExceeded__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tier4_planning_msgs__msg__StopSpeedExceeded__Sequence__fini(array);
  }
  free(array);
}
...
tier4_planning_msgs__msg__StopSpeedExceeded__Sequence__are_equal(const tier4_planning_msgs__msg__StopSpeedExceeded__Sequence * lhs, const tier4_planning_msgs__msg__StopSpeedExceeded__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tier4_planning_msgs__msg__StopSpeedExceeded__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tier4_planning_msgs__msg__StopSpeedExceeded__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tier4_planning_msgs__msg__StopSpeedExceeded);
    tier4_planning_msgs__msg__StopSpeedExceeded * data =
      (tier4_planning_msgs__msg__StopSpeedExceeded *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__StopSpeedExceeded__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__StopSpeedExceeded__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tier4_planning_msgs__msg__StopSpeedExceeded__copy(
