...
{
  tier4_planning_msgs__msg__AvoidanceDebugFactor * msg = (tier4_planning_msgs__msg__AvoidanceDebugFactor *)malloc(sizeof(tier4_planning_msgs__msg__AvoidanceDebugFactor));
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__AvoidanceDebugFactor__Sequence__init(tier4_planning_msgs__msg__AvoidanceDebugFactor__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__AvoidanceDebugFactor *)calloc(size, sizeof(tier4_planning_msgs__msg__AvoidanceDebugFactor));
    if (!data) {
      return false;
    }
...
{
  tier4_planning_msgs__msg__AvoidanceDebugFactor__Sequence * array = (tier4_planning_msgs__msg__AvoidanceDebugFactor__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__AvoidanceDebugFactor__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__AvoidanceDebugFactor__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__AvoidanceDebugFactor * data =
      (tier4_planning_msgs__msg__AvoidanceDebugFactor *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__AvoidanceDebugFactor__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__AvoidanceDebugFactor__fini(&data[i]);
        }
        free(data);
        return false;
      }
