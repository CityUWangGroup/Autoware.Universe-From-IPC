...
{
  tier4_planning_msgs__msg__LaneChangeCommand * msg = (tier4_planning_msgs__msg__LaneChangeCommand *)malloc(sizeof(tier4_planning_msgs__msg__LaneChangeCommand));
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__LaneChangeCommand__Sequence__init(tier4_planning_msgs__msg__LaneChangeCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__LaneChangeCommand *)calloc(size, sizeof(tier4_planning_msgs__msg__LaneChangeCommand));
    if (!data) {
      return false;
    }
...
{
  tier4_planning_msgs__msg__LaneChangeCommand__Sequence * array = (tier4_planning_msgs__msg__LaneChangeCommand__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__LaneChangeCommand__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__LaneChangeCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__LaneChangeCommand * data =
      (tier4_planning_msgs__msg__LaneChangeCommand *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__LaneChangeCommand__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__LaneChangeCommand__fini(&data[i]);
        }
        free(data);
        return false;
      }
