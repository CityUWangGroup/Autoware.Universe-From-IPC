...
{
  tier4_planning_msgs__msg__Scenario * msg = (tier4_planning_msgs__msg__Scenario *)malloc(sizeof(tier4_planning_msgs__msg__Scenario));
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__Scenario__Sequence__init(tier4_planning_msgs__msg__Scenario__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__Scenario *)calloc(size, sizeof(tier4_planning_msgs__msg__Scenario));
    if (!data) {
      return false;
    }
...
{
  tier4_planning_msgs__msg__Scenario__Sequence * array = (tier4_planning_msgs__msg__Scenario__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__Scenario__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__Scenario__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__Scenario * data =
      (tier4_planning_msgs__msg__Scenario *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__Scenario__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__Scenario__fini(&data[i]);
        }
        free(data);
        return false;
      }
