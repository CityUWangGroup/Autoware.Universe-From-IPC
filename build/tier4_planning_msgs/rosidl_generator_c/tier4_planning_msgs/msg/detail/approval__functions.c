...
tier4_planning_msgs__msg__Approval__init(tier4_planning_msgs__msg__Approval * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    tier4_planning_msgs__msg__Approval__fini(msg);
    return false;
  }
  // approval
  return true;
...
{
  tier4_planning_msgs__msg__Approval * msg = (tier4_planning_msgs__msg__Approval *)malloc(sizeof(tier4_planning_msgs__msg__Approval));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tier4_planning_msgs__msg__Approval));
  bool success = tier4_planning_msgs__msg__Approval__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
tier4_planning_msgs__msg__Approval__Sequence__init(tier4_planning_msgs__msg__Approval__Sequence * array, size_t size)
{
  ...
  tier4_planning_msgs__msg__Approval * data = NULL;
  if (size) {
    data = (tier4_planning_msgs__msg__Approval *)calloc(size, sizeof(tier4_planning_msgs__msg__Approval));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tier4_planning_msgs__msg__Approval__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tier4_planning_msgs__msg__Approval__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tier4_planning_msgs__msg__Approval__Sequence__fini(tier4_planning_msgs__msg__Approval__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tier4_planning_msgs__msg__Approval__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tier4_planning_msgs__msg__Approval__Sequence * array = (tier4_planning_msgs__msg__Approval__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__Approval__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tier4_planning_msgs__msg__Approval__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tier4_planning_msgs__msg__Approval__Sequence__fini(array);
  }
  free(array);
}
...
tier4_planning_msgs__msg__Approval__Sequence__are_equal(const tier4_planning_msgs__msg__Approval__Sequence * lhs, const tier4_planning_msgs__msg__Approval__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tier4_planning_msgs__msg__Approval__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tier4_planning_msgs__msg__Approval__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tier4_planning_msgs__msg__Approval);
    tier4_planning_msgs__msg__Approval * data =
      (tier4_planning_msgs__msg__Approval *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__Approval__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__Approval__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tier4_planning_msgs__msg__Approval__copy(
