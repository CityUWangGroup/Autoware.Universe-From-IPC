...
{
  tier4_planning_msgs__msg__EnableAvoidance * msg = (tier4_planning_msgs__msg__EnableAvoidance *)malloc(sizeof(tier4_planning_msgs__msg__EnableAvoidance));
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__EnableAvoidance__Sequence__init(tier4_planning_msgs__msg__EnableAvoidance__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__EnableAvoidance *)calloc(size, sizeof(tier4_planning_msgs__msg__EnableAvoidance));
    if (!data) {
      return false;
    }
...
{
  tier4_planning_msgs__msg__EnableAvoidance__Sequence * array = (tier4_planning_msgs__msg__EnableAvoidance__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__EnableAvoidance__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__EnableAvoidance__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__EnableAvoidance * data =
      (tier4_planning_msgs__msg__EnableAvoidance *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__EnableAvoidance__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__EnableAvoidance__fini(&data[i]);
        }
        free(data);
        return false;
      }
