...
tier4_planning_msgs__msg__IsAvoidancePossible__init(tier4_planning_msgs__msg__IsAvoidancePossible * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    tier4_planning_msgs__msg__IsAvoidancePossible__fini(msg);
    return false;
  }
...
tier4_planning_msgs__msg__IsAvoidancePossible__are_equal(const tier4_planning_msgs__msg__IsAvoidancePossible * lhs, const tier4_planning_msgs__msg__IsAvoidancePossible * rhs)
{
  ...
  // is_avoidance_possible
  if (lhs->is_avoidance_possible != rhs->is_avoidance_possible) {
    return false;
  }
  return true;
}
  ...
  tier4_planning_msgs__msg__IsAvoidancePossible * output)
{
  ...
  // is_avoidance_possible
  output->is_avoidance_possible = input->is_avoidance_possible;
  return true;
}
...
{
  tier4_planning_msgs__msg__IsAvoidancePossible * msg = (tier4_planning_msgs__msg__IsAvoidancePossible *)malloc(sizeof(tier4_planning_msgs__msg__IsAvoidancePossible));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tier4_planning_msgs__msg__IsAvoidancePossible));
  bool success = tier4_planning_msgs__msg__IsAvoidancePossible__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
tier4_planning_msgs__msg__IsAvoidancePossible__Sequence__init(tier4_planning_msgs__msg__IsAvoidancePossible__Sequence * array, size_t size)
{
  ...
  tier4_planning_msgs__msg__IsAvoidancePossible * data = NULL;
  if (size) {
    data = (tier4_planning_msgs__msg__IsAvoidancePossible *)calloc(size, sizeof(tier4_planning_msgs__msg__IsAvoidancePossible));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tier4_planning_msgs__msg__IsAvoidancePossible__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tier4_planning_msgs__msg__IsAvoidancePossible__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tier4_planning_msgs__msg__IsAvoidancePossible__Sequence__fini(tier4_planning_msgs__msg__IsAvoidancePossible__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tier4_planning_msgs__msg__IsAvoidancePossible__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tier4_planning_msgs__msg__IsAvoidancePossible__Sequence * array = (tier4_planning_msgs__msg__IsAvoidancePossible__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__IsAvoidancePossible__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tier4_planning_msgs__msg__IsAvoidancePossible__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tier4_planning_msgs__msg__IsAvoidancePossible__Sequence__fini(array);
  }
  free(array);
}
...
tier4_planning_msgs__msg__IsAvoidancePossible__Sequence__are_equal(const tier4_planning_msgs__msg__IsAvoidancePossible__Sequence * lhs, const tier4_planning_msgs__msg__IsAvoidancePossible__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tier4_planning_msgs__msg__IsAvoidancePossible__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tier4_planning_msgs__msg__IsAvoidancePossible__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tier4_planning_msgs__msg__IsAvoidancePossible);
    tier4_planning_msgs__msg__IsAvoidancePossible * data =
      (tier4_planning_msgs__msg__IsAvoidancePossible *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__IsAvoidancePossible__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__IsAvoidancePossible__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tier4_planning_msgs__msg__IsAvoidancePossible__copy(
