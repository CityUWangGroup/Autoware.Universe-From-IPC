...
{
  tier4_planning_msgs__msg__LaneChangeStatus * msg = (tier4_planning_msgs__msg__LaneChangeStatus *)malloc(sizeof(tier4_planning_msgs__msg__LaneChangeStatus));
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__LaneChangeStatus__Sequence__init(tier4_planning_msgs__msg__LaneChangeStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__LaneChangeStatus *)calloc(size, sizeof(tier4_planning_msgs__msg__LaneChangeStatus));
    if (!data) {
      return false;
    }
...
{
  tier4_planning_msgs__msg__LaneChangeStatus__Sequence * array = (tier4_planning_msgs__msg__LaneChangeStatus__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__LaneChangeStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__LaneChangeStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__LaneChangeStatus * data =
      (tier4_planning_msgs__msg__LaneChangeStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__LaneChangeStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__LaneChangeStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
