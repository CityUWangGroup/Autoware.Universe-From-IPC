...
{
  tier4_planning_msgs__msg__VelocityLimitClearCommand * msg = (tier4_planning_msgs__msg__VelocityLimitClearCommand *)malloc(sizeof(tier4_planning_msgs__msg__VelocityLimitClearCommand));
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__VelocityLimitClearCommand__Sequence__init(tier4_planning_msgs__msg__VelocityLimitClearCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__VelocityLimitClearCommand *)calloc(size, sizeof(tier4_planning_msgs__msg__VelocityLimitClearCommand));
    if (!data) {
      return false;
    }
...
{
  tier4_planning_msgs__msg__VelocityLimitClearCommand__Sequence * array = (tier4_planning_msgs__msg__VelocityLimitClearCommand__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__VelocityLimitClearCommand__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__VelocityLimitClearCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__VelocityLimitClearCommand * data =
      (tier4_planning_msgs__msg__VelocityLimitClearCommand *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__VelocityLimitClearCommand__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__VelocityLimitClearCommand__fini(&data[i]);
        }
        free(data);
        return false;
      }
