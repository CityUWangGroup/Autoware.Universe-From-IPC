...
{
  tier4_planning_msgs__msg__Path * msg = (tier4_planning_msgs__msg__Path *)malloc(sizeof(tier4_planning_msgs__msg__Path));
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__Path__Sequence__init(tier4_planning_msgs__msg__Path__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__Path *)calloc(size, sizeof(tier4_planning_msgs__msg__Path));
    if (!data) {
      return false;
    }
...
{
  tier4_planning_msgs__msg__Path__Sequence * array = (tier4_planning_msgs__msg__Path__Sequence *)malloc(sizeof(tier4_planning_msgs__msg__Path__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__Path__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__Path * data =
      (tier4_planning_msgs__msg__Path *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__Path__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__Path__fini(&data[i]);
        }
        free(data);
        return false;
      }
