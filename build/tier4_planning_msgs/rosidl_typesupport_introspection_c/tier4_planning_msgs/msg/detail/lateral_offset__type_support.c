...
#include <stddef.h>
#include "tier4_planning_msgs/msg/detail/lateral_offset__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_planning_msgs__msg__LateralOffset__init(message_memory);
}

void LateralOffset__rosidl_typesupport_introspection_c__LateralOffset_fini_function(void * message_memory)
{
  tier4_planning_msgs__msg__LateralOffset__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember LateralOffset__rosidl_typesupport_introspection_c__LateralOffset_message_member_array[2] = {
  {
    ...
    offsetof(tier4_planning_msgs__msg__LateralOffset, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_planning_msgs__msg__LateralOffset, lateral_offset),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers LateralOffset__rosidl_typesupport_introspection_c__LateralOffset_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_planning_msgs__msg__LateralOffset),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, msg, LateralOffset)() {
