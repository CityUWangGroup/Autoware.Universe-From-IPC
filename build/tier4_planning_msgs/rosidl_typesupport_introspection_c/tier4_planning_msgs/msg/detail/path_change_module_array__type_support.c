...
#include <stddef.h>
#include "tier4_planning_msgs/msg/detail/path_change_module_array__rosidl_typesupport_introspection_c.h"
...
// Member `modules`
#include "tier4_planning_msgs/msg/path_change_module_id.h"
// Member `modules`
#include "tier4_planning_msgs/msg/detail/path_change_module_id__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_planning_msgs__msg__PathChangeModuleArray__init(message_memory);
}

void PathChangeModuleArray__rosidl_typesupport_introspection_c__PathChangeModuleArray_fini_function(void * message_memory)
{
  tier4_planning_msgs__msg__PathChangeModuleArray__fini(message_memory);
}

size_t PathChangeModuleArray__rosidl_typesupport_introspection_c__size_function__PathChangeModuleId__modules(
  const void * untyped_member)
{
  const tier4_planning_msgs__msg__PathChangeModuleId__Sequence * member =
    (const tier4_planning_msgs__msg__PathChangeModuleId__Sequence *)(untyped_member);
  return member->size;
}
...
{
  tier4_planning_msgs__msg__PathChangeModuleId__Sequence * member =
    (tier4_planning_msgs__msg__PathChangeModuleId__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  tier4_planning_msgs__msg__PathChangeModuleId__Sequence * member =
    (tier4_planning_msgs__msg__PathChangeModuleId__Sequence *)(untyped_member);
  tier4_planning_msgs__msg__PathChangeModuleId__Sequence__fini(member);
  return tier4_planning_msgs__msg__PathChangeModuleId__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember PathChangeModuleArray__rosidl_typesupport_introspection_c__PathChangeModuleArray_message_member_array[2] = {
  {
    ...
    offsetof(tier4_planning_msgs__msg__PathChangeModuleArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_planning_msgs__msg__PathChangeModuleArray, modules),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers PathChangeModuleArray__rosidl_typesupport_introspection_c__PathChangeModuleArray_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_planning_msgs__msg__PathChangeModuleArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, msg, PathChangeModuleArray)() {
  ...
  PathChangeModuleArray__rosidl_typesupport_introspection_c__PathChangeModuleArray_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, msg, PathChangeModuleId)();
