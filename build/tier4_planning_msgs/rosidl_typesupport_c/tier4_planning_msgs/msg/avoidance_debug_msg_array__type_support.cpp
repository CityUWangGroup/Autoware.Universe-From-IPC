...
static const _AvoidanceDebugMsgArray_type_support_symbol_names_t _AvoidanceDebugMsgArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_planning_msgs, msg, AvoidanceDebugMsgArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, msg, AvoidanceDebugMsgArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_planning_msgs, msg, AvoidanceDebugMsgArray)() {
  return &::tier4_planning_msgs::msg::rosidl_typesupport_c::AvoidanceDebugMsgArray_message_type_support_handle;
}
