...
class Metaclass_PathChangeModuleArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tier4_planning_msgs.msg import PathChangeModuleId
...
class PathChangeModuleArray(metaclass=Metaclass_PathChangeModuleArray):
    ...
    _fields_and_field_types = {
        ...
        'modules': 'sequence<tier4_planning_msgs/PathChangeModuleId>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['tier4_planning_msgs', 'msg'], 'PathChangeModuleId')),  # noqa: E501
    )
