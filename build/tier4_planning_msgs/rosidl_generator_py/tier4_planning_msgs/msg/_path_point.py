...
class Metaclass_PathPoint(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'REFERENCE': cls.__constants['REFERENCE'],
            'FIXED': cls.__constants['FIXED'],
        }

    @property
    def REFERENCE(self):
        """Message constant 'REFERENCE'."""
        return Metaclass_PathPoint.__constants['REFERENCE']

    @property
    def FIXED(self):
        """Message constant 'FIXED'."""
        return Metaclass_PathPoint.__constants['FIXED']
