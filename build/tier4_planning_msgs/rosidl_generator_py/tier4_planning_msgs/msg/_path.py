...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<tier4_planning_msgs/PathPoint>',
        'drivable_area': 'nav_msgs/OccupancyGrid',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['tier4_planning_msgs', 'msg'], 'PathPoint')),  # noqa: E501
