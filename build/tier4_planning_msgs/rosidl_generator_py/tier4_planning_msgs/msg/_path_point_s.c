...
bool tier4_planning_msgs__msg__path_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_planning_msgs.msg._path_point.PathPoint", full_classname_dest, 45) == 0);
  }
  tier4_planning_msgs__msg__PathPoint * ros_message = _ros_message;
  {  // pose
...
PyObject * tier4_planning_msgs__msg__path_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_planning_msgs.msg._path_point");
