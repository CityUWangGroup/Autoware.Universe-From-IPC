...
{
  new (message_memory) tier4_planning_msgs::msg::PathChangeModule(_init);
}

void PathChangeModule_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_planning_msgs::msg::PathChangeModule *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathChangeModule_message_member_array[2] = {
  {
    ...
    offsetof(tier4_planning_msgs::msg::PathChangeModule, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_planning_msgs::msg::PathChangeModule, module),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathChangeModule_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_planning_msgs::msg::PathChangeModule),
...
{
  return &::tier4_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PathChangeModule_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_planning_msgs, msg, PathChangeModule)() {
  return &::tier4_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PathChangeModule_message_type_support_handle;
}
