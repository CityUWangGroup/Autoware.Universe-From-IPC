...
#define NODE_MAIN_LOGGER_NAME "ransac_ground_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libground_segmentation.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ground_segmentation::RANSACGroundFilterComponent>";
