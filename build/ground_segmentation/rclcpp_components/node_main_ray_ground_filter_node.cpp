...
#define NODE_MAIN_LOGGER_NAME "ray_ground_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ground_segmentation::RayGroundFilterComponent>";
