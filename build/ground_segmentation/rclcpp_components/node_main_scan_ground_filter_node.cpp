...
#define NODE_MAIN_LOGGER_NAME "scan_ground_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ground_segmentation::ScanGroundFilterComponent>";
