...
#define NODE_MAIN_LOGGER_NAME "occupancy_grid_map_outlier_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liboccupancy_grid_map_outlier_filter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<occupancy_grid_map_outlier_filter::OccupancyGridMapOutlierFilterComponent>";
