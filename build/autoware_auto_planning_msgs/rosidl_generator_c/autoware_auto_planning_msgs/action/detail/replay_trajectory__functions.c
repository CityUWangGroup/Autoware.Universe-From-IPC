  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_Goal * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_Result * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_Feedback * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Request * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Response * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Request * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Response * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_planning_msgs__action__ReplayTrajectory_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__ReplayTrajectory_FeedbackMessage * data =
      (autoware_auto_planning_msgs__action__ReplayTrajectory_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__ReplayTrajectory_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__ReplayTrajectory_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
