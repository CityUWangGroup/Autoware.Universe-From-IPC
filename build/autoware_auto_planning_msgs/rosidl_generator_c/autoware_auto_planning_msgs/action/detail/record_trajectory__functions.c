...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Goal__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_Goal * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_Goal * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->record_path), &(rhs->record_path)))
  {
    return false;
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Goal__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_Goal * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_Goal * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->record_path), &(output->record_path)))
  {
    return false;
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Goal__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_Goal__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_Goal__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Goal__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_Goal__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_Goal__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_Goal);
    autoware_auto_planning_msgs__action__RecordTrajectory_Goal * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_Goal__copy(
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Result__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_Result * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_Result * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Result__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_Result * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_Result * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Result__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_Result__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_Result__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Result__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_Result__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_Result__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_Result);
    autoware_auto_planning_msgs__action__RecordTrajectory_Result * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_Feedback * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_Feedback * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  // current_length
  if (lhs->current_length != rhs->current_length) {
    return false;
  }
  return true;
}
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_Feedback * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_Feedback * output)
{
  if (!input || !output) {
    return false;
  }
  // current_length
  output->current_length = input->current_length;
  return true;
}
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_Feedback);
    autoware_auto_planning_msgs__action__RecordTrajectory_Feedback * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // goal
  if (!autoware_auto_planning_msgs__action__RecordTrajectory_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request);
    autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response);
    autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request);
    autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // result
  if (!autoware_auto_planning_msgs__action__RecordTrajectory_Result__are_equal(
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response);
    autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // feedback
  if (!autoware_auto_planning_msgs__action__RecordTrajectory_Feedback__are_equal(
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__Sequence__are_equal(const autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__Sequence * lhs, const autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__Sequence__copy(
  const autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__Sequence * input,
  autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage);
    autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage * data =
      (autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__action__RecordTrajectory_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
