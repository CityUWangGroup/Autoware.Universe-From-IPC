...
static size_t _GetRosbagCopyList_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_tier4_external_api_msgs__srv__GetRosbagCopyList_Request(
    full_bounded, 0);
}
...
static size_t _GetRosbagCopyList_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_tier4_external_api_msgs__srv__GetRosbagCopyList_Response(
    full_bounded, 0);
}
