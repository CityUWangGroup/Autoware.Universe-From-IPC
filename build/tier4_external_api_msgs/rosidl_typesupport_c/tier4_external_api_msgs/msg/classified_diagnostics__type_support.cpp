...
static const _ClassifiedDiagnostics_type_support_symbol_names_t _ClassifiedDiagnostics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_external_api_msgs, msg, ClassifiedDiagnostics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_external_api_msgs, msg, ClassifiedDiagnostics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_external_api_msgs, msg, ClassifiedDiagnostics)() {
  return &::tier4_external_api_msgs::msg::rosidl_typesupport_c::ClassifiedDiagnostics_message_type_support_handle;
}
