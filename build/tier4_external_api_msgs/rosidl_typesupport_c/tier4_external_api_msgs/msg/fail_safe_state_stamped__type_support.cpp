...
static const _FailSafeStateStamped_type_support_symbol_names_t _FailSafeStateStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_external_api_msgs, msg, FailSafeStateStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_external_api_msgs, msg, FailSafeStateStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_external_api_msgs, msg, FailSafeStateStamped)() {
  return &::tier4_external_api_msgs::msg::rosidl_typesupport_c::FailSafeStateStamped_message_type_support_handle;
}
