...
inline void to_yaml(
  const tier4_external_api_msgs::srv::GetTextFile_Request & msg,
...
inline std::string to_yaml(const tier4_external_api_msgs::srv::GetTextFile_Request & msg)
{
...
inline void to_yaml(
  const tier4_external_api_msgs::srv::GetTextFile_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  // member: status
  {
  ...
  // member: file
  {
    ...
    out << "file:\n";
    to_yaml(msg.file, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)

inline std::string to_yaml(const tier4_external_api_msgs::srv::GetTextFile_Response & msg)
{
  std::ostringstream out;
  to_yaml(msg, out);
  return out.str();
