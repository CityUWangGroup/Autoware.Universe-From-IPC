...
inline void to_yaml(
  const tier4_external_api_msgs::srv::InitializePoseAuto_Request & msg,
...
inline std::string to_yaml(const tier4_external_api_msgs::srv::InitializePoseAuto_Request & msg)
{
...
inline void to_yaml(
  const tier4_external_api_msgs::srv::InitializePoseAuto_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  // member: status
  {
...
inline std::string to_yaml(const tier4_external_api_msgs::srv::InitializePoseAuto_Response & msg)
{
  std::ostringstream out;
  to_yaml(msg, out);
  return out.str();
