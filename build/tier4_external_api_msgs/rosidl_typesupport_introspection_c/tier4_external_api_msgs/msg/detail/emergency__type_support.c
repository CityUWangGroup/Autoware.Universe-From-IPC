...
#include <stddef.h>
#include "tier4_external_api_msgs/msg/detail/emergency__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_external_api_msgs__msg__Emergency__init(message_memory);
}

void Emergency__rosidl_typesupport_introspection_c__Emergency_fini_function(void * message_memory)
{
  tier4_external_api_msgs__msg__Emergency__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Emergency__rosidl_typesupport_introspection_c__Emergency_message_member_array[2] = {
  {
    ...
    offsetof(tier4_external_api_msgs__msg__Emergency, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_external_api_msgs__msg__Emergency, emergency),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Emergency__rosidl_typesupport_introspection_c__Emergency_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_external_api_msgs__msg__Emergency),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_external_api_msgs, msg, Emergency)() {
