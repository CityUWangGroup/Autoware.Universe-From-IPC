  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_external_api_msgs__msg__Steering__init(message_memory);
}

void Steering__rosidl_typesupport_introspection_c__Steering_fini_function(void * message_memory)
{
  tier4_external_api_msgs__msg__Steering__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Steering__rosidl_typesupport_introspection_c__Steering_message_member_array[1] = {
  {
    "data",  // name
    ...
    offsetof(tier4_external_api_msgs__msg__Steering, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Steering__rosidl_typesupport_introspection_c__Steering_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_external_api_msgs__msg__Steering),
