  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_external_api_msgs__msg__VehicleCommand__init(message_memory);
}

void VehicleCommand__rosidl_typesupport_introspection_c__VehicleCommand_fini_function(void * message_memory)
{
  tier4_external_api_msgs__msg__VehicleCommand__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember VehicleCommand__rosidl_typesupport_introspection_c__VehicleCommand_message_member_array[2] = {
  {
    "velocity",  // name
    ...
    offsetof(tier4_external_api_msgs__msg__VehicleCommand, velocity),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_external_api_msgs__msg__VehicleCommand, acceleration),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleCommand__rosidl_typesupport_introspection_c__VehicleCommand_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_external_api_msgs__msg__VehicleCommand),
