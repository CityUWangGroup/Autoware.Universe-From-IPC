...
#include <stddef.h>
#include "tier4_external_api_msgs/msg/detail/heartbeat__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_external_api_msgs__msg__Heartbeat__init(message_memory);
}

void Heartbeat__rosidl_typesupport_introspection_c__Heartbeat_fini_function(void * message_memory)
{
  tier4_external_api_msgs__msg__Heartbeat__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Heartbeat__rosidl_typesupport_introspection_c__Heartbeat_message_member_array[1] = {
  {
    "stamp",  // name
    ...
    offsetof(tier4_external_api_msgs__msg__Heartbeat, stamp),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Heartbeat__rosidl_typesupport_introspection_c__Heartbeat_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_external_api_msgs__msg__Heartbeat),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_external_api_msgs, msg, Heartbeat)() {
