...
{
  tier4_external_api_msgs__srv__StartRosbagCopy_Request * msg = (tier4_external_api_msgs__srv__StartRosbagCopy_Request *)malloc(sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Request));
  bool success = tier4_external_api_msgs__srv__StartRosbagCopy_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    tier4_external_api_msgs__srv__StartRosbagCopy_Request__fini(msg);
  }
  free(msg);
}
...
tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence__init(tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence * array, size_t size)
{
  ...
  tier4_external_api_msgs__srv__StartRosbagCopy_Request * data = NULL;
  if (size) {
    data = (tier4_external_api_msgs__srv__StartRosbagCopy_Request *)calloc(size, sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tier4_external_api_msgs__srv__StartRosbagCopy_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tier4_external_api_msgs__srv__StartRosbagCopy_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence__fini(tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tier4_external_api_msgs__srv__StartRosbagCopy_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence * array = (tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence *)malloc(sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence__fini(array);
  }
  free(array);
}
...
tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence__are_equal(const tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence * lhs, const tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tier4_external_api_msgs__srv__StartRosbagCopy_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tier4_external_api_msgs__srv__StartRosbagCopy_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Request);
    tier4_external_api_msgs__srv__StartRosbagCopy_Request * data =
      (tier4_external_api_msgs__srv__StartRosbagCopy_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__srv__StartRosbagCopy_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__srv__StartRosbagCopy_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tier4_external_api_msgs__srv__StartRosbagCopy_Request__copy(
...
tier4_external_api_msgs__srv__StartRosbagCopy_Response__init(tier4_external_api_msgs__srv__StartRosbagCopy_Response * msg)
{
  ...
  if (!tier4_external_api_msgs__msg__ResponseStatus__init(&msg->status)) {
    tier4_external_api_msgs__srv__StartRosbagCopy_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  tier4_external_api_msgs__srv__StartRosbagCopy_Response * msg = (tier4_external_api_msgs__srv__StartRosbagCopy_Response *)malloc(sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Response));
  bool success = tier4_external_api_msgs__srv__StartRosbagCopy_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence__init(tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence * array, size_t size)
{
  ...
  tier4_external_api_msgs__srv__StartRosbagCopy_Response * data = NULL;
  if (size) {
    data = (tier4_external_api_msgs__srv__StartRosbagCopy_Response *)calloc(size, sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tier4_external_api_msgs__srv__StartRosbagCopy_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tier4_external_api_msgs__srv__StartRosbagCopy_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence__fini(tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tier4_external_api_msgs__srv__StartRosbagCopy_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence * array = (tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence *)malloc(sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence__fini(array);
  }
  free(array);
}
...
tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence__are_equal(const tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence * lhs, const tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tier4_external_api_msgs__srv__StartRosbagCopy_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tier4_external_api_msgs__srv__StartRosbagCopy_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tier4_external_api_msgs__srv__StartRosbagCopy_Response);
    tier4_external_api_msgs__srv__StartRosbagCopy_Response * data =
      (tier4_external_api_msgs__srv__StartRosbagCopy_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__srv__StartRosbagCopy_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__srv__StartRosbagCopy_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tier4_external_api_msgs__srv__StartRosbagCopy_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
