...
{
  tier4_external_api_msgs__srv__GetRosbagCopyList_Request * msg = (tier4_external_api_msgs__srv__GetRosbagCopyList_Request *)malloc(sizeof(tier4_external_api_msgs__srv__GetRosbagCopyList_Request));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__srv__GetRosbagCopyList_Request__Sequence__init(tier4_external_api_msgs__srv__GetRosbagCopyList_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__srv__GetRosbagCopyList_Request *)calloc(size, sizeof(tier4_external_api_msgs__srv__GetRosbagCopyList_Request));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__srv__GetRosbagCopyList_Request__Sequence * array = (tier4_external_api_msgs__srv__GetRosbagCopyList_Request__Sequence *)malloc(sizeof(tier4_external_api_msgs__srv__GetRosbagCopyList_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__srv__GetRosbagCopyList_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__srv__GetRosbagCopyList_Request * data =
      (tier4_external_api_msgs__srv__GetRosbagCopyList_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__srv__GetRosbagCopyList_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__srv__GetRosbagCopyList_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  tier4_external_api_msgs__srv__GetRosbagCopyList_Response * msg = (tier4_external_api_msgs__srv__GetRosbagCopyList_Response *)malloc(sizeof(tier4_external_api_msgs__srv__GetRosbagCopyList_Response));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__srv__GetRosbagCopyList_Response__Sequence__init(tier4_external_api_msgs__srv__GetRosbagCopyList_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__srv__GetRosbagCopyList_Response *)calloc(size, sizeof(tier4_external_api_msgs__srv__GetRosbagCopyList_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  tier4_external_api_msgs__srv__GetRosbagCopyList_Response__Sequence * array = (tier4_external_api_msgs__srv__GetRosbagCopyList_Response__Sequence *)malloc(sizeof(tier4_external_api_msgs__srv__GetRosbagCopyList_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__srv__GetRosbagCopyList_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__srv__GetRosbagCopyList_Response * data =
      (tier4_external_api_msgs__srv__GetRosbagCopyList_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__srv__GetRosbagCopyList_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__srv__GetRosbagCopyList_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
