...
{
  tier4_external_api_msgs__srv__SetVelocityLimit_Request * msg = (tier4_external_api_msgs__srv__SetVelocityLimit_Request *)malloc(sizeof(tier4_external_api_msgs__srv__SetVelocityLimit_Request));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__srv__SetVelocityLimit_Request__Sequence__init(tier4_external_api_msgs__srv__SetVelocityLimit_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__srv__SetVelocityLimit_Request *)calloc(size, sizeof(tier4_external_api_msgs__srv__SetVelocityLimit_Request));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__srv__SetVelocityLimit_Request__Sequence * array = (tier4_external_api_msgs__srv__SetVelocityLimit_Request__Sequence *)malloc(sizeof(tier4_external_api_msgs__srv__SetVelocityLimit_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  tier4_external_api_msgs__srv__SetVelocityLimit_Response * msg = (tier4_external_api_msgs__srv__SetVelocityLimit_Response *)malloc(sizeof(tier4_external_api_msgs__srv__SetVelocityLimit_Response));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__srv__SetVelocityLimit_Response__Sequence__init(tier4_external_api_msgs__srv__SetVelocityLimit_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__srv__SetVelocityLimit_Response *)calloc(size, sizeof(tier4_external_api_msgs__srv__SetVelocityLimit_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  tier4_external_api_msgs__srv__SetVelocityLimit_Response__Sequence * array = (tier4_external_api_msgs__srv__SetVelocityLimit_Response__Sequence *)malloc(sizeof(tier4_external_api_msgs__srv__SetVelocityLimit_Response__Sequence));
  if (!array) {
    return NULL;
  }
