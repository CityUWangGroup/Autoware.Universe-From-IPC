...
#ifndef TIER4_EXTERNAL_API_MSGS__SRV__DETAIL__SET_VELOCITY_LIMIT__FUNCTIONS_H_
#define TIER4_EXTERNAL_API_MSGS__SRV__DETAIL__SET_VELOCITY_LIMIT__FUNCTIONS_H_
...
/// Initialize srv/SetVelocityLimit message.
/**
...
/// Finalize srv/SetVelocityLimit message.
/**
...
/// Create srv/SetVelocityLimit message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Request__init().
...
/// Destroy srv/SetVelocityLimit message.
/**
 * It calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Request__fini()
...
/// Check for srv/SetVelocityLimit message equality.
/**
...
/// Copy a srv/SetVelocityLimit message.
/**
...
/// Initialize array of srv/SetVelocityLimit messages.
/**
...
/// Finalize array of srv/SetVelocityLimit messages.
/**
 * It calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Request__fini()
...
/// Create array of srv/SetVelocityLimit messages.
/**
 * It allocates the memory for the array and calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetVelocityLimit messages.
/**
 * It calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetVelocityLimit message array equality.
/**
...
/// Copy an array of srv/SetVelocityLimit messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_external_api_msgs
...
/**
 * It calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_external_api_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_external_api_msgs
...
/**
 * It calls
 * tier4_external_api_msgs__srv__SetVelocityLimit_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_EXTERNAL_API_MSGS__SRV__DETAIL__SET_VELOCITY_LIMIT__FUNCTIONS_H_
