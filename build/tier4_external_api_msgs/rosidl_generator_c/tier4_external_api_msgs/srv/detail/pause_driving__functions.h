...
#ifndef TIER4_EXTERNAL_API_MSGS__SRV__DETAIL__PAUSE_DRIVING__FUNCTIONS_H_
#define TIER4_EXTERNAL_API_MSGS__SRV__DETAIL__PAUSE_DRIVING__FUNCTIONS_H_
...
/// Initialize srv/PauseDriving message.
/**
...
/// Finalize srv/PauseDriving message.
/**
...
/// Create srv/PauseDriving message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_external_api_msgs__srv__PauseDriving_Request__init().
...
/// Destroy srv/PauseDriving message.
/**
 * It calls
 * tier4_external_api_msgs__srv__PauseDriving_Request__fini()
...
/// Check for srv/PauseDriving message equality.
/**
...
/// Copy a srv/PauseDriving message.
/**
...
/// Initialize array of srv/PauseDriving messages.
/**
...
/// Finalize array of srv/PauseDriving messages.
/**
 * It calls
 * tier4_external_api_msgs__srv__PauseDriving_Request__fini()
...
/// Create array of srv/PauseDriving messages.
/**
 * It allocates the memory for the array and calls
 * tier4_external_api_msgs__srv__PauseDriving_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PauseDriving messages.
/**
 * It calls
 * tier4_external_api_msgs__srv__PauseDriving_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PauseDriving message array equality.
/**
...
/// Copy an array of srv/PauseDriving messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_external_api_msgs__srv__PauseDriving_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_external_api_msgs
...
/**
 * It calls
 * tier4_external_api_msgs__srv__PauseDriving_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_external_api_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_external_api_msgs__srv__PauseDriving_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_external_api_msgs
...
/**
 * It calls
 * tier4_external_api_msgs__srv__PauseDriving_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_EXTERNAL_API_MSGS__SRV__DETAIL__PAUSE_DRIVING__FUNCTIONS_H_
