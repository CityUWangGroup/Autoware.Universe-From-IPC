...
{
  tier4_external_api_msgs__msg__Operator * msg = (tier4_external_api_msgs__msg__Operator *)malloc(sizeof(tier4_external_api_msgs__msg__Operator));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__Operator__Sequence__init(tier4_external_api_msgs__msg__Operator__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__Operator *)calloc(size, sizeof(tier4_external_api_msgs__msg__Operator));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__Operator__Sequence * array = (tier4_external_api_msgs__msg__Operator__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__Operator__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__Operator__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__Operator * data =
      (tier4_external_api_msgs__msg__Operator *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__Operator__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__Operator__fini(&data[i]);
        }
        free(data);
        return false;
      }
