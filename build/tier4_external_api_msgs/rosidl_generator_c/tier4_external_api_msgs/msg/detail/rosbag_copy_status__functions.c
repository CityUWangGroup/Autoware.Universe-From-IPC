...
{
  tier4_external_api_msgs__msg__RosbagCopyStatus * msg = (tier4_external_api_msgs__msg__RosbagCopyStatus *)malloc(sizeof(tier4_external_api_msgs__msg__RosbagCopyStatus));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__RosbagCopyStatus__Sequence__init(tier4_external_api_msgs__msg__RosbagCopyStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__RosbagCopyStatus *)calloc(size, sizeof(tier4_external_api_msgs__msg__RosbagCopyStatus));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__RosbagCopyStatus__Sequence * array = (tier4_external_api_msgs__msg__RosbagCopyStatus__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__RosbagCopyStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__RosbagCopyStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__RosbagCopyStatus * data =
      (tier4_external_api_msgs__msg__RosbagCopyStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__RosbagCopyStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__RosbagCopyStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
