...
{
  tier4_external_api_msgs__msg__Heartbeat * msg = (tier4_external_api_msgs__msg__Heartbeat *)malloc(sizeof(tier4_external_api_msgs__msg__Heartbeat));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__Heartbeat__Sequence__init(tier4_external_api_msgs__msg__Heartbeat__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__Heartbeat *)calloc(size, sizeof(tier4_external_api_msgs__msg__Heartbeat));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__Heartbeat__Sequence * array = (tier4_external_api_msgs__msg__Heartbeat__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__Heartbeat__Sequence));
  if (!array) {
    return NULL;
  }
