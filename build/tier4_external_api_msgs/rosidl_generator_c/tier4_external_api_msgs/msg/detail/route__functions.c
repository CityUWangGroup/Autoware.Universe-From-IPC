...
{
  tier4_external_api_msgs__msg__Route * msg = (tier4_external_api_msgs__msg__Route *)malloc(sizeof(tier4_external_api_msgs__msg__Route));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__Route__Sequence__init(tier4_external_api_msgs__msg__Route__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__Route *)calloc(size, sizeof(tier4_external_api_msgs__msg__Route));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__Route__Sequence * array = (tier4_external_api_msgs__msg__Route__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__Route__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__Route__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__Route * data =
      (tier4_external_api_msgs__msg__Route *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__Route__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__Route__fini(&data[i]);
        }
        free(data);
        return false;
      }
