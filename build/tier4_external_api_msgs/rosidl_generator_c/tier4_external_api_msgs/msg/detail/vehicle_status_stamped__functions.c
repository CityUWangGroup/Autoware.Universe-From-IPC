...
{
  tier4_external_api_msgs__msg__VehicleStatusStamped * msg = (tier4_external_api_msgs__msg__VehicleStatusStamped *)malloc(sizeof(tier4_external_api_msgs__msg__VehicleStatusStamped));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__VehicleStatusStamped__Sequence__init(tier4_external_api_msgs__msg__VehicleStatusStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__VehicleStatusStamped *)calloc(size, sizeof(tier4_external_api_msgs__msg__VehicleStatusStamped));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__VehicleStatusStamped__Sequence * array = (tier4_external_api_msgs__msg__VehicleStatusStamped__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__VehicleStatusStamped__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__VehicleStatusStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__VehicleStatusStamped * data =
      (tier4_external_api_msgs__msg__VehicleStatusStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__VehicleStatusStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__VehicleStatusStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
