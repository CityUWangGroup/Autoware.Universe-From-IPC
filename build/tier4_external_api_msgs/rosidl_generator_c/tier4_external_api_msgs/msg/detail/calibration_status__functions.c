...
{
  tier4_external_api_msgs__msg__CalibrationStatus * msg = (tier4_external_api_msgs__msg__CalibrationStatus *)malloc(sizeof(tier4_external_api_msgs__msg__CalibrationStatus));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__CalibrationStatus__Sequence__init(tier4_external_api_msgs__msg__CalibrationStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__CalibrationStatus *)calloc(size, sizeof(tier4_external_api_msgs__msg__CalibrationStatus));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__CalibrationStatus__Sequence * array = (tier4_external_api_msgs__msg__CalibrationStatus__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__CalibrationStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__CalibrationStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__CalibrationStatus * data =
      (tier4_external_api_msgs__msg__CalibrationStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__CalibrationStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__CalibrationStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
