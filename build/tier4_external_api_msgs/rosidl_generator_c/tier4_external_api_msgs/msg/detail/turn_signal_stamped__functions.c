...
{
  tier4_external_api_msgs__msg__TurnSignalStamped * msg = (tier4_external_api_msgs__msg__TurnSignalStamped *)malloc(sizeof(tier4_external_api_msgs__msg__TurnSignalStamped));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__TurnSignalStamped__Sequence__init(tier4_external_api_msgs__msg__TurnSignalStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__TurnSignalStamped *)calloc(size, sizeof(tier4_external_api_msgs__msg__TurnSignalStamped));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__TurnSignalStamped__Sequence * array = (tier4_external_api_msgs__msg__TurnSignalStamped__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__TurnSignalStamped__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__TurnSignalStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__TurnSignalStamped * data =
      (tier4_external_api_msgs__msg__TurnSignalStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__TurnSignalStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__TurnSignalStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
