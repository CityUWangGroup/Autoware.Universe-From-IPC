...
{
  tier4_external_api_msgs__msg__TurnSignal * msg = (tier4_external_api_msgs__msg__TurnSignal *)malloc(sizeof(tier4_external_api_msgs__msg__TurnSignal));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__TurnSignal__Sequence__init(tier4_external_api_msgs__msg__TurnSignal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__TurnSignal *)calloc(size, sizeof(tier4_external_api_msgs__msg__TurnSignal));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__TurnSignal__Sequence * array = (tier4_external_api_msgs__msg__TurnSignal__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__TurnSignal__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__TurnSignal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__TurnSignal * data =
      (tier4_external_api_msgs__msg__TurnSignal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__TurnSignal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__TurnSignal__fini(&data[i]);
        }
        free(data);
        return false;
      }
