...
{
  tier4_external_api_msgs__msg__RosbagLoggingMode * msg = (tier4_external_api_msgs__msg__RosbagLoggingMode *)malloc(sizeof(tier4_external_api_msgs__msg__RosbagLoggingMode));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__RosbagLoggingMode__Sequence__init(tier4_external_api_msgs__msg__RosbagLoggingMode__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__RosbagLoggingMode *)calloc(size, sizeof(tier4_external_api_msgs__msg__RosbagLoggingMode));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__RosbagLoggingMode__Sequence * array = (tier4_external_api_msgs__msg__RosbagLoggingMode__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__RosbagLoggingMode__Sequence));
  if (!array) {
    return NULL;
  }
