...
{
  tier4_external_api_msgs__msg__VehicleCommand * msg = (tier4_external_api_msgs__msg__VehicleCommand *)malloc(sizeof(tier4_external_api_msgs__msg__VehicleCommand));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__VehicleCommand__Sequence__init(tier4_external_api_msgs__msg__VehicleCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__VehicleCommand *)calloc(size, sizeof(tier4_external_api_msgs__msg__VehicleCommand));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__VehicleCommand__Sequence * array = (tier4_external_api_msgs__msg__VehicleCommand__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__VehicleCommand__Sequence));
  if (!array) {
    return NULL;
  }
