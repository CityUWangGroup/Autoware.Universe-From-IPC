...
{
  tier4_external_api_msgs__msg__MapHash * msg = (tier4_external_api_msgs__msg__MapHash *)malloc(sizeof(tier4_external_api_msgs__msg__MapHash));
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__MapHash__Sequence__init(tier4_external_api_msgs__msg__MapHash__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__MapHash *)calloc(size, sizeof(tier4_external_api_msgs__msg__MapHash));
    if (!data) {
      return false;
    }
...
{
  tier4_external_api_msgs__msg__MapHash__Sequence * array = (tier4_external_api_msgs__msg__MapHash__Sequence *)malloc(sizeof(tier4_external_api_msgs__msg__MapHash__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__MapHash__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__MapHash * data =
      (tier4_external_api_msgs__msg__MapHash *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__MapHash__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__MapHash__fini(&data[i]);
        }
        free(data);
        return false;
      }
