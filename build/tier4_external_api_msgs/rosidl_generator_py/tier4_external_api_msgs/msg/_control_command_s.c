...
bool tier4_external_api_msgs__msg__control_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_external_api_msgs.msg._control_command.ControlCommand", full_classname_dest, 59) == 0);
  }
  tier4_external_api_msgs__msg__ControlCommand * ros_message = _ros_message;
  {  // steering_angle
  ...
  {  // steering_angle_velocity
    ...
    assert(PyFloat_Check(field));
    ros_message->steering_angle_velocity = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // throttle
...
PyObject * tier4_external_api_msgs__msg__control_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_external_api_msgs.msg._control_command");
