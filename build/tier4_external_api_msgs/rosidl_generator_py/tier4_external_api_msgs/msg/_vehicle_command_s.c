...
bool tier4_external_api_msgs__msg__vehicle_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_external_api_msgs.msg._vehicle_command.VehicleCommand", full_classname_dest, 59) == 0);
  }
  tier4_external_api_msgs__msg__VehicleCommand * ros_message = _ros_message;
  {  // velocity
...
PyObject * tier4_external_api_msgs__msg__vehicle_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_external_api_msgs.msg._vehicle_command");
