...
class Metaclass_SetRoute_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tier4_external_api_msgs.msg import Route
...
class SetRoute_Request(metaclass=Metaclass_SetRoute_Request):
    ...
    _fields_and_field_types = {
        'route': 'tier4_external_api_msgs/Route',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['tier4_external_api_msgs', 'msg'], 'Route'),  # noqa: E501
    )
...
class Metaclass_SetRoute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tier4_external_api_msgs.srv.SetRoute')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tier4_external_api_msgs.srv import _set_route
...
class SetRoute(metaclass=Metaclass_SetRoute):
    from tier4_external_api_msgs.srv._set_route import SetRoute_Request as Request
    from tier4_external_api_msgs.srv._set_route import SetRoute_Response as Response
