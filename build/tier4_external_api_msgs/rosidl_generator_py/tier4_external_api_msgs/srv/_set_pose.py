...
class Metaclass_SetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tier4_external_api_msgs.srv.SetPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tier4_external_api_msgs.srv import _set_pose
...
class SetPose(metaclass=Metaclass_SetPose):
    from tier4_external_api_msgs.srv._set_pose import SetPose_Request as Request
    from tier4_external_api_msgs.srv._set_pose import SetPose_Response as Response
