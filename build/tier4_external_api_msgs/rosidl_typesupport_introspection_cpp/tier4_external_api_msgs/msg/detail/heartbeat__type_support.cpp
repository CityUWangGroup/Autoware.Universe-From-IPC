...
{
  new (message_memory) tier4_external_api_msgs::msg::Heartbeat(_init);
}

void Heartbeat_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_external_api_msgs::msg::Heartbeat *>(message_memory);
  typed_message->~Heartbeat();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Heartbeat_message_member_array[1] = {
  {
    "stamp",  // name
    ...
    offsetof(tier4_external_api_msgs::msg::Heartbeat, stamp),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Heartbeat_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_external_api_msgs::msg::Heartbeat),
...
{
  return &::tier4_external_api_msgs::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, msg, Heartbeat)() {
  return &::tier4_external_api_msgs::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
