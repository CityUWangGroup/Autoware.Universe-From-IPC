...
{
  new (message_memory) tier4_external_api_msgs::msg::CalibrationStatus(_init);
}

void CalibrationStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_external_api_msgs::msg::CalibrationStatus *>(message_memory);
  typed_message->~CalibrationStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember CalibrationStatus_message_member_array[2] = {
  {
    "target",  // name
    ...
    offsetof(tier4_external_api_msgs::msg::CalibrationStatus, target),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_external_api_msgs::msg::CalibrationStatus, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CalibrationStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_external_api_msgs::msg::CalibrationStatus),
...
{
  return &::tier4_external_api_msgs::msg::rosidl_typesupport_introspection_cpp::CalibrationStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, msg, CalibrationStatus)() {
  return &::tier4_external_api_msgs::msg::rosidl_typesupport_introspection_cpp::CalibrationStatus_message_type_support_handle;
}
