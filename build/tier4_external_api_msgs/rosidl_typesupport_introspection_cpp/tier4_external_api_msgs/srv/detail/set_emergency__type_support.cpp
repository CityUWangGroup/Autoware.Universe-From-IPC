...
{
  new (message_memory) tier4_external_api_msgs::srv::SetEmergency_Request(_init);
}

void SetEmergency_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_external_api_msgs::srv::SetEmergency_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetEmergency_Request_message_member_array[1] = {
  {
    ...
    offsetof(tier4_external_api_msgs::srv::SetEmergency_Request, emergency),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetEmergency_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_external_api_msgs::srv::SetEmergency_Request),
...
{
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetEmergency_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, srv, SetEmergency_Request)() {
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetEmergency_Request_message_type_support_handle;
}
...
void SetEmergency_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tier4_external_api_msgs::srv::SetEmergency_Response(_init);
}

void SetEmergency_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_external_api_msgs::srv::SetEmergency_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetEmergency_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_external_api_msgs::srv::SetEmergency_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetEmergency_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_external_api_msgs::srv::SetEmergency_Response),
...
{
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetEmergency_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, srv, SetEmergency_Response)() {
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetEmergency_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetEmergency_service_members = {
  ...
  // see get_service_type_support_handle<tier4_external_api_msgs::srv::SetEmergency>()
...
get_service_type_support_handle<tier4_external_api_msgs::srv::SetEmergency>()
{
  ...
  auto service_type_support =
    &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetEmergency_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, srv, SetEmergency)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<tier4_external_api_msgs::srv::SetEmergency>();
}
