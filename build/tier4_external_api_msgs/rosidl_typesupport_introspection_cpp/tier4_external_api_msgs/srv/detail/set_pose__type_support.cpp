...
{
  new (message_memory) tier4_external_api_msgs::srv::SetPose_Request(_init);
}

void SetPose_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_external_api_msgs::srv::SetPose_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPose_Request_message_member_array[1] = {
  {
    ...
    offsetof(tier4_external_api_msgs::srv::SetPose_Request, pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPose_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_external_api_msgs::srv::SetPose_Request),
...
{
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, srv, SetPose_Request)() {
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Request_message_type_support_handle;
}
...
void SetPose_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tier4_external_api_msgs::srv::SetPose_Response(_init);
}

void SetPose_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_external_api_msgs::srv::SetPose_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPose_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_external_api_msgs::srv::SetPose_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPose_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tier4_external_api_msgs::srv::SetPose_Response),
...
{
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, srv, SetPose_Response)() {
  return &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetPose_service_members = {
  ...
  // see get_service_type_support_handle<tier4_external_api_msgs::srv::SetPose>()
...
get_service_type_support_handle<tier4_external_api_msgs::srv::SetPose>()
{
  ...
  auto service_type_support =
    &::tier4_external_api_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::tier4_external_api_msgs::srv::SetPose_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::tier4_external_api_msgs::srv::SetPose_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_external_api_msgs, srv, SetPose)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<tier4_external_api_msgs::srv::SetPose>();
}
