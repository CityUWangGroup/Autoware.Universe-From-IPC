...
#define NODE_MAIN_LOGGER_NAME "object_association_merger_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobject_association_merger.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<object_association::ObjectAssociationMergerNode>";
