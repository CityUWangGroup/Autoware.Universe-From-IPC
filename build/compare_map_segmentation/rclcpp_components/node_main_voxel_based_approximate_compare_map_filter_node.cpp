...
#define NODE_MAIN_LOGGER_NAME "voxel_based_approximate_compare_map_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcompare_map_segmentation.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<compare_map_segmentation::VoxelBasedApproximateCompareMapFilterComponent>";
