...
#define NODE_MAIN_LOGGER_NAME "voxel_distance_based_compare_map_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<compare_map_segmentation::VoxelDistanceBasedCompareMapFilterComponent>";
