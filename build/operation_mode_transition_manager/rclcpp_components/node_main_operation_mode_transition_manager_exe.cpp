...
#define NODE_MAIN_LOGGER_NAME "operation_mode_transition_manager_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liboperation_mode_transition_manager_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<operation_mode_transition_manager::OperationModeTransitionManager>";
