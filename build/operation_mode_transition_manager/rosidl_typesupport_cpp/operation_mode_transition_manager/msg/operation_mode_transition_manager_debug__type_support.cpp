...
static const _OperationModeTransitionManagerDebug_type_support_symbol_names_t _OperationModeTransitionManagerDebug_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, operation_mode_transition_manager, msg, OperationModeTransitionManagerDebug)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, operation_mode_transition_manager, msg, OperationModeTransitionManagerDebug)),
  }
};
...
{
  return &::operation_mode_transition_manager::msg::rosidl_typesupport_cpp::OperationModeTransitionManagerDebug_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, operation_mode_transition_manager, msg, OperationModeTransitionManagerDebug)() {
  return get_message_type_support_handle<operation_mode_transition_manager::msg::OperationModeTransitionManagerDebug>();
}
