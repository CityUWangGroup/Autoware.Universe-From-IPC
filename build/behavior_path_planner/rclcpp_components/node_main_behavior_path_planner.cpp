...
#define NODE_MAIN_LOGGER_NAME "behavior_path_planner"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbehavior_path_planner_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<behavior_path_planner::BehaviorPathPlannerNode>";
