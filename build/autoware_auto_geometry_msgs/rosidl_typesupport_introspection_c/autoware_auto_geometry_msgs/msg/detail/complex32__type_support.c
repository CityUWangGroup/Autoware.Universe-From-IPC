...
#include <stddef.h>
#include "autoware_auto_geometry_msgs/msg/detail/complex32__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_geometry_msgs__msg__Complex32__init(message_memory);
}

void Complex32__rosidl_typesupport_introspection_c__Complex32_fini_function(void * message_memory)
{
  autoware_auto_geometry_msgs__msg__Complex32__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Complex32__rosidl_typesupport_introspection_c__Complex32_message_member_array[2] = {
  {
    ...
    offsetof(autoware_auto_geometry_msgs__msg__Complex32, real),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_geometry_msgs__msg__Complex32, imag),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Complex32__rosidl_typesupport_introspection_c__Complex32_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_geometry_msgs__msg__Complex32),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_geometry_msgs, msg, Complex32)() {
