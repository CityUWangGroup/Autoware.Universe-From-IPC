...
#define NODE_MAIN_LOGGER_NAME "dummy_diag_publisher_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdummy_diag_publisher.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<DummyDiagPublisherNode>";
