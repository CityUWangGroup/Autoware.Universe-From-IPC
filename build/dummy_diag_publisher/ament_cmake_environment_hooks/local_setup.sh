...
: ${AMENT_CURRENT_PREFIX:="/home/cityu/autoware/install/dummy_diag_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dummy_diag_publisher/environment/library_path.sh"
