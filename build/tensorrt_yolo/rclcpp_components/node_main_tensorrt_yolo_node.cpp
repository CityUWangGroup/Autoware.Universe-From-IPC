...
#define NODE_MAIN_LOGGER_NAME "tensorrt_yolo_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtensorrt_yolo_nodelet.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<object_recognition::TensorrtYoloNodelet>";
