...
#define NODE_MAIN_LOGGER_NAME "obstacle_stop_planner_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobstacle_stop_planner.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<motion_planning::ObstacleStopPlannerNode>";
