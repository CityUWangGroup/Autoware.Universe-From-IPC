...
#define NODE_MAIN_LOGGER_NAME "image_transport_decompressor_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_transport_decompressor.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_preprocessor::ImageTransportDecompressor>";
