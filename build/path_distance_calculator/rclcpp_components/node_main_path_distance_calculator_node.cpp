...
#define NODE_MAIN_LOGGER_NAME "path_distance_calculator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpath_distance_calculator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<PathDistanceCalculator>";
