...
static const _SimulationEvents_type_support_symbol_names_t _SimulationEvents_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_simulation_msgs, msg, SimulationEvents)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_simulation_msgs, msg, SimulationEvents)),
  }
};
...
{
  return &::tier4_simulation_msgs::msg::rosidl_typesupport_cpp::SimulationEvents_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tier4_simulation_msgs, msg, SimulationEvents)() {
  return get_message_type_support_handle<tier4_simulation_msgs::msg::SimulationEvents>();
}
