...
static const _FaultInjectionEvent_type_support_symbol_names_t _FaultInjectionEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_simulation_msgs, msg, FaultInjectionEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_simulation_msgs, msg, FaultInjectionEvent)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_simulation_msgs, msg, FaultInjectionEvent)() {
  return &::tier4_simulation_msgs::msg::rosidl_typesupport_c::FaultInjectionEvent_message_type_support_handle;
}
