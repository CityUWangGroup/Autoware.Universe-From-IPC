...
: ${AMENT_CURRENT_PREFIX:="/home/cityu/autoware/install/perception_utils"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/perception_utils/environment/library_path.sh"
