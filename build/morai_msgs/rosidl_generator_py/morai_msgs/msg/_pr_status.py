...
class Metaclass_PRStatus(type):
    """Metaclass of message 'PRStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'morai_msgs.msg.PRStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__pr_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__pr_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__pr_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__pr_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__pr_status
...
class PRStatus(metaclass=Metaclass_PRStatus):
    """Message class 'PRStatus'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.mount_status = kwargs.get('mount_status', bool())
    ...
    def __eq__(self, other):
        ...
        if self.heading != other.heading:
            return False
        if self.mount_status != other.mount_status:
            return False
        return True
    ...
    def mount_status(self):
        """Message field 'mount_status'."""
        return self._mount_status

    @mount_status.setter
    def mount_status(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'mount_status' field must be of type 'bool'"
        self._mount_status = value
