...
bool morai_msgs__msg__radar_track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("morai_msgs.msg._radar_track.RadarTrack", full_classname_dest, 38) == 0);
  }
  morai_msgs__msg__RadarTrack * ros_message = _ros_message;
  {  // uuid
    ...
    ros_message->uuid = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // position
  ...
  {  // classification
    ...
    assert(PyLong_Check(field));
    ros_message->classification = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // position_covariance
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->position_covariance.data;
  ...
  {  // velocity_covariance
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->velocity_covariance.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // acceleration_covariance
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->acceleration_covariance.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // size_covariance
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->size_covariance.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'size_covariance'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * morai_msgs__msg__radar_track__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("morai_msgs.msg._radar_track");
  ...
  {  // uuid
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->uuid);
    {
  ...
  {  // position_covariance
    ...
    if (ros_message->position_covariance.size > 0) {
      ...
      float * src = &(ros_message->position_covariance.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->position_covariance.size * sizeof(float));
      assert(data != NULL);
  ...
  {  // velocity_covariance
    ...
    if (ros_message->velocity_covariance.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->velocity_covariance.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->velocity_covariance.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // acceleration_covariance
    ...
    if (ros_message->acceleration_covariance.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->acceleration_covariance.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->acceleration_covariance.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // size_covariance
    ...
    if (ros_message->size_covariance.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->size_covariance.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->size_covariance.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
