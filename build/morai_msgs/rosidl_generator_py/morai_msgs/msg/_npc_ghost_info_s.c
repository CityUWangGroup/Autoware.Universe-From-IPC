...
bool morai_msgs__msg__npc_ghost_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("morai_msgs.msg._npc_ghost_info.NpcGhostInfo", full_classname_dest, 43) == 0);
  }
  morai_msgs__msg__NpcGhostInfo * ros_message = _ros_message;
  {  // unique_id
...
{
  /* NOTE(esteve): Call constructor of NpcGhostInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("morai_msgs.msg._npc_ghost_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NpcGhostInfo");
