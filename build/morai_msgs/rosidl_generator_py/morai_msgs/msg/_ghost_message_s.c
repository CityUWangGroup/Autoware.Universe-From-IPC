...
bool morai_msgs__msg__ghost_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("morai_msgs.msg._ghost_message.GhostMessage", full_classname_dest, 42) == 0);
  }
  morai_msgs__msg__GhostMessage * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of GhostMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("morai_msgs.msg._ghost_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GhostMessage");
