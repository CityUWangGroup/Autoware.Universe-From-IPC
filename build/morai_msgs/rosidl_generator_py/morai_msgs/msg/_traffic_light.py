...
class TrafficLight(metaclass=Metaclass_TrafficLight):
    ...
    def __init__(self, **kwargs):
        ...
        self.num_of_light = kwargs.get('num_of_light', int())
    ...
    def __eq__(self, other):
        ...
        if self.light != other.light:
            return False
        if self.num_of_light != other.num_of_light:
            return False
        return True
    ...
    def light(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'light' field must be an integer in [-32768, 32767]"
        self._light = value

    @property
    def num_of_light(self):
        """Message field 'num_of_light'."""
        return self._num_of_light

    @num_of_light.setter
    def num_of_light(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'num_of_light' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'num_of_light' field must be an integer in [-32768, 32767]"
        self._num_of_light = value
