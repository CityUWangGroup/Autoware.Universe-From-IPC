...
bool morai_msgs__msg__ego_vehicle_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("morai_msgs.msg._ego_vehicle_status.EgoVehicleStatus", full_classname_dest, 51) == 0);
  }
  morai_msgs__msg__EgoVehicleStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // wheel_angle
    ...
    assert(PyFloat_Check(field));
    ros_message->wheel_angle = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of EgoVehicleStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("morai_msgs.msg._ego_vehicle_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EgoVehicleStatus");
