...
bool morai_msgs__msg__scenario_load__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("morai_msgs.msg._scenario_load.ScenarioLoad", full_classname_dest, 42) == 0);
  }
  morai_msgs__msg__ScenarioLoad * ros_message = _ros_message;
  {  // file_name
...
{
  /* NOTE(esteve): Call constructor of ScenarioLoad */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("morai_msgs.msg._scenario_load");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScenarioLoad");
