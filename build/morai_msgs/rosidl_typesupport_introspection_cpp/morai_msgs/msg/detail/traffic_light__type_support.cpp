...
{
  new (message_memory) morai_msgs::msg::TrafficLight(_init);
}

void TrafficLight_fini_function(void * message_memory)
{
  auto typed_message = static_cast<morai_msgs::msg::TrafficLight *>(message_memory);
  typed_message->~TrafficLight();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficLight_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(morai_msgs::msg::TrafficLight, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(morai_msgs::msg::TrafficLight, light),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(morai_msgs::msg::TrafficLight, num_of_light),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrafficLight_message_members = {
  ...
  3,  // number of fields
  sizeof(morai_msgs::msg::TrafficLight),
...
{
  return &::morai_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLight_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, morai_msgs, msg, TrafficLight)() {
  return &::morai_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLight_message_type_support_handle;
}
