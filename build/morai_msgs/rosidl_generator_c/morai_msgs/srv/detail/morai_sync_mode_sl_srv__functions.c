...
{
  morai_msgs__srv__MoraiSyncModeSLSrv_Request * msg = (morai_msgs__srv__MoraiSyncModeSLSrv_Request *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeSLSrv_Request));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__srv__MoraiSyncModeSLSrv_Request__Sequence__init(morai_msgs__srv__MoraiSyncModeSLSrv_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__srv__MoraiSyncModeSLSrv_Request *)calloc(size, sizeof(morai_msgs__srv__MoraiSyncModeSLSrv_Request));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__srv__MoraiSyncModeSLSrv_Request__Sequence * array = (morai_msgs__srv__MoraiSyncModeSLSrv_Request__Sequence *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeSLSrv_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__srv__MoraiSyncModeSLSrv_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__srv__MoraiSyncModeSLSrv_Request * data =
      (morai_msgs__srv__MoraiSyncModeSLSrv_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__srv__MoraiSyncModeSLSrv_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__srv__MoraiSyncModeSLSrv_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  morai_msgs__srv__MoraiSyncModeSLSrv_Response * msg = (morai_msgs__srv__MoraiSyncModeSLSrv_Response *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeSLSrv_Response));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__srv__MoraiSyncModeSLSrv_Response__Sequence__init(morai_msgs__srv__MoraiSyncModeSLSrv_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__srv__MoraiSyncModeSLSrv_Response *)calloc(size, sizeof(morai_msgs__srv__MoraiSyncModeSLSrv_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  morai_msgs__srv__MoraiSyncModeSLSrv_Response__Sequence * array = (morai_msgs__srv__MoraiSyncModeSLSrv_Response__Sequence *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeSLSrv_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__srv__MoraiSyncModeSLSrv_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__srv__MoraiSyncModeSLSrv_Response * data =
      (morai_msgs__srv__MoraiSyncModeSLSrv_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__srv__MoraiSyncModeSLSrv_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__srv__MoraiSyncModeSLSrv_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
