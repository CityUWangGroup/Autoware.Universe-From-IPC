...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__init(morai_msgs__srv__MoraiSyncModeCmdSrv_Request * msg)
{
  ...
  // request
  if (!morai_msgs__msg__SyncModeCmd__init(&msg->request)) {
    morai_msgs__srv__MoraiSyncModeCmdSrv_Request__fini(msg);
    return false;
  }
  return true;
}
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__fini(morai_msgs__srv__MoraiSyncModeCmdSrv_Request * msg)
{
  ...
  // request
  morai_msgs__msg__SyncModeCmd__fini(&msg->request);
}
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__are_equal(const morai_msgs__srv__MoraiSyncModeCmdSrv_Request * lhs, const morai_msgs__srv__MoraiSyncModeCmdSrv_Request * rhs)
{
  ...
  // request
  if (!morai_msgs__msg__SyncModeCmd__are_equal(
...
{
  morai_msgs__srv__MoraiSyncModeCmdSrv_Request * msg = (morai_msgs__srv__MoraiSyncModeCmdSrv_Request *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request));
  bool success = morai_msgs__srv__MoraiSyncModeCmdSrv_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence__init(morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * array, size_t size)
{
  ...
  morai_msgs__srv__MoraiSyncModeCmdSrv_Request * data = NULL;
  if (size) {
    data = (morai_msgs__srv__MoraiSyncModeCmdSrv_Request *)calloc(size, sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = morai_msgs__srv__MoraiSyncModeCmdSrv_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        morai_msgs__srv__MoraiSyncModeCmdSrv_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence__fini(morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      morai_msgs__srv__MoraiSyncModeCmdSrv_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * array = (morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence__fini(array);
  }
  free(array);
}
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence__are_equal(const morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * lhs, const morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request);
    morai_msgs__srv__MoraiSyncModeCmdSrv_Request * data =
      (morai_msgs__srv__MoraiSyncModeCmdSrv_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__srv__MoraiSyncModeCmdSrv_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Request__copy(
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Response__init(morai_msgs__srv__MoraiSyncModeCmdSrv_Response * msg)
{
  ...
  // response
  if (!morai_msgs__msg__SyncModeCmdResponse__init(&msg->response)) {
    morai_msgs__srv__MoraiSyncModeCmdSrv_Response__fini(msg);
    return false;
  }
  return true;
}
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Response__fini(morai_msgs__srv__MoraiSyncModeCmdSrv_Response * msg)
{
  ...
  // response
  morai_msgs__msg__SyncModeCmdResponse__fini(&msg->response);
}
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Response__are_equal(const morai_msgs__srv__MoraiSyncModeCmdSrv_Response * lhs, const morai_msgs__srv__MoraiSyncModeCmdSrv_Response * rhs)
{
  ...
  // response
  if (!morai_msgs__msg__SyncModeCmdResponse__are_equal(
...
{
  morai_msgs__srv__MoraiSyncModeCmdSrv_Response * msg = (morai_msgs__srv__MoraiSyncModeCmdSrv_Response *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response));
  bool success = morai_msgs__srv__MoraiSyncModeCmdSrv_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence__init(morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * array, size_t size)
{
  ...
  morai_msgs__srv__MoraiSyncModeCmdSrv_Response * data = NULL;
  if (size) {
    data = (morai_msgs__srv__MoraiSyncModeCmdSrv_Response *)calloc(size, sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = morai_msgs__srv__MoraiSyncModeCmdSrv_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        morai_msgs__srv__MoraiSyncModeCmdSrv_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence__fini(morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      morai_msgs__srv__MoraiSyncModeCmdSrv_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * array = (morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence *)malloc(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence__fini(array);
  }
  free(array);
}
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence__are_equal(const morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * lhs, const morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response);
    morai_msgs__srv__MoraiSyncModeCmdSrv_Response * data =
      (morai_msgs__srv__MoraiSyncModeCmdSrv_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__srv__MoraiSyncModeCmdSrv_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
