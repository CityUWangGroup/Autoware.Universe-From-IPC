...
{
  morai_msgs__msg__SyncModeCtrlCmd * msg = (morai_msgs__msg__SyncModeCtrlCmd *)malloc(sizeof(morai_msgs__msg__SyncModeCtrlCmd));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__SyncModeCtrlCmd__Sequence__init(morai_msgs__msg__SyncModeCtrlCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__SyncModeCtrlCmd *)calloc(size, sizeof(morai_msgs__msg__SyncModeCtrlCmd));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__SyncModeCtrlCmd__Sequence * array = (morai_msgs__msg__SyncModeCtrlCmd__Sequence *)malloc(sizeof(morai_msgs__msg__SyncModeCtrlCmd__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__SyncModeCtrlCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__SyncModeCtrlCmd * data =
      (morai_msgs__msg__SyncModeCtrlCmd *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__SyncModeCtrlCmd__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__SyncModeCtrlCmd__fini(&data[i]);
        }
        free(data);
        return false;
      }
