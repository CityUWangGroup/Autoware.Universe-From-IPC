...
{
  morai_msgs__msg__VehicleCollision * msg = (morai_msgs__msg__VehicleCollision *)malloc(sizeof(morai_msgs__msg__VehicleCollision));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__VehicleCollision__Sequence__init(morai_msgs__msg__VehicleCollision__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__VehicleCollision *)calloc(size, sizeof(morai_msgs__msg__VehicleCollision));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__VehicleCollision__Sequence * array = (morai_msgs__msg__VehicleCollision__Sequence *)malloc(sizeof(morai_msgs__msg__VehicleCollision__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__VehicleCollision__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__VehicleCollision * data =
      (morai_msgs__msg__VehicleCollision *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__VehicleCollision__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__VehicleCollision__fini(&data[i]);
        }
        free(data);
        return false;
      }
