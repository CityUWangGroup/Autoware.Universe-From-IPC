...
{
  morai_msgs__msg__RadarTracks * msg = (morai_msgs__msg__RadarTracks *)malloc(sizeof(morai_msgs__msg__RadarTracks));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__RadarTracks__Sequence__init(morai_msgs__msg__RadarTracks__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__RadarTracks *)calloc(size, sizeof(morai_msgs__msg__RadarTracks));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__RadarTracks__Sequence * array = (morai_msgs__msg__RadarTracks__Sequence *)malloc(sizeof(morai_msgs__msg__RadarTracks__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__RadarTracks__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__RadarTracks * data =
      (morai_msgs__msg__RadarTracks *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__RadarTracks__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__RadarTracks__fini(&data[i]);
        }
        free(data);
        return false;
      }
