...
{
  morai_msgs__msg__SyncModeInfo * msg = (morai_msgs__msg__SyncModeInfo *)malloc(sizeof(morai_msgs__msg__SyncModeInfo));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__SyncModeInfo__Sequence__init(morai_msgs__msg__SyncModeInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__SyncModeInfo *)calloc(size, sizeof(morai_msgs__msg__SyncModeInfo));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__SyncModeInfo__Sequence * array = (morai_msgs__msg__SyncModeInfo__Sequence *)malloc(sizeof(morai_msgs__msg__SyncModeInfo__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__SyncModeInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__SyncModeInfo * data =
      (morai_msgs__msg__SyncModeInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__SyncModeInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__SyncModeInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
