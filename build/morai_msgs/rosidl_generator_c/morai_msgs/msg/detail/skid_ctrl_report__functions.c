...
{
  morai_msgs__msg__SkidCtrlReport * msg = (morai_msgs__msg__SkidCtrlReport *)malloc(sizeof(morai_msgs__msg__SkidCtrlReport));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__SkidCtrlReport__Sequence__init(morai_msgs__msg__SkidCtrlReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__SkidCtrlReport *)calloc(size, sizeof(morai_msgs__msg__SkidCtrlReport));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__SkidCtrlReport__Sequence * array = (morai_msgs__msg__SkidCtrlReport__Sequence *)malloc(sizeof(morai_msgs__msg__SkidCtrlReport__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__SkidCtrlReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__SkidCtrlReport * data =
      (morai_msgs__msg__SkidCtrlReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__SkidCtrlReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__SkidCtrlReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
