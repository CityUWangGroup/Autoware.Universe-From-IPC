...
{
  morai_msgs__msg__VehicleSpecIndex * msg = (morai_msgs__msg__VehicleSpecIndex *)malloc(sizeof(morai_msgs__msg__VehicleSpecIndex));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__VehicleSpecIndex__Sequence__init(morai_msgs__msg__VehicleSpecIndex__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__VehicleSpecIndex *)calloc(size, sizeof(morai_msgs__msg__VehicleSpecIndex));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__VehicleSpecIndex__Sequence * array = (morai_msgs__msg__VehicleSpecIndex__Sequence *)malloc(sizeof(morai_msgs__msg__VehicleSpecIndex__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__VehicleSpecIndex__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__VehicleSpecIndex * data =
      (morai_msgs__msg__VehicleSpecIndex *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__VehicleSpecIndex__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__VehicleSpecIndex__fini(&data[i]);
        }
        free(data);
        return false;
      }
