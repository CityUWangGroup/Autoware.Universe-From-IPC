...
{
  morai_msgs__msg__SyncModeRemoveObj * msg = (morai_msgs__msg__SyncModeRemoveObj *)malloc(sizeof(morai_msgs__msg__SyncModeRemoveObj));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__SyncModeRemoveObj__Sequence__init(morai_msgs__msg__SyncModeRemoveObj__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__SyncModeRemoveObj *)calloc(size, sizeof(morai_msgs__msg__SyncModeRemoveObj));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__SyncModeRemoveObj__Sequence * array = (morai_msgs__msg__SyncModeRemoveObj__Sequence *)malloc(sizeof(morai_msgs__msg__SyncModeRemoveObj__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__SyncModeRemoveObj__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__SyncModeRemoveObj * data =
      (morai_msgs__msg__SyncModeRemoveObj *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__SyncModeRemoveObj__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__SyncModeRemoveObj__fini(&data[i]);
        }
        free(data);
        return false;
      }
