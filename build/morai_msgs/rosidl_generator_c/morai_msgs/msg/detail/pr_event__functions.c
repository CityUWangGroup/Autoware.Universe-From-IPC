...
{
  morai_msgs__msg__PREvent * msg = (morai_msgs__msg__PREvent *)malloc(sizeof(morai_msgs__msg__PREvent));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__PREvent__Sequence__init(morai_msgs__msg__PREvent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__PREvent *)calloc(size, sizeof(morai_msgs__msg__PREvent));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__PREvent__Sequence * array = (morai_msgs__msg__PREvent__Sequence *)malloc(sizeof(morai_msgs__msg__PREvent__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__PREvent__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__PREvent * data =
      (morai_msgs__msg__PREvent *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__PREvent__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__PREvent__fini(&data[i]);
        }
        free(data);
        return false;
      }
