...
morai_msgs__msg__MapSpecIndex__are_equal(const morai_msgs__msg__MapSpecIndex * lhs, const morai_msgs__msg__MapSpecIndex * rhs)
{
  ...
  // load_map_data
  if (lhs->load_map_data != rhs->load_map_data) {
    return false;
  }
  return true;
}
  ...
  morai_msgs__msg__MapSpecIndex * output)
{
  ...
  // load_map_data
  output->load_map_data = input->load_map_data;
  return true;
}
...
{
  morai_msgs__msg__MapSpecIndex * msg = (morai_msgs__msg__MapSpecIndex *)malloc(sizeof(morai_msgs__msg__MapSpecIndex));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(morai_msgs__msg__MapSpecIndex));
  bool success = morai_msgs__msg__MapSpecIndex__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    morai_msgs__msg__MapSpecIndex__fini(msg);
  }
  free(msg);
}
...
morai_msgs__msg__MapSpecIndex__Sequence__init(morai_msgs__msg__MapSpecIndex__Sequence * array, size_t size)
{
  ...
  morai_msgs__msg__MapSpecIndex * data = NULL;
  if (size) {
    data = (morai_msgs__msg__MapSpecIndex *)calloc(size, sizeof(morai_msgs__msg__MapSpecIndex));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = morai_msgs__msg__MapSpecIndex__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        morai_msgs__msg__MapSpecIndex__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
morai_msgs__msg__MapSpecIndex__Sequence__fini(morai_msgs__msg__MapSpecIndex__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      morai_msgs__msg__MapSpecIndex__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  morai_msgs__msg__MapSpecIndex__Sequence * array = (morai_msgs__msg__MapSpecIndex__Sequence *)malloc(sizeof(morai_msgs__msg__MapSpecIndex__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = morai_msgs__msg__MapSpecIndex__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    morai_msgs__msg__MapSpecIndex__Sequence__fini(array);
  }
  free(array);
}
...
morai_msgs__msg__MapSpecIndex__Sequence__are_equal(const morai_msgs__msg__MapSpecIndex__Sequence * lhs, const morai_msgs__msg__MapSpecIndex__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!morai_msgs__msg__MapSpecIndex__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  morai_msgs__msg__MapSpecIndex__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(morai_msgs__msg__MapSpecIndex);
    morai_msgs__msg__MapSpecIndex * data =
      (morai_msgs__msg__MapSpecIndex *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__MapSpecIndex__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__MapSpecIndex__fini(&data[i]);
        }
        free(data);
        return false;
      }
