...
{
  morai_msgs__msg__WheelTorque * msg = (morai_msgs__msg__WheelTorque *)malloc(sizeof(morai_msgs__msg__WheelTorque));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__WheelTorque__Sequence__init(morai_msgs__msg__WheelTorque__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__WheelTorque *)calloc(size, sizeof(morai_msgs__msg__WheelTorque));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__WheelTorque__Sequence * array = (morai_msgs__msg__WheelTorque__Sequence *)malloc(sizeof(morai_msgs__msg__WheelTorque__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__WheelTorque__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__WheelTorque * data =
      (morai_msgs__msg__WheelTorque *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__WheelTorque__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__WheelTorque__fini(&data[i]);
        }
        free(data);
        return false;
      }
