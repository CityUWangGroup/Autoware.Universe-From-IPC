...
{
  morai_msgs__msg__Lamps * msg = (morai_msgs__msg__Lamps *)malloc(sizeof(morai_msgs__msg__Lamps));
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__Lamps__Sequence__init(morai_msgs__msg__Lamps__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__Lamps *)calloc(size, sizeof(morai_msgs__msg__Lamps));
    if (!data) {
      return false;
    }
...
{
  morai_msgs__msg__Lamps__Sequence * array = (morai_msgs__msg__Lamps__Sequence *)malloc(sizeof(morai_msgs__msg__Lamps__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__Lamps__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__Lamps * data =
      (morai_msgs__msg__Lamps *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__Lamps__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__Lamps__fini(&data[i]);
        }
        free(data);
        return false;
      }
