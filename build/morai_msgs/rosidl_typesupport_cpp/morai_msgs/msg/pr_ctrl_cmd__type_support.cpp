...
static const _PRCtrlCmd_type_support_symbol_names_t _PRCtrlCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, morai_msgs, msg, PRCtrlCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, morai_msgs, msg, PRCtrlCmd)),
  }
};
...
{
  return &::morai_msgs::msg::rosidl_typesupport_cpp::PRCtrlCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, morai_msgs, msg, PRCtrlCmd)() {
  return get_message_type_support_handle<morai_msgs::msg::PRCtrlCmd>();
}
