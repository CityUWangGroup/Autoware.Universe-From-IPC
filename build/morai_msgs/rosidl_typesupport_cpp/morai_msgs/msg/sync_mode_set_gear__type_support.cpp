...
static const _SyncModeSetGear_type_support_symbol_names_t _SyncModeSetGear_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, morai_msgs, msg, SyncModeSetGear)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, morai_msgs, msg, SyncModeSetGear)),
  }
};
...
{
  return &::morai_msgs::msg::rosidl_typesupport_cpp::SyncModeSetGear_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, morai_msgs, msg, SyncModeSetGear)() {
  return get_message_type_support_handle<morai_msgs::msg::SyncModeSetGear>();
}
