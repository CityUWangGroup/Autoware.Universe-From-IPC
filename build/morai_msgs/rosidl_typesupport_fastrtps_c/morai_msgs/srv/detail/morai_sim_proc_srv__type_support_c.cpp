...
static size_t _MoraiSimProcSrv_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_morai_msgs__srv__MoraiSimProcSrv_Request(
    full_bounded, 0);
}
...
static size_t _MoraiSimProcSrv_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_morai_msgs__srv__MoraiSimProcSrv_Response(
    full_bounded, 0);
}
