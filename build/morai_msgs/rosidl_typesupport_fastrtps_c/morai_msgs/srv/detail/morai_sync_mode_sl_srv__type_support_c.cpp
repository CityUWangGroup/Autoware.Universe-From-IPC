...
static size_t _MoraiSyncModeSLSrv_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_morai_msgs__srv__MoraiSyncModeSLSrv_Request(
    full_bounded, 0);
}
...
static size_t _MoraiSyncModeSLSrv_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_morai_msgs__srv__MoraiSyncModeSLSrv_Response(
    full_bounded, 0);
}
