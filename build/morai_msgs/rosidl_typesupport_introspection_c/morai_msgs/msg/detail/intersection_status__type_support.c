...
#include <stddef.h>
#include "morai_msgs/msg/detail/intersection_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  morai_msgs__msg__IntersectionStatus__init(message_memory);
}

void IntersectionStatus__rosidl_typesupport_introspection_c__IntersectionStatus_fini_function(void * message_memory)
{
  morai_msgs__msg__IntersectionStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember IntersectionStatus__rosidl_typesupport_introspection_c__IntersectionStatus_message_member_array[4] = {
  {
    "header",  // name
    ...
    offsetof(morai_msgs__msg__IntersectionStatus, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(morai_msgs__msg__IntersectionStatus, intersection_index),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(morai_msgs__msg__IntersectionStatus, intersection_status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(morai_msgs__msg__IntersectionStatus, intersection_status_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers IntersectionStatus__rosidl_typesupport_introspection_c__IntersectionStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(morai_msgs__msg__IntersectionStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, morai_msgs, msg, IntersectionStatus)() {
