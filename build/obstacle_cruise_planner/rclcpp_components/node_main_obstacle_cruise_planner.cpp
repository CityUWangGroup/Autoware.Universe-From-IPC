...
#define NODE_MAIN_LOGGER_NAME "obstacle_cruise_planner"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobstacle_cruise_planner_core.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<motion_planning::ObstacleCruisePlannerNode>";
