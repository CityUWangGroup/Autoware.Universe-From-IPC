...
#define NODE_MAIN_LOGGER_NAME "shift_decider"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libshift_decider_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ShiftDecider>";
