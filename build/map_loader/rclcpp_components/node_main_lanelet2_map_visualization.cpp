...
#define NODE_MAIN_LOGGER_NAME "lanelet2_map_visualization"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblanelet2_map_visualization_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<Lanelet2MapVisualizationNode>";
