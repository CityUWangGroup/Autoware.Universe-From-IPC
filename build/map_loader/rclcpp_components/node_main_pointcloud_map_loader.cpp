...
#define NODE_MAIN_LOGGER_NAME "pointcloud_map_loader"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpointcloud_map_loader_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<PointCloudMapLoaderNode>";
