...
#define NODE_MAIN_LOGGER_NAME "pure_pursuit_lateral_controller_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpure_pursuit_lateral_controller.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pure_pursuit::PurePursuitLateralController>";
