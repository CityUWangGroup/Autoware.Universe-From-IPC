...
#define NODE_MAIN_LOGGER_NAME "voxel_grid_based_euclidean_cluster_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvoxel_grid_based_euclidean_cluster_node_core.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<euclidean_cluster::VoxelGridBasedEuclideanClusterNode>";
