...
#define NODE_MAIN_LOGGER_NAME "euclidean_cluster_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libeuclidean_cluster_node_core.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<euclidean_cluster::EuclideanClusterNode>";
