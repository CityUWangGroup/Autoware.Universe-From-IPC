...
#include "planning_debug_tools/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _TrajectoryDebugInfo_type_support_symbol_names_t _TrajectoryDebugInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, planning_debug_tools, msg, TrajectoryDebugInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, planning_debug_tools, msg, TrajectoryDebugInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_planning_debug_tools
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, planning_debug_tools, msg, TrajectoryDebugInfo)() {
  return &::planning_debug_tools::msg::rosidl_typesupport_c::TrajectoryDebugInfo_message_type_support_handle;
}
