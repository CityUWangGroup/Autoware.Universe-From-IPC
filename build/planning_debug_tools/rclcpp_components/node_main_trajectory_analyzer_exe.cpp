...
#define NODE_MAIN_LOGGER_NAME "trajectory_analyzer_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtrajectory_analyzer_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_debug_tools::TrajectoryAnalyzerNode>";
