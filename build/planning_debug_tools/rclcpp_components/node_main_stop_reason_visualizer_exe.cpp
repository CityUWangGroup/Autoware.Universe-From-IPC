...
#define NODE_MAIN_LOGGER_NAME "stop_reason_visualizer_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstop_reason_visualizer_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_debug_tools::StopReasonVisualizerNode>";
