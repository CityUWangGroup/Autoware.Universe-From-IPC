...
bool planning_debug_tools__msg__trajectory_debug_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("planning_debug_tools.msg._trajectory_debug_info.TrajectoryDebugInfo", full_classname_dest, 67) == 0);
  }
  planning_debug_tools__msg__TrajectoryDebugInfo * ros_message = _ros_message;
  {  // stamp
  ...
  {  // arclength
    PyObject * field = PyObject_GetAttrString(_pymsg, "arclength");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->arclength.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'arclength'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // curvature
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->curvature.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // yaw
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->yaw.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'yaw'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of TrajectoryDebugInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("planning_debug_tools.msg._trajectory_debug_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryDebugInfo");
  ...
  {  // arclength
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "arclength");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->arclength.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->arclength.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->arclength.size * sizeof(double));
      assert(data != NULL);
  ...
  {  // curvature
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "curvature");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->curvature.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->curvature.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->curvature.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // yaw
    ...
    if (ros_message->yaw.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->yaw.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->yaw.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
