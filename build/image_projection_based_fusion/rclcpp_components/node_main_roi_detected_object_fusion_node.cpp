...
#define NODE_MAIN_LOGGER_NAME "roi_detected_object_fusion_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_projection_based_fusion::RoiDetectedObjectFusionNode>";
