...
#define NODE_MAIN_LOGGER_NAME "pointpainting_fusion_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpointpainting_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_projection_based_fusion::PointPaintingFusionNode>";
