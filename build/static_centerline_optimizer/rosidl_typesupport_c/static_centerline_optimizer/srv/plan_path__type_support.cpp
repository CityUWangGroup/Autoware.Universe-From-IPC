...
static const _PlanPath_Request_type_support_symbol_names_t _PlanPath_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, static_centerline_optimizer, srv, PlanPath_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, static_centerline_optimizer, srv, PlanPath_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, static_centerline_optimizer, srv, PlanPath_Request)() {
  return &::static_centerline_optimizer::srv::rosidl_typesupport_c::PlanPath_Request_message_type_support_handle;
}
...
static const _PlanPath_Response_type_support_symbol_names_t _PlanPath_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, static_centerline_optimizer, srv, PlanPath_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, static_centerline_optimizer, srv, PlanPath_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_static_centerline_optimizer
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, static_centerline_optimizer, srv, PlanPath_Response)() {
  return &::static_centerline_optimizer::srv::rosidl_typesupport_c::PlanPath_Response_message_type_support_handle;
}
...
static const _PlanPath_type_support_symbol_names_t _PlanPath_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, static_centerline_optimizer, srv, PlanPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, static_centerline_optimizer, srv, PlanPath)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, static_centerline_optimizer, srv, PlanPath)() {
  return &::static_centerline_optimizer::srv::rosidl_typesupport_c::PlanPath_service_type_support_handle;
}
