...
#ifndef STATIC_CENTERLINE_OPTIMIZER__SRV__DETAIL__PLAN_ROUTE__FUNCTIONS_H_
#define STATIC_CENTERLINE_OPTIMIZER__SRV__DETAIL__PLAN_ROUTE__FUNCTIONS_H_
 ...
 * calls
 * static_centerline_optimizer__srv__PlanRoute_Request__init().
...
/**
 * It calls
 * static_centerline_optimizer__srv__PlanRoute_Request__fini()
 ...
 * static_centerline_optimizer__srv__PlanRoute_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * static_centerline_optimizer__srv__PlanRoute_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * static_centerline_optimizer__srv__PlanRoute_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_static_centerline_optimizer
...
/**
 * It calls
 * static_centerline_optimizer__srv__PlanRoute_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_static_centerline_optimizer
...
/**
 * It allocates the memory for the array and calls
 * static_centerline_optimizer__srv__PlanRoute_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_static_centerline_optimizer
...
/**
 * It calls
 * static_centerline_optimizer__srv__PlanRoute_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // STATIC_CENTERLINE_OPTIMIZER__SRV__DETAIL__PLAN_ROUTE__FUNCTIONS_H_
