...
bool static_centerline_optimizer__msg__points_with_lane_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("static_centerline_optimizer.msg._points_with_lane_id.PointsWithLaneId", full_classname_dest, 69) == 0);
  }
  static_centerline_optimizer__msg__PointsWithLaneId * ros_message = _ros_message;
  {  // lane_id
...
{
  /* NOTE(esteve): Call constructor of PointsWithLaneId */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("static_centerline_optimizer.msg._points_with_lane_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointsWithLaneId");
