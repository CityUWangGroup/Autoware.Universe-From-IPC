...
class Metaclass_LoadMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'static_centerline_optimizer.srv.LoadMap')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from static_centerline_optimizer.srv import _load_map
...
class LoadMap(metaclass=Metaclass_LoadMap):
    from static_centerline_optimizer.srv._load_map import LoadMap_Request as Request
    from static_centerline_optimizer.srv._load_map import LoadMap_Response as Response
