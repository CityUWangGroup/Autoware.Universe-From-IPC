...
{
  new (message_memory) static_centerline_optimizer::srv::LoadMap_Request(_init);
}

void LoadMap_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<static_centerline_optimizer::srv::LoadMap_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoadMap_Request_message_member_array[1] = {
  {
    ...
    offsetof(static_centerline_optimizer::srv::LoadMap_Request, map),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoadMap_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(static_centerline_optimizer::srv::LoadMap_Request),
...
{
  return &::static_centerline_optimizer::srv::rosidl_typesupport_introspection_cpp::LoadMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, static_centerline_optimizer, srv, LoadMap_Request)() {
  return &::static_centerline_optimizer::srv::rosidl_typesupport_introspection_cpp::LoadMap_Request_message_type_support_handle;
}
...
void LoadMap_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) static_centerline_optimizer::srv::LoadMap_Response(_init);
}

void LoadMap_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<static_centerline_optimizer::srv::LoadMap_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoadMap_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(static_centerline_optimizer::srv::LoadMap_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoadMap_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(static_centerline_optimizer::srv::LoadMap_Response),
...
{
  return &::static_centerline_optimizer::srv::rosidl_typesupport_introspection_cpp::LoadMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, static_centerline_optimizer, srv, LoadMap_Response)() {
  return &::static_centerline_optimizer::srv::rosidl_typesupport_introspection_cpp::LoadMap_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers LoadMap_service_members = {
  ...
  // see get_service_type_support_handle<static_centerline_optimizer::srv::LoadMap>()
...
get_service_type_support_handle<static_centerline_optimizer::srv::LoadMap>()
{
  ...
  auto service_type_support =
    &::static_centerline_optimizer::srv::rosidl_typesupport_introspection_cpp::LoadMap_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::static_centerline_optimizer::srv::LoadMap_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::static_centerline_optimizer::srv::LoadMap_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, static_centerline_optimizer, srv, LoadMap)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<static_centerline_optimizer::srv::LoadMap>();
}
