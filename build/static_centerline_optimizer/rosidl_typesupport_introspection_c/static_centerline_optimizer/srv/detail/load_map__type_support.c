...
void LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_init_function(
...
void LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_fini_function(void * message_memory)
{
  static_centerline_optimizer__srv__LoadMap_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_member_array[1] = {
  {
    "map",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_members = {
  ...
  LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_member_array,  // message members
  LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_type_support_handle = {
  0,
  &LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, static_centerline_optimizer, srv, LoadMap_Request)() {
  if (!LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_type_support_handle.typesupport_identifier) {
    LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_fini_function(void * message_memory)
{
  static_centerline_optimizer__srv__LoadMap_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_member_array[1] = {
  {
    "message",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_STRING,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_members = {
  "static_centerline_optimizer__srv",  // message namespace
  "LoadMap_Response",  // message name
  1,  // number of fields
  sizeof(static_centerline_optimizer__srv__LoadMap_Response),
  LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_member_array,  // message members
  LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_type_support_handle = {
  0,
  &LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, static_centerline_optimizer, srv, LoadMap_Response)() {
  if (!LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_type_support_handle.typesupport_identifier) {
    LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
