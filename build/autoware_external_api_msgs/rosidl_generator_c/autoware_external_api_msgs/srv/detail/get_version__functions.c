...
{
  autoware_external_api_msgs__srv__GetVersion_Request * msg = (autoware_external_api_msgs__srv__GetVersion_Request *)malloc(sizeof(autoware_external_api_msgs__srv__GetVersion_Request));
  if (!msg) {
    return NULL;
  }
...
autoware_external_api_msgs__srv__GetVersion_Request__Sequence__init(autoware_external_api_msgs__srv__GetVersion_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_external_api_msgs__srv__GetVersion_Request *)calloc(size, sizeof(autoware_external_api_msgs__srv__GetVersion_Request));
    if (!data) {
      return false;
    }
...
{
  autoware_external_api_msgs__srv__GetVersion_Request__Sequence * array = (autoware_external_api_msgs__srv__GetVersion_Request__Sequence *)malloc(sizeof(autoware_external_api_msgs__srv__GetVersion_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_external_api_msgs__srv__GetVersion_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_external_api_msgs__srv__GetVersion_Request * data =
      (autoware_external_api_msgs__srv__GetVersion_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_external_api_msgs__srv__GetVersion_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_external_api_msgs__srv__GetVersion_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  autoware_external_api_msgs__srv__GetVersion_Response * msg = (autoware_external_api_msgs__srv__GetVersion_Response *)malloc(sizeof(autoware_external_api_msgs__srv__GetVersion_Response));
  if (!msg) {
    return NULL;
  }
...
autoware_external_api_msgs__srv__GetVersion_Response__Sequence__init(autoware_external_api_msgs__srv__GetVersion_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_external_api_msgs__srv__GetVersion_Response *)calloc(size, sizeof(autoware_external_api_msgs__srv__GetVersion_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  autoware_external_api_msgs__srv__GetVersion_Response__Sequence * array = (autoware_external_api_msgs__srv__GetVersion_Response__Sequence *)malloc(sizeof(autoware_external_api_msgs__srv__GetVersion_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  autoware_external_api_msgs__srv__GetVersion_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_external_api_msgs__srv__GetVersion_Response * data =
      (autoware_external_api_msgs__srv__GetVersion_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_external_api_msgs__srv__GetVersion_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_external_api_msgs__srv__GetVersion_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
