...
#ifndef AUTOWARE_EXTERNAL_API_MSGS__SRV__DETAIL__GET_VERSION__FUNCTIONS_H_
#define AUTOWARE_EXTERNAL_API_MSGS__SRV__DETAIL__GET_VERSION__FUNCTIONS_H_
...
/// Initialize srv/GetVersion message.
/**
...
/// Finalize srv/GetVersion message.
/**
...
/// Create srv/GetVersion message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * autoware_external_api_msgs__srv__GetVersion_Request__init().
...
/// Destroy srv/GetVersion message.
/**
 * It calls
 * autoware_external_api_msgs__srv__GetVersion_Request__fini()
...
/// Check for srv/GetVersion message equality.
/**
...
/// Initialize array of srv/GetVersion messages.
/**
...
/// Finalize array of srv/GetVersion messages.
/**
 * It calls
 * autoware_external_api_msgs__srv__GetVersion_Request__fini()
...
/// Create array of srv/GetVersion messages.
/**
 * It allocates the memory for the array and calls
 * autoware_external_api_msgs__srv__GetVersion_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetVersion messages.
/**
 * It calls
 * autoware_external_api_msgs__srv__GetVersion_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetVersion message array equality.
/**
...
/// Copy an array of srv/GetVersion messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * autoware_external_api_msgs__srv__GetVersion_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_external_api_msgs
...
/**
 * It calls
 * autoware_external_api_msgs__srv__GetVersion_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_external_api_msgs
...
/**
 * It allocates the memory for the array and calls
 * autoware_external_api_msgs__srv__GetVersion_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_external_api_msgs
...
/**
 * It calls
 * autoware_external_api_msgs__srv__GetVersion_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AUTOWARE_EXTERNAL_API_MSGS__SRV__DETAIL__GET_VERSION__FUNCTIONS_H_
