...
class Metaclass_GetVersion_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('autoware_external_api_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetVersion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autoware_external_api_msgs.srv.GetVersion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autoware_external_api_msgs.srv import _get_version
...
class GetVersion(metaclass=Metaclass_GetVersion):
    from autoware_external_api_msgs.srv._get_version import GetVersion_Request as Request
    from autoware_external_api_msgs.srv._get_version import GetVersion_Response as Response
