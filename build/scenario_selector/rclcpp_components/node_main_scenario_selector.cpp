...
#define NODE_MAIN_LOGGER_NAME "scenario_selector"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libscenario_selector_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ScenarioSelectorNode>";
