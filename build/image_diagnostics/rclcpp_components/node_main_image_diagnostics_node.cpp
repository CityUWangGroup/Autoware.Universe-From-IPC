...
#define NODE_MAIN_LOGGER_NAME "image_diagnostics_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_diagnostics.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_diagnostics::ImageDiagNode>";
