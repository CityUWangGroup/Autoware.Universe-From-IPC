...
bool
autoware_auto_vehicle_msgs__msg__HornReport__are_equal(const autoware_auto_vehicle_msgs__msg__HornReport * lhs, const autoware_auto_vehicle_msgs__msg__HornReport * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_auto_vehicle_msgs__msg__HornReport__copy(
  const autoware_auto_vehicle_msgs__msg__HornReport * input,
  autoware_auto_vehicle_msgs__msg__HornReport * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
autoware_auto_vehicle_msgs__msg__HornReport__Sequence__are_equal(const autoware_auto_vehicle_msgs__msg__HornReport__Sequence * lhs, const autoware_auto_vehicle_msgs__msg__HornReport__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_vehicle_msgs__msg__HornReport__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_vehicle_msgs__msg__HornReport__Sequence__copy(
  const autoware_auto_vehicle_msgs__msg__HornReport__Sequence * input,
  autoware_auto_vehicle_msgs__msg__HornReport__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_vehicle_msgs__msg__HornReport);
    autoware_auto_vehicle_msgs__msg__HornReport * data =
      (autoware_auto_vehicle_msgs__msg__HornReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_vehicle_msgs__msg__HornReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_vehicle_msgs__msg__HornReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_vehicle_msgs__msg__HornReport__copy(
