...
autoware_auto_vehicle_msgs__msg__WipersReport__Sequence__are_equal(const autoware_auto_vehicle_msgs__msg__WipersReport__Sequence * lhs, const autoware_auto_vehicle_msgs__msg__WipersReport__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_vehicle_msgs__msg__WipersReport__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_auto_vehicle_msgs__msg__WipersReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_vehicle_msgs__msg__WipersReport);
    autoware_auto_vehicle_msgs__msg__WipersReport * data =
      (autoware_auto_vehicle_msgs__msg__WipersReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_vehicle_msgs__msg__WipersReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_vehicle_msgs__msg__WipersReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_vehicle_msgs__msg__WipersReport__copy(
