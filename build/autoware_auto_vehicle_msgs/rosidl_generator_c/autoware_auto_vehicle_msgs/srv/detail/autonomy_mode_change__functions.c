  ...
  autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request * data =
      (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response * data =
      (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
