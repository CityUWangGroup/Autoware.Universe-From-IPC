...
#include <stddef.h>
#include "autoware_auto_vehicle_msgs/msg/detail/control_mode_command__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_vehicle_msgs__msg__ControlModeCommand__init(message_memory);
}

void ControlModeCommand__rosidl_typesupport_introspection_c__ControlModeCommand_fini_function(void * message_memory)
{
  autoware_auto_vehicle_msgs__msg__ControlModeCommand__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ControlModeCommand__rosidl_typesupport_introspection_c__ControlModeCommand_message_member_array[2] = {
  {
    ...
    offsetof(autoware_auto_vehicle_msgs__msg__ControlModeCommand, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_vehicle_msgs__msg__ControlModeCommand, mode),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ControlModeCommand__rosidl_typesupport_introspection_c__ControlModeCommand_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_vehicle_msgs__msg__ControlModeCommand),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_vehicle_msgs, msg, ControlModeCommand)() {
