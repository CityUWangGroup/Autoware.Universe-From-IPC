...
static size_t _ControlModeCommand_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_vehicle_msgs__srv__ControlModeCommand_Request(
    full_bounded, 0);
}
...
static size_t _ControlModeCommand_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_vehicle_msgs__srv__ControlModeCommand_Response(
    full_bounded, 0);
}
