...
#define NODE_MAIN_LOGGER_NAME "traffic_light_classifier_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtraffic_light_classifier_nodelet.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<traffic_light::TrafficLightClassifierNodelet>";
