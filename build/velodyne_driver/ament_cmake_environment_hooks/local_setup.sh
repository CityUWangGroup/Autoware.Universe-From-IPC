...
: ${AMENT_CURRENT_PREFIX:="/home/cityu/autoware/install/velodyne_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/velodyne_driver/environment/library_path.sh"
