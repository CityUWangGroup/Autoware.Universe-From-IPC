...
#define NODE_MAIN_LOGGER_NAME "velodyne_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvelodyne_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<velodyne_driver::VelodyneDriver>";
