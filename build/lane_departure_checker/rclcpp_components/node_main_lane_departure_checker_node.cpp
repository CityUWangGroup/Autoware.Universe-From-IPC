...
#define NODE_MAIN_LOGGER_NAME "lane_departure_checker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblane_departure_checker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<lane_departure_checker::LaneDepartureCheckerNode>";
