...
#define NODE_MAIN_LOGGER_NAME "obstacle_pointcloud_based_validator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobstacle_pointcloud_based_validator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<obstacle_pointcloud_based_validator::ObstaclePointCloudBasedValidator>";
