...
#define NODE_MAIN_LOGGER_NAME "object_position_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobject_position_filter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<object_position_filter::ObjectPositionFilterNode>";
