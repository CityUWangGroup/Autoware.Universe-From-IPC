...
#define NODE_MAIN_LOGGER_NAME "object_lanelet_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobject_lanelet_filter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<object_lanelet_filter::ObjectLaneletFilterNode>";
