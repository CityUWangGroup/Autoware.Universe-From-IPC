...
: ${AMENT_CURRENT_PREFIX:="/home/cityu/autoware/install/tensorrt_common"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tensorrt_common/environment/library_path.sh"
