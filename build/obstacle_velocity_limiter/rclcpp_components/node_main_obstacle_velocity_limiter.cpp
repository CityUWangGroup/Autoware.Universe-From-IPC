...
#define NODE_MAIN_LOGGER_NAME "obstacle_velocity_limiter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobstacle_velocity_limiter_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<obstacle_velocity_limiter::ObstacleVelocityLimiterNode>";
