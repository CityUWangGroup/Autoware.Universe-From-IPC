...
#define NODE_MAIN_LOGGER_NAME "kinematic_evaluator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkinematic_evaluator_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kinematic_diagnostics::KinematicEvaluatorNode>";
