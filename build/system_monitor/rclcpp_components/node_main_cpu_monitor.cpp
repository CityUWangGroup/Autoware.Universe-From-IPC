...
#define NODE_MAIN_LOGGER_NAME "cpu_monitor"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcpu_monitor_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<CPUMonitor>";
