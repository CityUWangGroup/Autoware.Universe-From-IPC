...
#define NODE_MAIN_LOGGER_NAME "process_monitor"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libprocess_monitor_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ProcessMonitor>";
