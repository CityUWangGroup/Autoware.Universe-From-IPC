...
#define NODE_MAIN_LOGGER_NAME "mem_monitor"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmem_monitor_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<MemMonitor>";
