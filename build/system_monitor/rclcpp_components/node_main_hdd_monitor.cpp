...
#define NODE_MAIN_LOGGER_NAME "hdd_monitor"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhdd_monitor_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<HddMonitor>";
