...
#define NODE_MAIN_LOGGER_NAME "gpu_monitor"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgpu_monitor_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<GPUMonitor>";
