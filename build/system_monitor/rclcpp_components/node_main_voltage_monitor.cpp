...
#define NODE_MAIN_LOGGER_NAME "voltage_monitor"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvoltage_monitor_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<VoltageMonitor>";
