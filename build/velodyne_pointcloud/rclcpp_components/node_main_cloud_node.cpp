...
#define NODE_MAIN_LOGGER_NAME "cloud_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcloud_nodelet.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<velodyne_pointcloud::Convert>";
