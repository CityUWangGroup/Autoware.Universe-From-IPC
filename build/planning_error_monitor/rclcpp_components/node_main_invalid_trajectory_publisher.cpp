...
#define NODE_MAIN_LOGGER_NAME "invalid_trajectory_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libinvalid_trajectory_publisher_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_diagnostics::InvalidTrajectoryPublisherNode>";
