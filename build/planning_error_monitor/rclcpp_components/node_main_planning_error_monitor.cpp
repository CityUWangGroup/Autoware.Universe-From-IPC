...
#define NODE_MAIN_LOGGER_NAME "planning_error_monitor"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libplanning_error_monitor_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_diagnostics::PlanningErrorMonitorNode>";
