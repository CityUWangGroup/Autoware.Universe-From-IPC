...
#define NODE_MAIN_LOGGER_NAME "front_vehicle_velocity_estimator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfront_vehicle_velocity_estimator_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<front_vehicle_velocity_estimator::FrontVehicleVelocityEstimatorNode>";
