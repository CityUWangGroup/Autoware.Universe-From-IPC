...
#define NODE_MAIN_LOGGER_NAME "lidar_apollo_segmentation_tvm_nodes_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblidar_apollo_segmentation_tvm_nodes.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::perception::lidar_apollo_segmentation_tvm_nodes::ApolloLidarSegmentationNode>";
