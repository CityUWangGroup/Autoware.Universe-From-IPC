...
: ${AMENT_CURRENT_PREFIX:="/home/cityu/autoware/install/lidar_apollo_segmentation_tvm_nodes"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lidar_apollo_segmentation_tvm_nodes/environment/library_path.sh"
