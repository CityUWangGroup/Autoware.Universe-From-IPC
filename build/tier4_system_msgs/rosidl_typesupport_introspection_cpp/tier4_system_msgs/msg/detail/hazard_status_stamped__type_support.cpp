...
{
  new (message_memory) tier4_system_msgs::msg::HazardStatusStamped(_init);
}

void HazardStatusStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_system_msgs::msg::HazardStatusStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HazardStatusStamped_message_member_array[2] = {
  {
    ...
    offsetof(tier4_system_msgs::msg::HazardStatusStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<tier4_system_msgs::msg::HazardStatus>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_system_msgs::msg::HazardStatusStamped, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HazardStatusStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_system_msgs::msg::HazardStatusStamped),
...
{
  return &::tier4_system_msgs::msg::rosidl_typesupport_introspection_cpp::HazardStatusStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_system_msgs, msg, HazardStatusStamped)() {
  return &::tier4_system_msgs::msg::rosidl_typesupport_introspection_cpp::HazardStatusStamped_message_type_support_handle;
}
