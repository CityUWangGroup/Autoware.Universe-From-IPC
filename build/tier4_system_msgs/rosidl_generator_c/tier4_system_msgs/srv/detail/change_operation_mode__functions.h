...
#ifndef TIER4_SYSTEM_MSGS__SRV__DETAIL__CHANGE_OPERATION_MODE__FUNCTIONS_H_
#define TIER4_SYSTEM_MSGS__SRV__DETAIL__CHANGE_OPERATION_MODE__FUNCTIONS_H_
...
/// Initialize srv/ChangeOperationMode message.
/**
...
/// Finalize srv/ChangeOperationMode message.
/**
...
/// Create srv/ChangeOperationMode message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_system_msgs__srv__ChangeOperationMode_Request__init().
...
/// Destroy srv/ChangeOperationMode message.
/**
 * It calls
 * tier4_system_msgs__srv__ChangeOperationMode_Request__fini()
...
/// Check for srv/ChangeOperationMode message equality.
/**
...
/// Copy a srv/ChangeOperationMode message.
/**
...
/// Initialize array of srv/ChangeOperationMode messages.
/**
...
/// Finalize array of srv/ChangeOperationMode messages.
/**
 * It calls
 * tier4_system_msgs__srv__ChangeOperationMode_Request__fini()
...
/// Create array of srv/ChangeOperationMode messages.
/**
 * It allocates the memory for the array and calls
 * tier4_system_msgs__srv__ChangeOperationMode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ChangeOperationMode messages.
/**
 * It calls
 * tier4_system_msgs__srv__ChangeOperationMode_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ChangeOperationMode message array equality.
/**
...
/// Copy an array of srv/ChangeOperationMode messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_system_msgs__srv__ChangeOperationMode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_system_msgs
...
/**
 * It calls
 * tier4_system_msgs__srv__ChangeOperationMode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_system_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_system_msgs__srv__ChangeOperationMode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_system_msgs
...
/**
 * It calls
 * tier4_system_msgs__srv__ChangeOperationMode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_SYSTEM_MSGS__SRV__DETAIL__CHANGE_OPERATION_MODE__FUNCTIONS_H_
