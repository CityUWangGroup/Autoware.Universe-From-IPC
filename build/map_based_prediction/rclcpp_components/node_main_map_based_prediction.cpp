...
#define NODE_MAIN_LOGGER_NAME "map_based_prediction"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmap_based_prediction_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<map_based_prediction::MapBasedPredictionNode>";
