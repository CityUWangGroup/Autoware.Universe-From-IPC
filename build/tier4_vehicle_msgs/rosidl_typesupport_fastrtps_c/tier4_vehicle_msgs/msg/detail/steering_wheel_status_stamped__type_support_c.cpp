...
static size_t _SteeringWheelStatusStamped__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_tier4_vehicle_msgs__msg__SteeringWheelStatusStamped(
    full_bounded, 0);
}
