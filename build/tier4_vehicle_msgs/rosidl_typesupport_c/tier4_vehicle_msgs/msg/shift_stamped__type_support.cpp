...
static const _ShiftStamped_type_support_symbol_names_t _ShiftStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_vehicle_msgs, msg, ShiftStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_vehicle_msgs, msg, ShiftStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_vehicle_msgs, msg, ShiftStamped)() {
  return &::tier4_vehicle_msgs::msg::rosidl_typesupport_c::ShiftStamped_message_type_support_handle;
}
