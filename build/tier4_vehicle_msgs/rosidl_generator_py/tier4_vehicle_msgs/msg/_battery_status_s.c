...
bool tier4_vehicle_msgs__msg__battery_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_vehicle_msgs.msg._battery_status.BatteryStatus", full_classname_dest, 52) == 0);
  }
  tier4_vehicle_msgs__msg__BatteryStatus * ros_message = _ros_message;
  {  // stamp
...
PyObject * tier4_vehicle_msgs__msg__battery_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_vehicle_msgs.msg._battery_status");
