...
{
  tier4_vehicle_msgs__msg__SteeringWheelStatusStamped * msg = (tier4_vehicle_msgs__msg__SteeringWheelStatusStamped *)malloc(sizeof(tier4_vehicle_msgs__msg__SteeringWheelStatusStamped));
  if (!msg) {
    return NULL;
  }
...
tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__Sequence__init(tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_vehicle_msgs__msg__SteeringWheelStatusStamped *)calloc(size, sizeof(tier4_vehicle_msgs__msg__SteeringWheelStatusStamped));
    if (!data) {
      return false;
    }
...
{
  tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__Sequence * array = (tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__Sequence *)malloc(sizeof(tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_vehicle_msgs__msg__SteeringWheelStatusStamped * data =
      (tier4_vehicle_msgs__msg__SteeringWheelStatusStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_vehicle_msgs__msg__SteeringWheelStatusStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
