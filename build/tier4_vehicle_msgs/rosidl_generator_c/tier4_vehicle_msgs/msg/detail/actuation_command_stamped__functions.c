...
{
  tier4_vehicle_msgs__msg__ActuationCommandStamped * msg = (tier4_vehicle_msgs__msg__ActuationCommandStamped *)malloc(sizeof(tier4_vehicle_msgs__msg__ActuationCommandStamped));
  if (!msg) {
    return NULL;
  }
...
tier4_vehicle_msgs__msg__ActuationCommandStamped__Sequence__init(tier4_vehicle_msgs__msg__ActuationCommandStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_vehicle_msgs__msg__ActuationCommandStamped *)calloc(size, sizeof(tier4_vehicle_msgs__msg__ActuationCommandStamped));
    if (!data) {
      return false;
    }
...
{
  tier4_vehicle_msgs__msg__ActuationCommandStamped__Sequence * array = (tier4_vehicle_msgs__msg__ActuationCommandStamped__Sequence *)malloc(sizeof(tier4_vehicle_msgs__msg__ActuationCommandStamped__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  tier4_vehicle_msgs__msg__ActuationCommandStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_vehicle_msgs__msg__ActuationCommandStamped * data =
      (tier4_vehicle_msgs__msg__ActuationCommandStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_vehicle_msgs__msg__ActuationCommandStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tier4_vehicle_msgs__msg__ActuationCommandStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
