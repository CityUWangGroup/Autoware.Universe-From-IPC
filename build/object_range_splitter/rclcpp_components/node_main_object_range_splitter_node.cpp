...
#define NODE_MAIN_LOGGER_NAME "object_range_splitter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobject_range_splitter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<object_range_splitter::ObjectRangeSplitterNode>";
